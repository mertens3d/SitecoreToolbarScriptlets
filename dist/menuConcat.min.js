...
var constants={taDebug:"ta-debug"};function WriteHtml(n){n.document.innerHtml="",n.document.write(HtmlToInject),console.log(HtmlToInject),n.document.write("<script>"),n.document.write(CodeToInject),n.document.write("WireMenuButtons()"),n.document.write("<\/script>")}!window.mywindow||"undefined"===window.mywindow||window.mywindow.closed?(console.log("new window"),console.log("Constants: "+constants.taDebug),window.mywindow=window.open("","mywindow","width=800, height=400"),window.mywindow.document.innerHtml="",WriteHtml(window.mywindow)):(console.log("existing window"),window.mywindow.focus());}());