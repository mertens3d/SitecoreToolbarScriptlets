...
var constants={taDebug:"ta-debug"},xyyz=xyyz||{};xyyz.ChildWindow={myWindow:null,WindowExists:function(){return this.mywindow&&"undefined"!==this.mywindow&&!this.mywindow.closed},WriteHtml:function(n){var o="<head>";o+="<style>",o+=StyleInject,o+="</style>",o+="<body>",o+=HtmlToInject,o+="<script>",o+=CodeToInject,o+="<\/script>",o+="</body>",n.document.innerHtml="",console.log(o),n.document.write(o)},CreateWindow:function(){console.log("new window"),console.log("Constants: "+constants.taDebug),window.mywindow=window.open("","mywindow","width=800, height=400"),this.WriteHtml(window.mywindow)},FocusWindow:function(){console.log("existing window"),window.mywindow.focus()}},xyyz.ChildWindow.WindowExists()?xyyz.ChildWindow.FocusWindow():xyyz.ChildWindow.CreateWindow();}());