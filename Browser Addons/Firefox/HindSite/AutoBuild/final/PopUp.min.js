...
class UiManager_UiManager extends PopUpManagerBase {
    ...
    RefreshUiRequest() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            var payload = yield this.MsgMan().SendMessageHndlr(new MsgPayloadRequestFromPopUp_MsgFromPopUp(MsgFlag.GiveCurrentData));
...
class PopUpMessagesManager_PopUpMessagesManager extends PopUpManagerBase {
    ...
    SendMessageHndlr(msgPlayload) {
        return PopUpMessagesManager_awaiter(this, void 0, void 0, function* () {
            this.debug().FuncStart(this.SendMessageHndlr.name, this.Utilites().MsgFlagAsString(msgPlayload));
