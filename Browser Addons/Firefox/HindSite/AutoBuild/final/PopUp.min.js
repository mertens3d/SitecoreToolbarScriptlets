...
class PopUpManagerBase {
    ...
    GuidHelper() { return this.PopHub.GuidHelper; }
    SettingsMan() { return this.PopHub.SettingsMan; }
    EventMan() { return this.PopHub.EventMan; }
    PromiseHelp() { return this.PopHub.promHelper; }
}
...
class ExternalEvents_ExternalEvents extends CommonEvents_CommonEvents {
    ...
    __hndlrDesktop(evt) {
        this.__initNewOperation();
        this.MsgMan().SendMessageToContent(new MsgPayloadRequestFromPopUp_MsgFromPopUp(MsgFlag.ReqGoDesktop, this.PopHub));
    }
    HndlrAdminB() {
        this.__initNewOperation();
    ...
    __hndlrOpenCE() {
        return ExternalEvents_awaiter(this, void 0, void 0, function* () {
            this.__initNewOperation();
            this.MsgMan().SendMessageToContent(new MsgPayloadRequestFromPopUp_MsgFromPopUp(MsgFlag.ReqOpenCE, this.PopHub));
        });
    }
        ...
        return new Promise((resolve, reject) => ExternalEvents_awaiter(this, void 0, void 0, function* () {
            ...
            if (!evt.ctrlKey) {
                ...
                yield browser.tabs.create({
                    ...
                    yield this.MsgMan().WaitForListening();
                }))
                    .catch((ex) => {
...
class PopUpMessagesManager_PopUpMessagesManager extends PopUpManagerBase {
    ...
    AutoLogin() {
        if (this.CachedState.WindowType === scWindowType.LoginPage) {
            this.SendMessageToContent(new MsgPayloadRequestFromPopUp_MsgFromPopUp(MsgFlag.ReqLoginWithAdminB, this.PopHub));
        }
    }
    ...
    WaitForListening() {
        return PopUpMessagesManager_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => PopUpMessagesManager_awaiter(this, void 0, void 0, function* () {
                ...
                var result = new ResultSuccessFail();
                result.Succeeded = false;
                var iterationJr = new IterationHelper_IterationHelper(this.debug(), this.WaitForListening.name);
                var targetTab;
...
class PopUpHub_PopUpHub {
    constructor() {
        ...
        this.GuidHelper = new GuidHelper_GuidHelper(this.debug);
        ...
        this.promHelper = new PromiseHelper_PromiseHelper(this.debug);
        this.init();
    }
    init() {
