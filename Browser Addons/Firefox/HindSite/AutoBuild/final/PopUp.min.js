...
class HandlersExternal_HandlersExternal extends CommonEvents_CommonEvents {
    __hndlrAddCETab(evt, popHub) {
        return HandlersExternal_awaiter(this, void 0, void 0, function* () {
            ...
            yield popHub.PopMsgMan.SendMessageToContentTab(new MsgPayloadRequestFromPopUp_MsgFromPopUp(MsgFlag.ReqAddCETab, popHub), popHub.TabMan.CurrentTabData);
    ...
    HndlrSnapShotCreate(evt, popHub) {
        return HandlersExternal_awaiter(this, void 0, void 0, function* () {
            popHub.EventMan.Handlers.External.__initNewOperation();
            var msg = new MsgPayloadRequestFromPopUp_MsgFromPopUp(MsgFlag.ReqTakeSnapShot, popHub);
            msg.Data.SnapShotSettings.Flavor = SnapShotFlavor.Manual;
            yield popHub.PopMsgMan.SendMessageToContentTab(msg, popHub.TabMan.CurrentTabData);
            popHub.UiMan.OnSuccessfullCommand();
        });
    }
    ...
    SetScMode(evt, popHub, parameters) {
        return HandlersExternal_awaiter(this, void 0, void 0, function* () {
            let newMode = parameters[0];
            yield popHub.EventMan.Handlers.External.__initNewOperation()
    ...
    CreateNewWindowIfRequired(evt, tabUrl) {
        return new Promise((resolve, reject) => HandlersExternal_awaiter(this, void 0, void 0, function* () {
            ...
            let result = new PromiseResult(this.CreateNewWindowIfRequired.name, this.Log());
            let toReturn;
            if (!evt.ctrlKey) {
...
class PopUpMessagesManager_PopUpMessagesManager extends PopUpManagerBase {
    ...
    OnePing(targetTab, msg) {
        return new Promise((resolve, reject) => PopUpMessagesManager_awaiter(this, void 0, void 0, function* () {
            ...
            var result = new PromiseResult(this.OnePing.name, this.Log());
    ...
    WaitForListeningTab(targetTab) {
        return PopUpMessagesManager_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => PopUpMessagesManager_awaiter(this, void 0, void 0, function* () {
                ...
                var result = new PromiseResult(this.WaitForListeningTab.name, this.Log());
    ...
    SendMessageToSingleTab(tab, messageToSend) {
        return new Promise((resolve, reject) => {
            ...
            browser.tabs.sendMessage(tab.Tab.id, messageToSend).then((response) => PopUpMessagesManager_awaiter(this, void 0, void 0, function* () {
                var asMsgFromContent = response;
                if (asMsgFromContent) {
                    this.Log().Log(StaticHelpers_StaticHelpers.MsgFlagAsString(asMsgFromContent.MsgFlag));
                    yield this.ReceiveResponseHndlr(asMsgFromContent);
                }
                else {
...
class ConstAllSettings_ConstAllSettings {
    constructor() {
        this.AllSettings = [
            ...
            new OneGenericSetting(SettingKey_SettingKey.AutoSaveEnabled, SettingType.BoolCheckBox, null, PopConst.Const.Selector.HS.SettingAutoSaveEnabled, PopConst.Const.Storage.Defaults.bool.AutoSaveEnabled, SettingFlavor.ContentAndPopUp, 'Auto Save Snapshot'),
            ...
            new OneGenericSetting(SettingKey_SettingKey.AutoSaveIntervalMin, SettingType.Number, null, PopConst.Const.Selector.HS.SettingAutoSaveInterval, PopConst.Const.Numbers.AutoSaveIntervalMin, SettingFlavor.ContentAndPopUp, 'Auto Save Interval (Minutes)'),
