...
const BuildDateStamp = 1590973594873;
    ...
    WaitForListeningTab(targetTab) {
        return PopUpMessagesManager_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => PopUpMessagesManager_awaiter(this, void 0, void 0, function* () {
                ...
                var iterationJr = new IterationHelper_IterationHelper(this.Helpers(), this.WaitForListeningTab.name, this.AllAgents);
    ...
    SendMessageToContentTab(msgPlayload, targetTab = null) {
        return PopUpMessagesManager_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => PopUpMessagesManager_awaiter(this, void 0, void 0, function* () {
                ...
                msgPlayload.CurrentContentPrefs = yield this.AllAgents.SettingsAgent.GetOnlyContentPrefs();
...
class LocationManager_LocationManager extends PopUpManagerBase {
    ...
    ChangeLocationSwitchBoard(desiredPageType) {
        ...
        var iteration = new IterationHelper_IterationHelper(this.Helpers(), this.ChangeLocationSwitchBoard.name, this.AllAgents);
...
class GuidHelper_GuidHelper extends HelperBase {
    ...
    FormatAsBracedGuid(str) {
        ...
        try {
            ...
            this.AllHelperAgents.Logger.Error(this.FormatAsBracedGuid.name, ex);
        }
        return GUID;
    }
    ParseGuid(val) {
...
class PromiseGeneric_PromiseHelper extends HelperBase {
    WaitForReadyIframe(dataOneIframe) {
        return PromiseGeneric_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => PromiseGeneric_awaiter(this, void 0, void 0, function* () {
                ...
                let promiseResult = new PromiseResult(this.WaitForReadyIframe.name, this.AllHelperAgents.Logger);
    ...
    WaitForPageReadyNative(targetDoc) {
        return PromiseGeneric_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => PromiseGeneric_awaiter(this, void 0, void 0, function* () {
                ...
                var result = new PromiseResult(this.WaitForPageReadyNative.name, this.AllHelperAgents.Logger);
    ...
    WaitForIframeElemAndReturnWhenReady(haystackDoc, selector, iframeNickName) {
        return PromiseGeneric_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => PromiseGeneric_awaiter(this, void 0, void 0, function* () {
                ...
                let promiseResult = new PromiseResult(this.WaitForIframeElemAndReturnWhenReady.name, this.AllHelperAgents.Logger);
    ...
    WaitForAndReturnFoundElem(haystackDoc, selector, overrideIterCount = 8) {
        return PromiseGeneric_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => PromiseGeneric_awaiter(this, void 0, void 0, function* () {
                ...
                let promiseResult = new PromiseResult(this.WaitForAndReturnFoundElem.name, this.AllHelperAgents.Logger);
    ...
    TabWaitForReadyStateCompleteNative(browserTab) {
        return new Promise((resolve, reject) => PromiseGeneric_awaiter(this, void 0, void 0, function* () {
            ...
            let result = new PromiseResult(this.TabWaitForReadyStateCompleteNative.name, this.AllHelperAgents.Logger);
    ...
    WaitForThenClick(selectorAr, targetDoc) {
        return new Promise((resolve, reject) => PromiseGeneric_awaiter(this, void 0, void 0, function* () {
            ...
            let promiseResults = new PromiseResult(this.WaitForThenClick.name, this.AllHelperAgents.Logger);
            if (targetDoc) {
...
class Helpers_HelperHub {
    constructor(allAgents) {
        allAgents.Logger.FuncStart(Helpers_HelperHub.name);
        this.Init(allAgents);
        allAgents.Logger.FuncEnd(Helpers_HelperHub.name);
    }
    Init(helperAgents) {
...
class PopUpHub_PopUpHub {
    constructor(allAgents) {
        ...
        this.Helpers = new Helpers_HelperHub(allAgents);
        this.init();
    }
    init() {
            ...
            if (foundSettings) {
                for (var idx = 0; idx < foundSettings.length; idx++) {
                    ...
                    if (matchingSetting) {
                        ...
                        this.Logger.Error(this.HarvestNonDefaultGenericSettingsFromStorage.name, 'matching setting not found ' + StaticHelpers_StaticHelpers.SettingKeyAsString(storageSetting.SettingKey));
                    }
                }
            }
            else {
...
EntryPoint_allAgents.HelperAgents = new AllHelperAgents(EntryPoint_allAgents.Logger, EntryPoint_allAgents.SettingsAgent);
