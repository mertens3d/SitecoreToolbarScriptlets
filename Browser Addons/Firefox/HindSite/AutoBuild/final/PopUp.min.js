...
(function (MenuCommand) {
    ...
    MenuCommand[MenuCommand["RestoreState"] = 2012] = "RestoreState";
    MenuCommand[MenuCommand["UpdateNickname"] = 2013] = "UpdateNickname";
    MenuCommand[MenuCommand["QuickPublish"] = 2014] = "QuickPublish";
    ...
    static BuildAllCommands(popHub, handlers) {
        let toReturn = [
            ...
            },
            {
                ...
                ButtonSelector: PopConst_PopConst.Const.ElemId.HS.Btn.CompactCE,
                VisibilityControllers: [VisibilityType.ActiveCeNode],
                Events: [{
                        Event: CommandButtonEvents.OnClick,
...
class HandlersExternal_HandlersExternal extends CommonEvents {
    AddCETab(evt, popHub) {
        return HandlersExternal_awaiter(this, void 0, void 0, function* () {
            yield popHub.EventMan.Handlers.External.GoContentCommand(new MsgFromPopUp_MsgFromPopUp(MsgFlag.ReqAddCETab, popHub))
    ...
    HndlrSnapShotUpdateNickName(evt, popHub) {
        return HandlersExternal_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => HandlersExternal_awaiter(this, void 0, void 0, function* () {
                ...
                yield popHub.EventMan.Handlers.External.GoContentCommand(msg)
                    .then(() => resolve())
                    .catch((err) => reject(err));
            }));
        });
    ...
    MarkFavorite(evt, popHub, tanManagerTempFix) {
        popHub.MessageMan.SendMessageToContent(new MsgFromPopUp_MsgFromPopUp(MsgFlag.ReqMarkFavorite, popHub));
    }
    __DrawStorage(evt, popHub) {
        popHub.UiMan.DrawStorage();
    }
    __DrawPopUpLogStorage(evt, popHub) {
    ...
    HndlrCompactCE(evt, popHub) {
        var msg = new MsgFromPopUp_MsgFromPopUp(MsgFlag.ReqToggleCompactCss, popHub);
        this.GoContentCommand(msg);
    }
    CreateNewWindowIfRequired(evt, popHub, tabUrl) {
        return new Promise((resolve, reject) => HandlersExternal_awaiter(this, void 0, void 0, function* () {
            ...
            let result = new PromiseResult(this.CreateNewWindowIfRequired.name, this.AllAgents.Logger);
            let toReturn;
            if (!evt.ctrlKey) {
...
class EventManager_EventManager extends PopUpManagerBase {
    ...
    Init() {
        this.AllAgents.Logger.FuncStart(EventManager_EventManager.name + this.Init.name);
        this.AllAgents.Logger.FuncStart(AllCommands_AllCommands.BuildAllCommands.name);
        this.AllMenuCommands = AllCommands_AllCommands.BuildAllCommands(this.PopHub, this.Handlers);
        this.AllAgents.Logger.FuncEnd(AllCommands_AllCommands.BuildAllCommands.name);
        this.__wireMenuButtons();
        this.WireAllGenericSettings();
        this.AllAgents.Logger.FuncEnd(EventManager_EventManager.name + this.Init.name);
    }
...
class LocationManager_LocationManager extends PopUpManagerBase {
    constructor(hub, allAgents) {
        super(hub, allAgents);
        this.AllAgents.Logger.FuncStart(LocationManager_LocationManager.name);
        this.AllAgents.Logger.FuncEnd(LocationManager_LocationManager.name);
    }
    ChangeLocationSwitchBoard(desiredPageType) {
        ...
        if (iteration.DecrementAndKeepGoing()) {
            ...
            if (this.TabMan().CurrentTabData.UrlParts.ScWindowType === scWindowType.LoginPage) {
                ...
                var absUrl = this.AllAgents.HelperAgent.UrlHelp.BuildFullUrlFromParts(this.TabMan().CurrentTabData.UrlParts);
    ...
    SetScMode(newValue) {
        return new Promise((resolve, reject) => LocationManager_awaiter(this, void 0, void 0, function* () {
            ...
            if (currentPageType === scWindowType.ContentEditor
                ...
                let newHref = this.AllAgents.HelperAgent.UrlHelp.BuildFullUrlFromParts(this.TabMan().CurrentTabData.UrlParts);
                yield this.AllAgents.HelperAgent.PromisesBasic.TabChainSetHrefWaitForComplete(newHref, this.TabMan().CurrentTabData)
                    .then(() => result.MarkSuccessful())
                    .catch((ex) => result.MarkFailed(ex));
            }
...
class PopUpMessagesBroker_PopUpMessagesBroker {
    ...
    ReceiveResponseHndlr(response) {
        return new Promise((resolve, reject) => {
            this.Logger.FuncStart(this.ReceiveResponseHndlr.name, StaticHelpers_StaticHelpers.MsgFlagAsString(response.MsgFlag));
            if (response) {
                ...
                if (asMsgFromContent) {
                    ...
                    switch (response.MsgFlag) {
                        ...
                        case MsgFlag.RespError:
                            ...
                            break;
                        default:
                            this.Logger.LogVal('Unrecognized MsgFlag', StaticHelpers_StaticHelpers.MsgFlagAsString(response.MsgFlag));
                            break;
                    }
                ...
                this.Logger.FuncEnd(this.ReceiveResponseHndlr.name, StaticHelpers_StaticHelpers.MsgFlagAsString(response.MsgFlag));
            }
        });
    }
    OnePing(targetTab, msg) {
        return new Promise((resolve, reject) => PopUpMessagesBroker_awaiter(this, void 0, void 0, function* () {
            ...
            this.MsgFeedback.UpdateMsgStatusStack('Sending Msg: ' + StaticHelpers_StaticHelpers.MsgFlagAsString(msg.MsgFlag));
            var successful = true;
            yield browser.tabs.sendMessage(targetTab.Tab.id, msg)
                .then((response) => {
                var asMsgFromContent = response;
                if (asMsgFromContent) {
                    this.Logger.LogVal('Response', StaticHelpers_StaticHelpers.MsgFlagAsString(asMsgFromContent.MsgFlag));
    ...
    SendMessageToSingleTab(messageToSend) {
        return new Promise((resolve, reject) => PopUpMessagesBroker_awaiter(this, void 0, void 0, function* () {
            ...
            yield browser.tabs.sendMessage(this.TargetTab.Tab.id, messageToSend)
                .then((response) => this.ReceiveResponseHndlr(response))
                .then((contentState) => resolve(contentState))
                .catch((ex) => { reject(ex); });
    ...
    SendMessageToContentTab(msgPlayload) {
        return PopUpMessagesBroker_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => PopUpMessagesBroker_awaiter(this, void 0, void 0, function* () {
                ...
                var promResult = new PromiseResult(this.SendMessageToContentTab.name, this.Logger);
...
class TabManager_TabManager extends PopUpManagerBase {
    constructor(hub, allAgents) {
        super(hub, allAgents);
        this.AllAgents.Logger.FuncStart(TabManager_TabManager.name);
        this.AllAgents.Logger.FuncEnd(TabManager_TabManager.name);
    }
    MakeTabData(rawTab) {
        let toReturn = {
            Tab: rawTab,
    ...
    Init() {
        return TabManager_awaiter(this, void 0, void 0, function* () {
            this.AllAgents.Logger.FuncStart(TabManager_TabManager.name, this.Init.name);
            yield this.GetAssociatedTab()
                .then((tabData) => {
                this.CurrentTabData = tabData;
            });
            this.AllAgents.Logger.DebugIDataBrowserTab(this.CurrentTabData);
            this.AllAgents.Logger.FuncEnd(TabManager_TabManager.name, this.Init.name);
        });
    }
    GetAssociatedTab() {
        return TabManager_awaiter(this, void 0, void 0, function* () {
...
class UiFeedbackModuleBase {
    constructor(textAreaSelector, logger) {
        this.__elementSelector = textAreaSelector;
        this.Logger = logger;
    }
    __getFeedbackElem() {
        return document.getElementById(this.__elementSelector);
    }
    AddHtml(htmlText) {
        if (htmlText) {
...
// CONCATENATED MODULE: ./AutoBuild/TsTranspiled/PopUp/scripts/Managers/UiManager/Modules/UiFeedbackModules/CommunicationsFeedbackModule/CommunicationsFeedbackModule.js


class CommunicationsFeedbackModule_CommunicationsFeedbackModule extends UiFeedbackModuleBase {
...
class AccordianManager_AccordianManager {
    ...
    AddAccordianDrone(popHub, oneSetting, uiElem) {
...
class UiButtonStateManager_UiButtonStateManager extends PopUpManagerBase {
    constructor(popHub, allAgents) {
        super(popHub, allAgents);
        this.AllAgents.Logger.FuncStart(UiButtonStateManager_UiButtonStateManager.name);
        this.AllAgents.Logger.FuncEnd(UiButtonStateManager_UiButtonStateManager.name);
    }
...
class SelectSnapshotModule_SelectSnapshotModule {
    ...
    SelectHeaderStr(prefix) {
        let toReturn = StaticHelpers_StaticHelpers.BufferString('Time Stamp', PopConst_PopConst.Const.SnapShotFormat.lenTimestamp, BufferChar.Period, BufferDirection.right)
            + PopConst_PopConst.Const.SnapShotFormat.colSep + StaticHelpers_StaticHelpers.BufferString('Type', PopConst_PopConst.Const.SnapShotFormat.lenPageType, BufferChar.Period, BufferDirection.right)
            + PopConst_PopConst.Const.SnapShotFormat.colSep + StaticHelpers_StaticHelpers.BufferString('Nickname', PopConst_PopConst.Const.SnapShotFormat.lenNickname, BufferChar.Period, BufferDirection.right)
            + PopConst_PopConst.Const.SnapShotFormat.colSep + StaticHelpers_StaticHelpers.BufferString('Active Node.', PopConst_PopConst.Const.SnapShotFormat.lenActiveNode, BufferChar.Period, BufferDirection.right)
            + PopConst_PopConst.Const.SnapShotFormat.colSep + StaticHelpers_StaticHelpers.BufferString('Fav.', PopConst_PopConst.Const.SnapShotFormat.lenFavorite, BufferChar.Period, BufferDirection.right)
            + PopConst_PopConst.Const.SnapShotFormat.colSep + StaticHelpers_StaticHelpers.BufferString('Id', PopConst_PopConst.Const.SnapShotFormat.lenShortId, BufferChar.Period, BufferDirection.right)
            + PopConst_PopConst.Const.SnapShotFormat.colSep + StaticHelpers_StaticHelpers.BufferString('#CE', PopConst_PopConst.Const.SnapShotFormat.lenCeCount, BufferChar.Period, BufferDirection.right);
        return toReturn;
    }
...
// CONCATENATED MODULE: ./AutoBuild/TsTranspiled/PopUp/scripts/Managers/UiManager/Modules/UiFeedbackModules/ContentStateModule/UiContentStateModule.js

class UiContentStateModule_UiContentStateModule extends UiFeedbackModuleBase {
    constructor(selector, loggerAgent) {
        super(selector, loggerAgent);
    }
}
...
class UiManager_UiManager extends PopUpManagerBase {
    constructor(popHub, allAgents) {
        ...
        this.AllAgents.Logger.FuncStart(UiManager_UiManager.name);
        this.ButtonStateManager = new UiButtonStateManager_UiButtonStateManager(this.PopHub, this.AllAgents);
        this.AccordianManager = new AccordianManager_AccordianManager(this.AllAgents.Logger, this.AllAgents.SettingsAgent);
        this.CommunicationsFeedbackModule = new CommunicationsFeedbackModule_CommunicationsFeedbackModule(PopConst_PopConst.Const.Selector.HS.DivOverlayModule, this.AllAgents.Logger);
        this.FeedbackModuleLog = new UiFeedbackModuleLog_UiFeedbackModuleLog(PopConst_PopConst.Const.ElemId.textAreaFeedback, this.AllAgents.Logger);
        this.FeedbackModuleState = new UiContentStateModule_UiContentStateModule(PopConst_PopConst.Const.Selector.HS.DivStatePopUp, this.AllAgents.Logger);
        this.SelectSnapShotModule = new SelectSnapshotModule_SelectSnapshotModule(PopConst_PopConst.Const.Selector.HS.SelStateSnapShot, this.AllAgents.Logger, this.Helpers().GuidHelper);
        this.AllAgents.Logger.FuncEnd(UiManager_UiManager.name);
    }
    Init() {
        this.AllAgents.Logger.FuncStart(UiManager_UiManager.name, this.Init.name);
        var self = this;
        this.WriteBuildNumToUi();
        this.InitUiTextAreaModules();
        this.ScheduleAutoSaveSnapShot();
        this.ScheduleAutoLogin();
        this.AllAgents.Logger.FuncEnd(UiManager_UiManager.name, this.Init.name);
    }
    SelectChanged() {
        this.SelectSnapShotModule.SelectChanged();
        this.RefreshUi();
    }
    InitUiTextAreaModules() {
    }
    OnFailedCommand(err) {
    ...
    DrawPopUpLogStorage() {
        var lastId = this.AllAgents.SettingsAgent.GetByKey(_3xxx_SettingKey_SettingKey.LastUsedLogToStorageKey);
    ...
    RefreshUiGenericSettings() {
        ...
        for (var idx = 0; idx < this.AllAgents.SettingsAgent.SettingsAr.length; idx++) {
            var oneSetting = this.AllAgents.SettingsAgent.SettingsAr[idx];
    ...
    RefreshUiFromContentState(contentState) {
        return UiManager_awaiter(this, void 0, void 0, function* () {
    ...
    PopulateContentStateDivContent(contentState) {
        ...
        var allStateText = this.lineBreak + 'Content State as of: ' + this.AllAgents.HelperAgent.UtilityHelp.MakeFriendlyDate(new Date());
    ...
    PopulateContentStateDivPopUp() {
        var allStateText = this.lineBreak + 'PopUp State as of: ' + this.AllAgents.HelperAgent.UtilityHelp.MakeFriendlyDate(new Date());
...
class PopUpHub_PopUpHub {
    constructor(allAgents) {
        ...
        this.LocMan = new LocationManager_LocationManager(this, this._allAgents);
        ...
        let communicationsFeedbackModule = new CommunicationsFeedbackModule_CommunicationsFeedbackModule(PopConst_PopConst.Const.Selector.HS.DivMsgStatus, this._allAgents.Logger);
        let PopUpMessageBroker = new PopUpMessagesBroker_PopUpMessagesBroker(this._allAgents.Logger, communicationsFeedbackModule);
    ...
    init() {
        return PopUpHub_awaiter(this, void 0, void 0, function* () {
            this._allAgents.Logger.FuncStart(PopUpHub_PopUpHub.name, this.init.name);
            let setting = yield this._allAgents.SettingsAgent.GetByKey(_3xxx_SettingKey_SettingKey.LogToConsole);
            console.log("setting");
            console.log(setting);
            if (setting) {
                yield this._allAgents.Logger.Init(this._allAgents.SettingsAgent.ValueAsBool(setting));
            }
            else {
                yield this._allAgents.Logger.Init(SharedConst.Const.Settings.Defaults.LogToConsole);
            }
            yield this.TabMan.Init();
            yield this.MessageMan.Init();
            this._allAgents.Logger.DebugIDataBrowserTab(this.TabMan.CurrentTabData);
            this.EventMan.Init();
            this._allAgents.Logger.DebugIDataBrowserTab(this.TabMan.CurrentTabData);
            this._allAgents.Logger.DebugIDataBrowserTab(this.TabMan.CurrentTabData);
            this.UiMan.Init();
            this._allAgents.Logger.FuncEnd(PopUpHub_PopUpHub.name, this.init.name);
...
function main() {
    return zPopUpEntryPoint_awaiter(this, void 0, void 0, function* () {
        ...
        new PopUpHub_PopUpHub(allAgents);
    });
}
main();
