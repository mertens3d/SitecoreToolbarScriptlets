...
class HandlersExternal_HandlersExternal extends CommonEvents {
    ...
    QuickPublish(evt, popHub) {
        return HandlersExternal_awaiter(this, void 0, void 0, function* () {
            popHub.EventMan.Handlers.External.GoContentCommand(new MsgFromPopUp_MsgFromPopUp(MsgFlag.ReqQuickPublish, this.PopHub));
        });
    }
    ...
    MarkFavorite(evt, popHub) {
        popHub.PopMsgMan.SendMessageToContentTab(new MsgFromPopUp_MsgFromPopUp(MsgFlag.ReqMarkFavorite, this.PopHub));
    }
    __DrawStorage(evt, popHub) {
        popHub.PopMsgMan.FromAtticDrawStorage();
    }
    HndlrSnapShotRemove(evt, popHub) {
        var msg = new MsgFromPopUp_MsgFromPopUp(MsgFlag.RemoveFromStorage, this.PopHub);
    ...
    HndlrSnapShotUpdateNickName(evt, popHub) {
        var msg = new MsgFromPopUp_MsgFromPopUp(MsgFlag.ReqUpdateNickName, this.PopHub);
        msg.Data.IdOfSelect = popHub.UiMan.CurrentMenuState.SelectSnapshotId;
