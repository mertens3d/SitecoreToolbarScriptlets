    ...
    OnePing(targetTab, msg) {
        return new Promise((resolve, reject) => PopUpMessagesManager_awaiter(this, void 0, void 0, function* () {
            ...
            yield browser.tabs.sendMessage(targetTab.Tab.id, msg)
                ...
                var asMsgFromContent = response;
                if (asMsgFromContent) {
                    this.AllAgents.Logger.LogVal('Response', StaticHelpers_StaticHelpers.MsgFlagAsString(asMsgFromContent.MsgFlag));
            ...
            if (foundSettings) {
                for (var idx = 0; idx < foundSettings.length; idx++) {
                    ...
                    if (matchingSetting) {
                        ...
                        this.Logger.ErrorAndThrow(this.HarvestGenericSettingsFromStorage.name, 'matching setting not found ' + StaticHelpers_StaticHelpers.SettingKeyAsString(storageSetting.SettingKey));
                    }
                }
            }
            else {
