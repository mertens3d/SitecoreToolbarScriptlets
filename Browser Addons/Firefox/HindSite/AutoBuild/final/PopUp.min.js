...
class MsgPayloadRequestFromPopUp_MsgFromPopUp {
    constructor(msgFlag) {
...
class UiManager_UiManager extends PopUpManagerBase {
    ...
    RefreshUiRequest() {
        ...
        var payload = this.MsgMan().SendMessageHndlr(new MsgPayloadRequestFromPopUp_MsgFromPopUp(MsgFlag.GiveCurrentData));
    ...
    __populateStateOfSnapShotSelect(snapShots) {
...
class PopUpDebug_PopUpDebug extends BaseDebug {
}
...
class EventManager_EventManager extends PopUpManagerBase {
    ...
    __hndlrSelectChange(evt) {
        this.PopHub.UiMan.SelectChanged();
    }
    __RemoveFromStorage(evt) {
    ...
    __hndlrSetScMode(newMode, evt) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            var payload = new MsgPayloadRequestFromPopUp_MsgFromPopUp(MsgFlag.SetScMode);
    ...
    __handlrB() {
        this.MsgMan().SendMessageHndlr(new MsgPayloadRequestFromPopUp_MsgFromPopUp(MsgFlag.AdminB));
    }
    ...
    __hndlrDesktop(evt) {
        this.__initNewOperation();
        this.MsgMan().SendMessageHndlr(new MsgPayloadRequestFromPopUp_MsgFromPopUp(MsgFlag.GoDesktop));
    }
    ...
    __hndlrQuickPublish(evt) {
        return __awaiter(this, void 0, void 0, function* () {
            this.__initNewOperation();
            this.MsgMan().SendMessageHndlr(new MsgPayloadRequestFromPopUp_MsgFromPopUp(MsgFlag.QuickPublish));
    ...
    __hndlrTakeSnapShot(evt) {
        return __awaiter(this, void 0, void 0, function* () {
            this.__initNewOperation();
            this.MsgMan().SendMessageHndlr(new MsgPayloadRequestFromPopUp_MsgFromPopUp(MsgFlag.TakeSnapShot));
        });
    }
    __hndlrAddCETab() {
        return __awaiter(this, void 0, void 0, function* () {
            this.__initNewOperation();
            this.MsgMan().SendMessageHndlr(new MsgPayloadRequestFromPopUp_MsgFromPopUp(MsgFlag.AddCETab));
        });
    }
    __hndlrOpenCE() {
        return __awaiter(this, void 0, void 0, function* () {
            this.__initNewOperation();
            this.MsgMan().SendMessageHndlr(new MsgPayloadRequestFromPopUp_MsgFromPopUp(MsgFlag.OpenCE));
        });
    }
    __initNewOperation() {
    ...
    __hndlrRestoreClick(evt) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.__initNewOperation();
            var payload = new MsgPayloadRequestFromPopUp_MsgFromPopUp(MsgFlag.AddCETab);
            payload.Data.idOfSelect = this.UiMan().GetIdOfSelectWindowSnapshot();
            this.MsgMan().SendMessageHndlr(payload);
...
class MsgRunner_MessageRunner {
    ...
    SendMessageToTabs(tabs) {
        for (let tab of tabs) {
            browser.tabs.sendMessage(tab.id, { greeting: "Hi from background script" }).then(response => {
...
class PopUpMessagesManager_PopUpMessagesManager extends PopUpManagerBase {
    Init() {
        this.MsgRunner = new MsgRunner_MessageRunner(this.ReceiveMessageHndlr, this.SendMessageHndlr, this.debug(), 'PopUp');
    }
...
console.log('did it');
var PopUpHubObj = new PopUpHub_PopUpHub();
