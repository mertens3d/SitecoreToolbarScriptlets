...
class PopUpManagerBase {
    constructor(popHub, allPopUpAgents) {
        this.IsInit = false;
        this.PopHub = popHub;
...
class UiButtonStateManager_UiButtonStateManager extends PopUpManagerBase {
    constructor(popHub, allPopUpAgents) {
        ...
        this.AllPopUpAgents.Logger.FuncStart(UiButtonStateManager_UiButtonStateManager.name);
        this.AllPopUpAgents.Logger.FuncEnd(UiButtonStateManager_UiButtonStateManager.name);
    }
...
class UiManager_UiManager extends PopUpManagerBase {
    constructor(popHub, allPopUpAgents) {
        ...
        this.AllPopUpAgents.Logger.FuncStart(UiManager_UiManager.name);
        this.ButtonStateManager = new UiButtonStateManager_UiButtonStateManager(this.PopHub, this.AllPopUpAgents);
        this.AllPopUpAgents.Logger.FuncEnd(UiManager_UiManager.name);
    }
    Init() {
        this.AllPopUpAgents.Logger.FuncStart(UiManager_UiManager.name, this.Init.name);
        var self = this;
        ...
        this.AllPopUpAgents.Logger.FuncEnd(UiManager_UiManager.name, this.Init.name);
    }
    LookForMsgStatusDiv() {
        this.MsgStatusDiv = document.querySelector(PopConst_PopConst.Const.Selector.HS.DivMsgStatus);
    }
    ...
    WriteBuildNumToUi() {
        ...
        var targetTag = document.querySelector(PopConst_PopConst.Const.Selector.HS.BuildStamp);
        if (targetTag) {
    ...
    __getTextArea() {
        return document.querySelector(PopConst_PopConst.Const.Selector.HS.TaDebug);
    }
    ...
    SetAccordianClass(targetElem, isCollapsed) {
        if (!isCollapsed) {
            targetElem.classList.remove(PopConst_PopConst.Const.ClassNames.HS.Collapsed);
        }
        else {
            targetElem.classList.add(PopConst_PopConst.Const.ClassNames.HS.Collapsed);
        }
    }
    ...
    __GetCancelButton() {
        return document.getElementById(PopConst_PopConst.Const.ElemId.HS.Btn.HsCancel);
    }
    SetCancelFlag() {
    ...
    __drawCorrectNicknameInUI(snapShots) {
        ...
        if (targetId) {
            ...
            if (storageMatch) {
                var inputElem = window.document.getElementById(PopConst_PopConst.Const.ElemId.InputNickname);
                if (inputElem) {
    ...
    GetValueInNickname() {
        var toReturn = '';
        toReturn = window.document.getElementById(PopConst_PopConst.Const.ElemId.InputNickname).value;
        return toReturn;
    }
    __getSelectElem() {
        return window.document.querySelector(PopConst_PopConst.Const.Selector.HS.SelStateSnapShot);
    }
    ...
    PopulateContentStateDivContent(contentState) {
        var targetCurrStateDiv = window.document.querySelector(PopConst_PopConst.Const.Selector.HS.DivStateContent);
    ...
    PopulateContentStateDivPopUp() {
        var targetCurrStateDiv = window.document.querySelector(PopConst_PopConst.Const.Selector.HS.DivStatePopUp);
    ...
    CleanExistingSelection(targetSel) {
        var optGroup = targetSel.querySelector('[id=' + PopConst_PopConst.Const.ElemId.HS.SelectHeaderAutoTitle + ']');
        if (optGroup) {
            optGroup.remove();
        }
        optGroup = targetSel.querySelector('[id=' + PopConst_PopConst.Const.ElemId.HS.SelectHeaderAuto + ']');
        if (optGroup) {
            optGroup.remove();
        }
        optGroup = targetSel.querySelector('[id=' + PopConst_PopConst.Const.ElemId.HS.SelectHeaderFavorite + ']');
        if (optGroup) {
            optGroup.remove();
        }
        optGroup = targetSel.querySelector('[id=' + PopConst_PopConst.Const.ElemId.HS.SelectHeaderFavoriteTitle + ']');
        if (optGroup) {
            optGroup.remove();
        }
    ...
    WriteHeaders(targetSel) {
        ...
        toReturn.Auto.id = PopConst_PopConst.Const.ElemId.HS.SelectHeaderAuto;
        toReturn.AutoTitle = window.document.createElement('optgroup');
        toReturn.AutoTitle.label = 'Auto Snap Shots';
        toReturn.AutoTitle.id = PopConst_PopConst.Const.ElemId.HS.SelectHeaderAutoTitle;
        ...
        toReturn.Favorite.id = PopConst_PopConst.Const.ElemId.HS.SelectHeaderFavorite;
        toReturn.FavoriteTitle = window.document.createElement('optgroup');
        toReturn.FavoriteTitle.label = 'Tyical Snap Shots';
        toReturn.FavoriteTitle.id = PopConst_PopConst.Const.ElemId.HS.SelectHeaderFavoriteTitle;
...
class CommonEvents {
    constructor(hub, allPopUpAgents) {
        this.PopHub = hub;
        this.AllPopUpAgents = allPopUpAgents;
    }
    __cleardebugText() {
...
class HandlersExternal_HandlersExternal extends CommonEvents {
    ...
    CreateNewWindowIfRequired(evt, popHub, tabUrl) {
        return new Promise((resolve, reject) => HandlersExternal_awaiter(this, void 0, void 0, function* () {
            ...
            let result = new PromiseResult(this.CreateNewWindowIfRequired.name, this.AllPopUpAgents.Logger);
            let toReturn;
            if (!evt.ctrlKey) {
        ...
        let toReturn = [
            {
                ...
                ButtonSelector: PopConst_PopConst.Const.Selector.Btn.WindowClose,
            ...
            },
            {
                ...
                ButtonSelector: PopConst_PopConst.Const.ElemId.HS.Btn.BigRed,
            ...
            },
            {
                ...
                ButtonSelector: PopConst_PopConst.Const.ElemId.HS.Btn.ModeEdit,
                VisibilityControllers: [VisibilityType.ActiveCeNode],
                Events: [{
                        Event: CommandButtonEvents.OnClick,
                        Handler: popHub.EventMan.Handlers.Internal.SetScModeInternal,
                        ParameterData: [PopConst_PopConst.Const.ScMode.edit],
                    }]
            },
            {
                Command: MenuCommand.ScModeNormal,
                ButtonSelector: PopConst_PopConst.Const.ElemId.HS.Btn.ModeNorm,
                VisibilityControllers: [VisibilityType.ActiveCeNode],
                Events: [{
                        Event: CommandButtonEvents.OnClick,
                        Handler: popHub.EventMan.Handlers.Internal.SetScModeInternal,
                        ParameterData: [PopConst_PopConst.Const.ScMode.normal],
                    }]
            },
            {
                Command: MenuCommand.ScModePrev,
                ButtonSelector: PopConst_PopConst.Const.ElemId.HS.Btn.ModePrev,
                VisibilityControllers: [VisibilityType.ActiveCeNode],
                Events: [{
                        Event: CommandButtonEvents.OnClick,
                        Handler: popHub.EventMan.Handlers.Internal.SetScModeInternal,
                        ParameterData: [PopConst_PopConst.Const.ScMode.preview],
                    }]
            },
            {
                Command: MenuCommand.UpdateNickname,
                ButtonSelector: PopConst_PopConst.Const.ElemId.HS.Btn.UpdateNicknameB,
            ...
            },
            {
                ...
                ButtonSelector: PopConst_PopConst.Const.ElemId.HS.Btn.PresentationDetails,
                VisibilityControllers: [VisibilityType.ActiveCeNode],
                Events: [{
                        Event: CommandButtonEvents.OnClick,
                        Handler: popHub.EventMan.Handlers.External.HndlrSnapShotUpdateNickName,
            ...
            },
            {
                ...
                ButtonSelector: PopConst_PopConst.Const.ElemId.HS.Btn.AdminB,
            ...
            },
            {
                ...
                ButtonSelector: PopConst_PopConst.Const.ElemId.HS.Btn.GoCE,
            ...
            },
            {
                ...
                ButtonSelector: PopConst_PopConst.Const.ElemId.HS.Btn.QuickPublish,
                VisibilityControllers: [VisibilityType.ActiveCeNode],
                Events: [{
                        Event: CommandButtonEvents.OnClick,
            ...
            },
            {
                ...
                ButtonSelector: PopConst_PopConst.Const.ElemId.HS.Btn.Desktop,
                VisibilityControllers: [VisibilityType.NotLogin],
                Events: [{
                        Event: CommandButtonEvents.OnClick,
            ...
            },
            {
                ...
                ButtonSelector: PopConst_PopConst.Const.ElemId.HS.Btn.TakeSnapshot,
            ...
            },
            {
                ...
                ButtonSelector: PopConst_PopConst.Const.ElemId.HS.Btn.MarkFavorite,
                VisibilityControllers: [VisibilityType.SnapShotSelected],
                Events: [{
            ...
            },
            {
                ...
                ButtonSelector: PopConst_PopConst.Const.ElemId.HS.Btn.HsCancel,
            ...
            },
            {
                ...
                ButtonSelector: PopConst_PopConst.Const.ElemId.HS.Btn.HsRemoveFromStorage,
                VisibilityControllers: [VisibilityType.SnapShotSelected],
                Events: [{
                        Event: CommandButtonEvents.OnClick,
            ...
            },
            {
                ...
                ButtonSelector: PopConst_PopConst.Const.ElemId.HS.Btn.HsRestoreWindowState,
                VisibilityControllers: [VisibilityType.SnapShotSelected],
                Events: [{
                        Event: CommandButtonEvents.OnClick,
            ...
            },
            {
                ...
                ButtonSelector: PopConst_PopConst.Const.ElemId.HS.Btn.HsDrawStorage,
                VisibilityControllers: [],
                Events: [{
                        Event: CommandButtonEvents.OnClick,
...
class EventManager_EventManager extends PopUpManagerBase {
    constructor(popHub, allPopUpAgents) {
        ...
        this.Handlers.External = new HandlersExternal_HandlersExternal(popHub, this.AllPopUpAgents);
        this.Handlers.Internal = new HandlersInternal_HandlersInternal(popHub, this.AllPopUpAgents);
    }
    Init() {
        this.AllPopUpAgents.Logger.FuncStart(EventManager_EventManager.name + this.Init.name);
        ...
        this.AllPopUpAgents.Logger.FuncEnd(EventManager_EventManager.name + this.Init.name);
    }
    ...
    __wireMenuButtons() {
        ...
        this.UiMan().AssignDblClickEvent(PopConst_PopConst.Const.Selector.HS.SelStateSnapShot, (evt) => { this.Handlers.External.HndlrSnapShotRestore(evt, this.PopHub); });
        this.UiMan().AssignDblClickEvent(PopConst_PopConst.Const.Selector.HS.TaDebug, (evt) => { this.Handlers.Internal.__cleardebugTextWithConfirm(evt, this.PopHub); });
        this.UiMan().AssignOnChangeEvent(PopConst_PopConst.Const.Selector.HS.SelStateSnapShot, (evt) => { this.Handlers.Internal.HndlrSelectChange(evt, this.PopHub); });
...
class PopUpMessagesManager_PopUpMessagesManager extends PopUpManagerBase {
    ...
    ReceiveResponseHndlr(response) {
        this.AllPopUpAgents.Logger.FuncStart(this.ReceiveResponseHndlr.name, StaticHelpers_StaticHelpers.MsgFlagAsString(response.MsgFlag));
        if (response) {
            ...
            if (asMsgFromContent) {
                ...
                this.AllPopUpAgents.Logger.Log(StaticHelpers_StaticHelpers.MsgFlagAsString(asMsgFromContent.MsgFlag));
                ...
                switch (response.MsgFlag) {
                    ...
                    case MsgFlag.RespError:
                        ...
                        break;
                    default:
                        this.AllPopUpAgents.Logger.LogVal('Unrecognized MsgFlag', StaticHelpers_StaticHelpers.MsgFlagAsString(response.MsgFlag));
                        break;
                }
            }
            else {
            ...
            this.AllPopUpAgents.Logger.FuncEnd(this.ReceiveResponseHndlr.name, StaticHelpers_StaticHelpers.MsgFlagAsString(response.MsgFlag));
        }
    }
    ...
    OnePing(targetTab, msg) {
        return new Promise((resolve, reject) => PopUpMessagesManager_awaiter(this, void 0, void 0, function* () {
            ...
            var promResult = new PromiseResult(this.OnePing.name, this.AllPopUpAgents.Logger);
    ...
    WaitForListeningTab(targetTab) {
        return PopUpMessagesManager_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => PopUpMessagesManager_awaiter(this, void 0, void 0, function* () {
                ...
                var promResult = new PromiseResult(this.WaitForListeningTab.name, this.AllPopUpAgents.Logger);
    ...
    SendMessageToSingleTab(dataBrowserTab, messageToSend) {
        return new Promise((resolve, reject) => {
            this.AllPopUpAgents.Logger.FuncStart(this.SendMessageToSingleTab.name, StaticHelpers_StaticHelpers.MsgFlagAsString(messageToSend.MsgFlag));
            var result = new PromiseResult(this.SendMessageToSingleTab.name, this.AllPopUpAgents.Logger);
            ...
            this.AllPopUpAgents.Logger.FuncEnd(this.SendMessageToSingleTab.name, StaticHelpers_StaticHelpers.MsgFlagAsString(messageToSend.MsgFlag));
            if (result.WasSuccessful()) {
                resolve();
            }
            else {
    ...
    SendMessageToContentTab(msgPlayload, targetTab = null) {
        return PopUpMessagesManager_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => PopUpMessagesManager_awaiter(this, void 0, void 0, function* () {
                ...
                this.AllPopUpAgents.Logger.FuncStart(this.SendMessageToContentTab.name, StaticHelpers_StaticHelpers.MsgFlagAsString(msgPlayload.MsgFlag));
                var result = new PromiseResult(this.SendMessageToContentTab.name, this.AllPopUpAgents.Logger);
                ...
                this.AllPopUpAgents.Logger.FuncEnd(this.SendMessageToContentTab.name, StaticHelpers_StaticHelpers.MsgFlagAsString(msgPlayload.MsgFlag));
...
class PopUpAtticManager_PopUpAtticManager extends PopUpManagerBase {
    Init() {
        this.AllPopUpAgents.Logger.FuncStart(PopUpAtticManager_PopUpAtticManager.name, this.Init.name);
        this.AllPopUpAgents.Logger.FuncEnd(PopUpAtticManager_PopUpAtticManager.name, this.Init.name);
    }
    ReadGenericSettings() {
            ...
            try {
                yield browser.storage.local.get().then((storageResults) => {
                    ...
                    for (let oneKey of storageKeys) {
                        if (oneKey === PopConst_PopConst.Const.Storage.KeyGenericSettings) {
    ...
    WriteGenericSettings(settingsToWrite) {
        ...
        let storageObj = {
            [PopConst_PopConst.Const.Storage.KeyGenericSettings]: JSON.stringify(settingsToWrite)
        };
...
class FeedbackManager_FeedbackManager extends PopUpManagerBase {
    ...
    __getTextArea() {
        return document.getElementById(PopConst_PopConst.Const.ElemId.textAreaFeedback);
    }
    WriteLine(text) {
        var ta = this.__getTextArea();
        if (ta) {
...
class ConstAllSettings_ConstAllSettings {
    constructor() {
        this.AllSettings = [
            ...
            new OneGenericSetting(SettingKey_SettingKey.LogToConsole, SettingType.BoolCheckBox, null, PopConst_PopConst.Const.Selector.HS.LogToConsole, SharedConst.Const.Settings.Defaults.LogToConsole, SettingFlavor.ContentAndPopUp, 'Log to Console'),
            ...
            new OneGenericSetting(SettingKey_SettingKey.AutoLogin, SettingType.BoolCheckBox, null, PopConst_PopConst.Const.Selector.HS.iCBoxdSettingsAutoLogin, PopConst_PopConst.Const.Storage.Defaults.bool.AutoLogin, SettingFlavor.ContentAndPopUp, 'Auto Login'),
            new OneGenericSetting(SettingKey_SettingKey.LgndLog, SettingType.Accordian, null, PopConst_PopConst.Const.Selector.Legend.LgndDebug, PopConst_PopConst.Const.Settings.Defaults.LgndDebug, SettingFlavor.PopUp, 'Log'),
            new OneGenericSetting(SettingKey_SettingKey.LgndForeSite, SettingType.Accordian, null, PopConst_PopConst.Const.Selector.Legend.LgndForeSite, PopConst_PopConst.Const.Settings.Defaults.LgndForeSite, SettingFlavor.PopUp, 'Fore&bull;Site'),
            new OneGenericSetting(SettingKey_SettingKey.LgndHindSite, SettingType.Accordian, null, PopConst_PopConst.Const.Selector.Legend.LgndHindSite, PopConst_PopConst.Const.Settings.Defaults.LgndHindSite, SettingFlavor.PopUp, 'Hind&bull;Site'),
            new OneGenericSetting(SettingKey_SettingKey.LgndHindSite, SettingType.Accordian, null, PopConst_PopConst.Const.Selector.Legend.LgndInSite, PopConst_PopConst.Const.Settings.Defaults.LgndInSite, SettingFlavor.PopUp, 'In&bull;Site'),
            new OneGenericSetting(SettingKey_SettingKey.LgndSettings, SettingType.Accordian, null, PopConst_PopConst.Const.Selector.Legend.LgndSettings, PopConst_PopConst.Const.Settings.Defaults.LgndSettings, SettingFlavor.PopUp, 'Settings'),
            new OneGenericSetting(SettingKey_SettingKey.LgndState, SettingType.Accordian, null, PopConst_PopConst.Const.Selector.Legend.LgndState, PopConst_PopConst.Const.Settings.Defaults.LgndState, SettingFlavor.PopUp, 'State'),
            new OneGenericSetting(SettingKey_SettingKey.MaxAutoSaveCount, SettingType.Number, null, PopConst_PopConst.Const.Selector.HS.SettingAutoSaveMaxCount, PopConst_PopConst.Const.Numbers.MaxAutoSaveCount, SettingFlavor.ContentAndPopUp, 'Auto Save Max Count'),
            new OneGenericSetting(SettingKey_SettingKey.AutoSaveIntervalMin, SettingType.Number, null, PopConst_PopConst.Const.Selector.HS.SettingAutoSaveInterval, PopConst_PopConst.Const.Numbers.AutoSaveIntervalMin, SettingFlavor.ContentAndPopUp, 'Auto Save Interval (Min) - 0 to disable'),
...
class SettingsManager_SettingsManager extends PopUpManagerBase {
            ...
            if (foundSettings) {
                for (var idx = 0; idx < foundSettings.length; idx++) {
                    ...
                    if (matchingSetting) {
                        ...
                        this.AllPopUpAgents.Logger.Error(this.HarvestNonDefaultGenericSettingsFromStorage.name, 'matching setting not found ' + StaticHelpers_StaticHelpers.SettingKeyAsString(storageSetting.SettingKey));
                    }
                }
            }
            else {
    ...
    SettingChanged(SettingKey, valueAsObj) {
        this.AllPopUpAgents.Logger.Log(StaticHelpers_StaticHelpers.SettingKeyAsString(SettingKey));
    ...
    SetByKey(settingKey, value) {
        this.AllPopUpAgents.Logger.FuncStart(this.SetByKey.name, StaticHelpers_StaticHelpers.SettingKeyAsString(settingKey));
        let foundSetting = this.Helpers().SettingsHelp.GetByKey(settingKey, this.AllSettings.SettingsAr);
        if (foundSetting) {
        ...
        this.AllPopUpAgents.Logger.FuncEnd(this.SetByKey.name, StaticHelpers_StaticHelpers.SettingKeyAsString(settingKey));
    }
}
...
class TabManager_TabManager extends PopUpManagerBase {
    constructor(hub, allPopUpAgents) {
        ...
        this.AllPopUpAgents.Logger.FuncStart(TabManager_TabManager.name);
        this.AllPopUpAgents.Logger.FuncEnd(TabManager_TabManager.name);
    }
    MakeTabData(rawTab) {
        let toReturn = {
            Tab: rawTab,
    ...
    Init() {
        return TabManager_awaiter(this, void 0, void 0, function* () {
            this.AllPopUpAgents.Logger.FuncStart(TabManager_TabManager.name, this.Init.name);
            ...
            this.AllPopUpAgents.Logger.FuncEnd(TabManager_TabManager.name, this.Init.name);
        });
    }
    GetAssociatedTab() {
        return TabManager_awaiter(this, void 0, void 0, function* () {
...
class LocationManager_LocationManager extends PopUpManagerBase {
    constructor(hub, allPopUpAgents) {
        super(hub, allPopUpAgents);
        this.AllPopUpAgents.Logger.FuncStart(LocationManager_LocationManager.name);
        this.AllPopUpAgents.Logger.FuncEnd(LocationManager_LocationManager.name);
    }
    ...
    SetScModeFromCeDt(newValue, currentPageType) {
        return LocationManager_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => LocationManager_awaiter(this, void 0, void 0, function* () {
                ...
                this.AllPopUpAgents.Logger.LogVal('WindowType', StaticHelpers_StaticHelpers.WindowTypeAsString(currentPageType));
                let result = new PromiseResult(this.SetScModeFromCeDt.name, this.AllPopUpAgents.Logger);
                this.AllPopUpAgents.Logger.MarkerA();
    ...
    SetScMode(newValue) {
        return new Promise((resolve, reject) => LocationManager_awaiter(this, void 0, void 0, function* () {
            ...
            let result = new PromiseResult(this.SetScMode.name, this.AllPopUpAgents.Logger);
...
class PromiseGeneric_PromiseHelper extends HelperBase {
    WaitForReadyIframe(dataOneIframe) {
        return PromiseGeneric_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => PromiseGeneric_awaiter(this, void 0, void 0, function* () {
                ...
                let promiseResult = new PromiseResult(this.WaitForReadyIframe.name, this.LoggerAgentBase);
    ...
    WaitForPageReadyNative(targetDoc) {
        return PromiseGeneric_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => PromiseGeneric_awaiter(this, void 0, void 0, function* () {
                ...
                var result = new PromiseResult(this.WaitForPageReadyNative.name, this.LoggerAgentBase);
    ...
    WaitForIframeElemAndReturnWhenReady(haystackDoc, selector, iframeNickName) {
        return PromiseGeneric_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => PromiseGeneric_awaiter(this, void 0, void 0, function* () {
                ...
                let promiseResult = new PromiseResult(this.WaitForIframeElemAndReturnWhenReady.name, this.LoggerAgentBase);
    ...
    WaitForAndReturnFoundElem(haystackDoc, selector, overrideIterCount = 8) {
        return PromiseGeneric_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => PromiseGeneric_awaiter(this, void 0, void 0, function* () {
                ...
                let promiseResult = new PromiseResult(this.WaitForAndReturnFoundElem.name, this.LoggerAgentBase);
    ...
    TabWaitForReadyStateCompleteNative(browserTab) {
        return new Promise((resolve, reject) => PromiseGeneric_awaiter(this, void 0, void 0, function* () {
            ...
            let result = new PromiseResult(this.TabWaitForReadyStateCompleteNative.name, this.LoggerAgentBase);
    ...
    WaitForThenClick(selectorAr, targetDoc) {
        return new Promise((resolve, reject) => PromiseGeneric_awaiter(this, void 0, void 0, function* () {
            ...
            let promiseResults = new PromiseResult(this.WaitForThenClick.name, this.LoggerAgentBase);
            if (targetDoc) {
...
class Helpers_HelperHub {
    constructor(logger) {
        this.Log = logger;
        this.Log.FuncStart(Helpers_HelperHub.name);
        this.Init();
        this.Log.FuncEnd(Helpers_HelperHub.name);
    }
    Init() {
    ...
    CreateNewTab(tabUrl) {
        return BrowserManager_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => BrowserManager_awaiter(this, void 0, void 0, function* () {
                ...
                let result = new PromiseResult(this.CreateNewTab.name, this.AllPopUpAgents.Logger);
                let newTab;
...
class PopUpHub_PopUpHub {
    constructor(allPopUpAgents) {
        this.AllPopUpAgents = allPopUpAgents;
        this.SettingsMan = new SettingsManager_SettingsManager(this, this.AllPopUpAgents);
        this.PopUpAtticMan = new PopUpAtticManager_PopUpAtticManager(this, this.AllPopUpAgents);
        this.PopMsgMan = new PopUpMessagesManager_PopUpMessagesManager(this, this.AllPopUpAgents);
        this.UiMan = new UiManager_UiManager(this, this.AllPopUpAgents);
        this.EventMan = new EventManager_EventManager(this, this.AllPopUpAgents);
        this.Helpers = new Helpers_HelperHub(this.AllPopUpAgents.Logger);
        this.LocMan = new LocationManager_LocationManager(this, this.AllPopUpAgents);
        this.FeedbackMan = new FeedbackManager_FeedbackManager(this, this.AllPopUpAgents);
        this.TabMan = new TabManager_TabManager(this, this.AllPopUpAgents);
        this.BrowserMan = new BrowserManager_BrowserManager(this, this.logger);
        this.init();
    }
    init() {
        return PopUpHub_awaiter(this, void 0, void 0, function* () {
            this.AllPopUpAgents.Logger.FuncStart(PopUpHub_PopUpHub.name, this.init.name);
            ...
            if (setting) {
                this.AllPopUpAgents.Logger.Init(SettingsHelper_SettingsHelper.ValueAsBool(setting));
            }
            else {
            ...
            this.PopMsgMan.Init();
            this.UiMan.Init();
            this.AllPopUpAgents.Logger.FuncEnd(PopUpHub_PopUpHub.name, this.init.name);
            this.AllPopUpAgents.Logger.Log('');
            this.AllPopUpAgents.Logger.Log('');
        });
    }
...
// CONCATENATED MODULE: ./AutoBuild/TsTranspiled/Shared/scripts/Agents/LoggerAgentBase.js




class LoggerAgentBase_LoggerAgentBase {
    constructor() {
...
// CONCATENATED MODULE: ./AutoBuild/TsTranspiled/PopUp/scripts/Agents/LoggerPopUpAgent.js


class LoggerPopUpAgent_LoggerPopUpAgent extends LoggerAgentBase_LoggerAgentBase {
...
// CONCATENATED MODULE: ./AutoBuild/TsTranspiled/PopUp/scripts/Agents/AllPopUpAgents.js

class AllPopUpAgents_AllPopUpAgents extends LoggerAgentBase_LoggerAgentBase {
}
...
var EntryPoint_allPopUpAgents = new AllPopUpAgents_AllPopUpAgents();
EntryPoint_allPopUpAgents.Logger = new LoggerPopUpAgent_LoggerPopUpAgent();
new PopUpHub_PopUpHub(EntryPoint_allPopUpAgents);
