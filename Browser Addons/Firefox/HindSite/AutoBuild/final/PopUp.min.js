...
class UrlHelper_UrlHelper extends HelperBase {
    ...
    BuildEditPrevNormUrl(scMode, contState, urlParts) {
        ...
        urlParts.FilePath = '';
        urlParts.Parameters = [];
        urlParts.ScWindowType = scWindowType_scWindowType.Unknown;
    ...
    CalcPageTypeFromHref(absUrl) {
        ...
        this.Logger.FuncEnd(this.CalcPageTypeFromHref.name, scWindowType_scWindowType[toReturn]);
        return toReturn;
    }
}
...
class HandlersExternal_HandlersExternal extends CommonEvents {
    BuildNewMsgFromPopUp(msgFlag) {
        ...
        var msg = new MsgFromPopUp_MsgFromPopUp(msgFlag, this.PopHub.TabMan.CurrentTabData.UrlParts.ScWindowType, this.PopHub.UiMan.ModuleSelectSnapShot.GetSelectSnapshotId(), this.PopHub._allAgents.SettingsAgent.GetOnlyContentPrefs());
    ...
    AddCETab(evt, popHub) {
        return HandlersExternal_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => HandlersExternal_awaiter(this, void 0, void 0, function* () {
                let msg = popHub.EventMan.Handlers.External.BuildNewMsgFromPopUp(MsgFlag.ReqAddCETab);
    ...
    PutAdminB(evt, popHub) {
        return HandlersExternal_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => HandlersExternal_awaiter(this, void 0, void 0, function* () {
                let msg = popHub.EventMan.Handlers.External.BuildNewMsgFromPopUp(MsgFlag.ReqAdminB);
                yield popHub.EventMan.Handlers.External.GoContentCommand(msg)
                    .then(() => resolve())
                    .catch((err) => reject(err));
            }));
    ...
    QuickPublish(evt, popHub) {
        return HandlersExternal_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => HandlersExternal_awaiter(this, void 0, void 0, function* () {
                let msg = popHub.EventMan.Handlers.External.BuildNewMsgFromPopUp(MsgFlag.ReqQuickPublish);
                yield popHub.EventMan.Handlers.External.GoContentCommand(msg)
                    .then(() => resolve())
                    .catch((err) => reject(err));
            }));
    ...
    HndlrSnapShotCreate(evt, popHub) {
        return HandlersExternal_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => HandlersExternal_awaiter(this, void 0, void 0, function* () {
                let msg = popHub.EventMan.Handlers.External.BuildNewMsgFromPopUp(MsgFlag.ReqTakeSnapShot);
                yield popHub.EventMan.Handlers.External.GoContentCommand(msg)
                    .then(() => resolve())
                    .catch((err) => reject(err));
            }));
    ...
    HndlrSnapShotUpdateNickName(evt, popHub) {
        return HandlersExternal_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => HandlersExternal_awaiter(this, void 0, void 0, function* () {
                let msg = popHub.EventMan.Handlers.External.BuildNewMsgFromPopUp(MsgFlag.ReqUpdateNickName);
    ...
    Ping(evt, popHub) {
        return HandlersExternal_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => HandlersExternal_awaiter(this, void 0, void 0, function* () {
                let msg = popHub.EventMan.Handlers.External.BuildNewMsgFromPopUp(MsgFlag.Ping);
                yield popHub.EventMan.Handlers.External.GoContentCommand(msg)
                    .then(() => resolve())
                    .catch((err) => reject(err));
            }));
    ...
    MarkFavorite(evt, popHub, tanManagerTempFix) {
        return new Promise((resolve, reject) => HandlersExternal_awaiter(this, void 0, void 0, function* () {
            var msg = popHub.EventMan.Handlers.External.BuildNewMsgFromPopUp(MsgFlag.ReqMarkFavorite);
            yield popHub.EventMan.Handlers.External.GoContentCommand(msg)
                .then(() => resolve())
                .catch((err) => reject(err));
        }));
    ...
    HndlrSnapShotRemove(evt, popHub) {
        return new Promise((resolve, reject) => HandlersExternal_awaiter(this, void 0, void 0, function* () {
            let msg = popHub.EventMan.Handlers.External.BuildNewMsgFromPopUp(MsgFlag.RemoveFromStorage);
            msg.Data.SnapShotSettings.SnapShotNewNickname = popHub.UiMan.GetValueInNickname();
            yield popHub.EventMan.Handlers.External.GoContentCommand(msg)
                .then(() => resolve())
                .catch((err) => reject(err));
    ...
    HndlrCompactCE(evt, popHub) {
        return new Promise((resolve, reject) => HandlersExternal_awaiter(this, void 0, void 0, function* () {
            let msg = popHub.EventMan.Handlers.External.BuildNewMsgFromPopUp(MsgFlag.ReqToggleCompactCss);
            msg.Data.SnapShotSettings.SnapShotNewNickname = popHub.UiMan.GetValueInNickname();
            yield popHub.EventMan.Handlers.External.GoContentCommand(msg)
                .then(() => resolve())
                .catch((err) => reject(err));
...
class HandlersInternal_HandlersInternal extends CommonEvents {
    ...
    GoCeInternal(evt, popHub) {
        return HandlersInternal_awaiter(this, void 0, void 0, function* () {
            popHub.LocMan.ChangeLocationSwitchBoard(scWindowType_scWindowType.ContentEditor);
        });
    }
    GoDesktopInternal(evt, popHub) {
        popHub.LocMan.ChangeLocationSwitchBoard(scWindowType_scWindowType.Desktop);
    }
...
class EventManager_EventManager extends PopUpManagerBase {
    ...
    TriggerPingEvent() {
        return new Promise((resolve, reject) => EventManager_awaiter(this, void 0, void 0, function* () {
            ...
            yield this.Handlers.External.Ping(null, this.PopHub);
...
class LocationManager_LocationManager extends PopUpManagerBase {
    ...
    ChangeLocationSwitchBoard(desiredPageType) {
        ...
        if (iteration.DecrementAndKeepGoing()) {
            ...
            if (this.TabMan().CurrentTabData.UrlParts.ScWindowType === scWindowType_scWindowType.LoginPage) {
                var self = this;
...
class SelectSnapshotModule_SelectSnapshotModule {
    ...
    Init() {
        this.AssignOnChangeEvent(PopConst_PopConst.Const.Selector.HS.SelStateSnapShot);
    }
    ...
    SelectHeaderStr(prefix) {
        let toReturn = StaticHelpers_StaticHelpers.BufferString('', 4, BufferChar.Period, BufferDirection.right)
            + StaticHelpers_StaticHelpers.BufferString('Time Stamp', PopConst_PopConst.Const.SnapShotFormat.lenTimestamp, BufferChar.Period, BufferDirection.right)
...
class FeedbackModuleBrowserState_FeedbackModuleBrowserState extends UiFeedbackModuleBase {
    ...
    PopulateFeedackBrowserState(urlParts) {
        var targetCurrStateDiv = window.document.querySelector(PopConst_PopConst.Const.Selector.HS.FeedbackBrowserState);
...
class UiManager_UiManager extends PopUpManagerBase {
    ...
    RefreshUi() {
        return UiManager_awaiter(this, void 0, void 0, function* () {
            ...
            yield this.SetUIStates(this.TabMan().CurrentTabData.UrlParts);
