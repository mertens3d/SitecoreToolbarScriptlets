...
// CONCATENATED MODULE: ./AutoBuild/TsTranspiled/PopUp/scripts/Managers/UiMessageOverlayModule.js

class UiMessageOverlayModule_UiCommunicationFeedbackModule {
    constructor(overlayElem, loggerAgent) {
        this.Logger = loggerAgent;
...
class UiManager_UiManager extends PopUpManagerBase {
    constructor(popHub, allAgents) {
        ...
        this.MessageFeedbackModule = new UiMessageOverlayModule_UiCommunicationFeedbackModule(document.querySelector(PopConst_PopConst.Const.Selector.HS.DivOverlayModule), this.AllAgents.Logger);
...
class PopUpHub_PopUpHub {
    constructor(allAgents) {
        ...
        let PopUpMessageBroker = new PopUpMessagesBroker_PopUpMessagesBroker(this._allAgents.Logger, this.UiMan.MessageFeedbackModule);
