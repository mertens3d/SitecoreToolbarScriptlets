    ...
    SetScMode(newValue) {
        return new Promise((resolve, reject) => LocationManager_awaiter(this, void 0, void 0, function* () {
            ...
            if (currentPageType === scWindowType.ContentEditor
                ...
                yield this.AllAgents.HelperAgent.PromiseHelper.TabChainSetHrefWaitForComplete(newHref, this.TabMan().CurrentTabData)
                    .then(() => result.MarkSuccessful())
                    .catch((ex) => result.MarkFailed(ex));
            }
...
class Helpers_HelperAgent {
    ...
    Init(logger, helperAgent) {
        ...
        this.PromiseHelper = new PromiseGeneric_PromiseHelper(logger, helperAgent);
