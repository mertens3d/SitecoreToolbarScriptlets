...
class UiManager_UiManager extends PopUpManagerBase {
    ...
    WriteBuildNumToUi() {
        ...
        var targetTag = document.querySelector(this.PopConst().Selector.HS.BuildStamp);
        if (targetTag) {
...
class ExternalEvents_ExternalEvents extends CommonEvents_CommonEvents {
    ...
    __hndlrQuickPublish(evt) {
        return ExternalEvents_awaiter(this, void 0, void 0, function* () {
            ...
            this.MsgMan().SendMessageHndlr(new MsgPayloadRequestFromPopUp_MsgFromPopUp(MsgFlag.RespTaskSuccessful));
        });
    }
    ...
    HndlrSnapShotUpdateNickName() {
        ...
        var payload = new MsgPayloadRequestFromPopUp_MsgFromPopUp(MsgFlag.ReqUpdateNickName);
        payload.Data.IdOfSelect = this.UiMan().GetIdOfSelectWindowSnapshot();
...
class PopUpMessagesManager_PopUpMessagesManager extends PopUpManagerBase {
    ...
    AutoLogin() {
        if (this.CachedSate.WindowType === scWindowType.LoginPage) {
            this.SendMessageHndlr(new MsgPayloadRequestFromPopUp_MsgFromPopUp(MsgFlag.ReqLoginWithAdminB));
        }
    }
    ...
    SendMessageHndlr(msgPlayload) {
        return PopUpMessagesManager_awaiter(this, void 0, void 0, function* () {
            this.debug().FuncStart(this.SendMessageHndlr.name, StaticHelpers_StaticHelpers.MsgFlagAsString(msgPlayload.MsgFlag));
            ...
            this.debug().FuncEnd(this.SendMessageHndlr.name, StaticHelpers_StaticHelpers.MsgFlagAsString(msgPlayload.MsgFlag));
        });
    }
