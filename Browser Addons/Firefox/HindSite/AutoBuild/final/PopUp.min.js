        ...
        return PopUpMessagesManager_awaiter(this, void 0, void 0, function* () {
            try {
                yield browser.storage.local.get()
                    .then((storageResults) => {
                    var lastId = this.AllAgents.SettingsAgent.GetByKey(SettingKey_SettingKey.LastUsedLogToStorageKey);
                    this.AllAgents.Logger.LogAsJsonPretty('lastId xxxx', lastId);
                    let keyToUse = PopConst_PopConst.Const.Storage.StorageLogKeyPrefix + lastId.ValueAsInt();
