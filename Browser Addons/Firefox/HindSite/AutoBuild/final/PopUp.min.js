...
(function (MenuCommand) {
    ...
    MenuCommand[MenuCommand["DrawStoragePopUpLogStorage"] = 10] = "DrawStoragePopUpLogStorage";
    MenuCommand[MenuCommand["Remove"] = 11] = "Remove";
    MenuCommand[MenuCommand["RestoreState"] = 12] = "RestoreState";
    MenuCommand[MenuCommand["UpdateNickname"] = 13] = "UpdateNickname";
    MenuCommand[MenuCommand["QuickPublish"] = 14] = "QuickPublish";
    MenuCommand[MenuCommand["GoDesktop"] = 15] = "GoDesktop";
    MenuCommand[MenuCommand["GoContentEditor"] = 16] = "GoContentEditor";
    MenuCommand[MenuCommand["PutAdminB"] = 17] = "PutAdminB";
    MenuCommand[MenuCommand["PresentationDetails"] = 18] = "PresentationDetails";
    MenuCommand[MenuCommand["CompactCE"] = 19] = "CompactCE";
...
class UiManager_UiManager extends PopUpManagerBase {
    ...
    OnSuccessfullCommand() {
        ...
        try {
            ...
            let setting = this.AllAgents.SettingsAgent.GetByKey(SettingKey_SettingKey.DebugKeepDialogOpen);
            if (!this.AllAgents
    ...
    RestoreaccordionState(oneSetting, foundElem) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (contentSib) {
                this.SetaccordionClass(contentSib, oneSetting.ValueAsObj);
            }
            else {
...
class HandlersExternal_HandlersExternal extends CommonEvents {
    ...
    HndlrCompactCE(evt, popHub) {
        var msg = new MsgFromPopUp_MsgFromPopUp(MsgFlag.ReqCompactCE, popHub);
        this.GoContentCommand(msg);
    }
...
class HandlersInternal_HandlersInternal extends CommonEvents {
    ...
    Toggleaccordion(evt, popHub, settingKey) {
        ...
        if (foundContentSib) {
            var oldValue = this.AllAgents.SettingsAgent.GetByKey(settingKey);
            if (oldValue) {
...
class PopUpMessagesManager_PopUpMessagesManager extends PopUpManagerBase {
    ...
    ReceiveResponseHndlr(response) {
        this.AllAgents.Logger.FuncStart(this.ReceiveResponseHndlr.name, StaticHelpers_StaticHelpers.MsgFlagAsString(response.MsgFlag));
        if (response) {
            ...
            if (asMsgFromContent) {
                ...
                this.AllAgents.Logger.Log(StaticHelpers_StaticHelpers.MsgFlagAsString(asMsgFromContent.MsgFlag));
                ...
                switch (response.MsgFlag) {
                    ...
                    case MsgFlag.RespError:
                        ...
                        break;
                    default:
                        this.AllAgents.Logger.LogVal('Unrecognized MsgFlag', StaticHelpers_StaticHelpers.MsgFlagAsString(response.MsgFlag));
                        break;
                }
            }
            else {
            ...
            this.AllAgents.Logger.FuncEnd(this.ReceiveResponseHndlr.name, StaticHelpers_StaticHelpers.MsgFlagAsString(response.MsgFlag));
        }
    }
    ...
    OnePing(targetTab, msg) {
        return new Promise((resolve, reject) => PopUpMessagesManager_awaiter(this, void 0, void 0, function* () {
            ...
            var promResult = new PromiseResult(this.OnePing.name, this.AllAgents.Logger);
    ...
    WaitForListeningTab(targetTab) {
        return PopUpMessagesManager_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => PopUpMessagesManager_awaiter(this, void 0, void 0, function* () {
                ...
                var promResult = new PromiseResult(this.WaitForListeningTab.name, this.AllAgents.Logger);
                var iterationJr = new IterationDrone_IterationDrone(this.AllAgents.Logger, this.WaitForListeningTab.name);
    ...
    SendMessageToSingleTab(dataBrowserTab, messageToSend) {
        return new Promise((resolve, reject) => PopUpMessagesManager_awaiter(this, void 0, void 0, function* () {
            this.AllAgents.Logger.FuncStart(this.SendMessageToSingleTab.name, StaticHelpers_StaticHelpers.MsgFlagAsString(messageToSend.MsgFlag));
            var result = new PromiseResult(this.SendMessageToSingleTab.name, this.AllAgents.Logger);
            this.UiMan().UpdateMsgStatusStack('Sending Msg: ' + StaticHelpers_StaticHelpers.MsgFlagAsString(messageToSend.MsgFlag));
            yield browser.tabs.sendMessage(dataBrowserTab.Tab.id, messageToSend)
                .then((response) => this.ReceiveResponseHndlr(response))
                .then(() => result.MarkSuccessful())
                .catch((ex) => {
                result.MarkFailed(ex);
            });
            this.AllAgents.Logger.FuncEnd(this.SendMessageToSingleTab.name, StaticHelpers_StaticHelpers.MsgFlagAsString(messageToSend.MsgFlag));
            if (result.WasSuccessful()) {
                resolve();
            }
            else {
    ...
    SendMessageToContentTab(msgPlayload, targetTab = null) {
        return PopUpMessagesManager_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => PopUpMessagesManager_awaiter(this, void 0, void 0, function* () {
                this.AllAgents.Logger.FuncStart(this.SendMessageToContentTab.name, StaticHelpers_StaticHelpers.MsgFlagAsString(msgPlayload.MsgFlag));
                if (!targetTab) {
                    targetTab = this.TabMan().CurrentTabData;
                }
                var promResult = new PromiseResult(this.SendMessageToContentTab.name, this.AllAgents.Logger);
                ...
                this.AllAgents.Logger.FuncEnd(this.SendMessageToContentTab.name, StaticHelpers_StaticHelpers.MsgFlagAsString(msgPlayload.MsgFlag));
                if (promResult.WasSuccessful()) {
                    resolve();
                }
                else {
    ...
    FromAtticDrawPopUpLogStorage() {
        return PopUpMessagesManager_awaiter(this, void 0, void 0, function* () {
            try {
                yield browser.storage.local.get()
                    .then((storageResults) => {
                    let lastId = storageResults[PopConst_PopConst.Const.Storage.StorageLastKeyKey];
                    let keyToUse = PopConst_PopConst.Const.Storage.StorageLogKeyPrefix + lastId;
                    console.log("keyToUse: " + keyToUse);
                    let storedValue = storageResults[keyToUse];
                    if (storedValue) {
                        let valueSplit = storedValue.toString().split('|||');
                        if (valueSplit) {
...
class PromiseGeneric_PromisesBasic extends HelperBase {
    ...
    GetAllLiveIframeData(targetDoc) {
        return new Promise((resolve, reject) => {
            ...
            let rejectReason = '';
            var toReturn = [];
            this.Logger.LogVal('querySelectorAll 9.2: ', InjectConst_ContentConst.Const.Selector.SC.IframeContent.sc920);
    ...
    CreateNewTab(tabUrl) {
        return BrowserManager_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => BrowserManager_awaiter(this, void 0, void 0, function* () {
                ...
                let result = new PromiseResult(this.CreateNewTab.name, this.AllAgents.Logger);
                let newTab;
...
class PopUpHub_PopUpHub {
    constructor(allAgents) {
        ...
        this.PopMsgMan = new PopUpMessagesManager_PopUpMessagesManager(this, this._allAgents);
        ...
        this.FeedbackMan = new FeedbackManager_FeedbackManager(this, this._allAgents);
    ...
    init() {
        return PopUpHub_awaiter(this, void 0, void 0, function* () {
            ...
            let setting = yield this._allAgents.SettingsAgent.GetByKey(SettingKey_SettingKey.LogToConsole);
            console.log("setting");
            console.log(setting);
            if (setting) {
...
class SettingsAgent_SettingsAgent {
    ...
    HarvestNonDefaultGenericSettingsFromStorage() {
        return SettingsAgent_awaiter(this, void 0, void 0, function* () {
            ...
            let foundSettings;
            try {
                foundSettings = yield this.RepoAgent.ReadGenericSettings();
            }
            catch (e) {
            ...
            if (foundSettings) {
                for (var idx = 0; idx < foundSettings.length; idx++) {
                    ...
                    if (matchingSetting) {
                        ...
                        this.Logger.ErrorAndThrow(this.HarvestNonDefaultGenericSettingsFromStorage.name, 'matching setting not found ' + StaticHelpers_StaticHelpers.SettingKeyAsString(storageSetting.SettingKey));
                    }
                }
            }
            else {
...
var RollingLogIdDrone_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
class RollingLogIdDrone_RollingLogIdDrone {
    constructor() {
        this.CurrentStorageLogKey = null;
    }
    Init() {
        return RollingLogIdDrone_awaiter(this, void 0, void 0, function* () {
            yield this.GetLogId()
    ...
    GetLogId() {
        return RollingLogIdDrone_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => RollingLogIdDrone_awaiter(this, void 0, void 0, function* () {
                if (!this.CurrentStorageLogKey) {
                    console.log("building new prefix");
                    yield this.GetLastUsedLogId()
                        .then((result) => {
                        let nextKey = result + 1;
                        if (nextKey > 10) {
                            nextKey = 0;
                        }
                        this.CurrentStorageLogKey = PopConst_PopConst.Const.Storage.StorageLogKeyPrefix + nextKey;
                        console.log("Using " + this.CurrentStorageLogKey);
                        let storageObj = {
                            [PopConst_PopConst.Const.Storage.StorageLastKeyKey]: nextKey
                        };
    ...
    GetLastUsedLogId() {
        return RollingLogIdDrone_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve) => RollingLogIdDrone_awaiter(this, void 0, void 0, function* () {
                let toReturn = 0;
                console.log("getting last");
                yield browser.storage.local.get()
                    .then((storageResults) => {
                    let storedValue = storageResults[PopConst_PopConst.Const.Storage.StorageLastKeyKey];
                    if (storedValue) {
...
// CONCATENATED MODULE: ./AutoBuild/TsTranspiled/Shared/scripts/Agents/Agents/LoggerAgent/LoggerAgentBase.js
var LoggerAgentBase_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
class LoggerAgentBase_LoggerAgent {
    constructor() {
        ...
        this.LogHasBeenInit = false;
        this.RollingLogId = new RollingLogIdDrone_RollingLogIdDrone();
    ...
    WriteLogToStorage(logMessage) {
        return LoggerAgentBase_awaiter(this, void 0, void 0, function* () {
            return new Promise(() => LoggerAgentBase_awaiter(this, void 0, void 0, function* () {
                this.StorageLogCombined += "|||" + JSON.stringify(logMessage);
                let storageObj = {
                    [this.RollingLogId.CurrentStorageLogKey]: this.StorageLogCombined
                };
                yield browser.storage.local.set(storageObj);
            }));
        });
    }
...
class ConstAllSettings_ConstAllSettings {
    constructor() {
        this.AllSettings = [
            ...
            new OneGenericSetting(SettingKey_SettingKey.LogToConsole, SettingType.BoolCheckBox, true, PopConst_PopConst.Const.Selector.HS.LogToConsole, SharedConst.Const.Settings.Defaults.LogToConsole, SettingFlavor.ContentAndPopUp, 'Log to Console'),
...
var EntryPoint_allAgents = new AllAgents();
EntryPoint_allAgents.Logger = new LoggerAgentBase_LoggerAgent();
EntryPoint_allAgents.RepoAgent = new RepoAgent_RepoAgent(EntryPoint_allAgents.Logger);
EntryPoint_allAgents.SettingsAgent = new SettingsAgent_SettingsAgent(EntryPoint_allAgents.Logger, EntryPoint_allAgents.RepoAgent);
var allSettings = new ConstAllSettings_ConstAllSettings().AllSettings;
EntryPoint_allAgents.Logger.LogAsJsonPretty("allSettings", allSettings);
EntryPoint_allAgents.SettingsAgent.Init(allSettings);
EntryPoint_allAgents.HelperAgent = new Helpers_HelperAgent(EntryPoint_allAgents.Logger);
new PopUpHub_PopUpHub(EntryPoint_allAgents);
