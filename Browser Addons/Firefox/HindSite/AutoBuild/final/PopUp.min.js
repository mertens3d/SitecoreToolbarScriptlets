    ...
    SendMessageToContentTab(msgPlayload, targetTab = null) {
        return PopUpMessagesManager_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => PopUpMessagesManager_awaiter(this, void 0, void 0, function* () {
                ...
                var result = new PromiseResult(this.SendMessageToContentTab.name, this.AllAgents.Logger);
...
class SettingsManager_SettingsManager extends PopUpManagerBase {
    ...
    HarvestNonDefaultGenericSettingsFromStorage() {
        return SettingsManager_awaiter(this, void 0, void 0, function* () {
            ...
            let foundSettings;
            try {
                foundSettings = yield this.AllAgents.RepoAgent.ReadGenericSettings();
            }
            catch (e) {
            ...
            if (foundSettings) {
                for (var idx = 0; idx < foundSettings.length; idx++) {
                    ...
                    let matchingSetting = this.AllAgents.SettingsAgent.GetByKey(storageSetting.SettingKey);
                    if (matchingSetting) {
                        matchingSetting.ValueAsObj = storageSetting.ValueAsObj;
                    }
                    else {
                        this.AllAgents.Logger.Error(this.HarvestNonDefaultGenericSettingsFromStorage.name, 'matching setting not found ' + StaticHelpers_StaticHelpers.SettingKeyAsString(storageSetting.SettingKey));
                    }
                }
            }
            else {
    ...
    SettingChanged(SettingKey, valueAsObj) {
        this.AllAgents.Logger.Log(StaticHelpers_StaticHelpers.SettingKeyAsString(SettingKey));
    ...
    SetByKey(settingKey, value) {
        this.AllAgents.Logger.FuncStart(this.SetByKey.name, StaticHelpers_StaticHelpers.SettingKeyAsString(settingKey));
        let foundSetting = this.AllAgents.SettingsAgent.GetByKey(settingKey);
        if (foundSetting) {
        ...
        this.AllAgents.Logger.FuncEnd(this.SetByKey.name, StaticHelpers_StaticHelpers.SettingKeyAsString(settingKey));
    }
}
...
class PopUpHub_PopUpHub {
    constructor(allAgents) {
        ...
        this.SettingsMan = new SettingsManager_SettingsManager(this, this._allAgents);
...
EntryPoint_allAgents.SettingsAgent = new SettingsAgent();
