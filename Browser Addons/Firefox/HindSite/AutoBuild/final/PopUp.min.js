...
class HandlersInternal_HandlersInternal extends CommonEvents {
    ...
    ToggleAccordian(evt, popHub, settingKey) {
        ...
        if (foundContentSib) {
            var oldValue = this.AllAgents.SettingsAgent.GetByKey(settingKey, popHub.SettingsMan.AllSettings.SettingsAr);
            if (oldValue) {
    ...
    WaitForListeningTab(targetTab) {
        return PopUpMessagesManager_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => PopUpMessagesManager_awaiter(this, void 0, void 0, function* () {
                ...
                var iterationJr = new IterationHelper_IterationHelper(this.Helpers(), this.WaitForListeningTab.name, this.AllAgents.HelperAgents);
...
class PopUpAtticManager_PopUpAtticManager extends PopUpManagerBase {
    Init() {
        this.AllAgents.Logger.FuncStart(PopUpAtticManager_PopUpAtticManager.name, this.Init.name);
        this.AllAgents.Logger.FuncEnd(PopUpAtticManager_PopUpAtticManager.name, this.Init.name);
    }
    ReadGenericSettings() {
...
// CONCATENATED MODULE: ./AutoBuild/TsTranspiled/Shared/scripts/Agents/SettingsAgent/OneGenericSetting.js
        ...
        return SettingsManager_awaiter(this, void 0, void 0, function* () {
            ...
            if (foundSettings) {
                for (var idx = 0; idx < foundSettings.length; idx++) {
                    ...
                    let matchingSetting = this.AllAgents.SettingsAgent.GetByKey(storageSetting.SettingKey, this.AllSettings.SettingsAr);
                    if (matchingSetting) {
...
class LocationManager_LocationManager extends PopUpManagerBase {
    ...
    ChangeLocationSwitchBoard(desiredPageType) {
        ...
        var iteration = new IterationHelper_IterationHelper(this.Helpers(), this.ChangeLocationSwitchBoard.name, this.AllAgents.HelperAgents);
...
class PopUpHub_PopUpHub {
    constructor(allAgents) {
        ...
        this.PopUpAtticMan = new PopUpAtticManager_PopUpAtticManager(this, this._allAgents);
        ...
        this.Helpers = new Helpers_HelperHub(allAgents.HelperAgents);
        this.init();
    }
    init() {
