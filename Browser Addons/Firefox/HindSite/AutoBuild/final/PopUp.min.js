...
const BuildDateStamp = 1581486874770;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.debug().IsNotNullOrUndefinedBool('state', state)) {
                ...
                if (targetCurrStateTa) {
                    ...
                    allTaText += '\n';
                    allTaText += 'Page Type: ' + StaticHelpers_StaticHelpers.WindowTypeAsString(yield this.PageMan().GetCurrentPageType());
                    allTaText += '\n';
                    allTaText += 'Url: ' + (yield this.locMan().GetCurrentUrl());
                    allTaText += '\n';
...
class LocationManager_LocationManager extends PopUpManagerBase {
    ...
    GetCurrentUrl() {
        return LocationManager_awaiter(this, void 0, void 0, function* () {
            var toReturn = '';
            yield this.MsgMan().GetTargetTab()
                .then((tab) => {
                toReturn = tab.url;
                this.debug().LogVal('tab url ss', tab.url);
...
class PageManagerPopUp_PageManagerPopUp extends PopUpManagerBase {
    ...
    CalcPageType() {
        return PageManagerPopUp_awaiter(this, void 0, void 0, function* () {
            ...
            let currentLocHref = yield this.locMan().GetCurrentUrl();
