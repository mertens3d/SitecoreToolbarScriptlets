...
class UiFeedbackModuleBase {
    ...
    __getFeedbackElem() {
        let result = document.querySelector(this.__elementSelector);
...
class UiManager_UiManager extends PopUpManagerBase {
    constructor(popHub, allAgents) {
        ...
        this.FeedbackModuleLog = new UiFeedbackModuleLog_UiFeedbackModuleLog(PopConst_PopConst.Const.Selector.HS.textAreaFeedback, this.AllAgents.Logger);
