    ...
    static BuildAllCommands(popHub, handlers) {
        let toReturn = [
            ...
            },
            {
                ...
                ButtonSelector: PopConst_PopConst.Const.Selector.HS.BigRed,
            ...
            },
            {
                ...
                ButtonSelector: PopConst_PopConst.Const.Selector.HS.ModeEdit,
            ...
            },
            {
                ...
                ButtonSelector: PopConst_PopConst.Const.Selector.HS.ModeNorm,
                VisibilityControllers: [VisibilityType.ActiveCeNode],
                Events: [{
                        Event: CommandButtonEvents.OnClick,
                        Handler: popHub.EventMan.Handlers.Internal.SetScModeInternal,
            ...
            },
            {
                ...
                ButtonSelector: PopConst_PopConst.Const.Selector.HS.ModePrev,
            ...
            },
            {
                ...
                ButtonSelector: PopConst_PopConst.Const.Selector.HS.UpdateNicknameB,
            ...
            },
            {
                ...
                ButtonSelector: PopConst_PopConst.Const.Selector.HS.PresentationDetails,
                VisibilityControllers: [VisibilityType.ActiveCeNode],
                Events: [{
                        Event: CommandButtonEvents.OnClick,
            ...
            },
            {
                ...
                ButtonSelector: PopConst_PopConst.Const.Selector.HS.CompactCE,
                VisibilityControllers: [VisibilityType.ActiveCeNode],
                Events: [{
                        Event: CommandButtonEvents.OnClick,
            ...
            },
            {
                ...
                ButtonSelector: PopConst_PopConst.Const.Selector.HS.AdminB,
            ...
            },
            {
                ...
                ButtonSelector: PopConst_PopConst.Const.Selector.HS.GoCE,
            ...
            },
            {
                ...
                ButtonSelector: PopConst_PopConst.Const.Selector.HS.QuickPublish,
                VisibilityControllers: [VisibilityType.ActiveCeNode],
                Events: [{
                        Event: CommandButtonEvents.OnClick,
            ...
            },
            {
                ...
                ButtonSelector: PopConst_PopConst.Const.Selector.HS.Desktop,
                VisibilityControllers: [VisibilityType.NotLogin],
                Events: [{
                        Event: CommandButtonEvents.OnClick,
            ...
            },
            {
                ...
                ButtonSelector: PopConst_PopConst.Const.Selector.HS.TakeSnapshot,
            ...
            },
            {
                ...
                ButtonSelector: PopConst_PopConst.Const.Selector.HS.MarkFavorite,
                VisibilityControllers: [VisibilityType.SnapShotSelected],
                Events: [{
            ...
            },
            {
                ...
                ButtonSelector: PopConst_PopConst.Const.Selector.HS.HsCancel,
            ...
            },
            {
                ...
                ButtonSelector: PopConst_PopConst.Const.Selector.HS.HsRemoveFromStorage,
                VisibilityControllers: [VisibilityType.SnapShotSelected],
                Events: [{
                        Event: CommandButtonEvents.OnClick,
            ...
            },
            {
                ...
                ButtonSelector: PopConst_PopConst.Const.Selector.HS.HsRestoreWindowState,
                VisibilityControllers: [VisibilityType.SnapShotSelected],
                Events: [{
                        Event: CommandButtonEvents.OnClick,
            ...
            },
            {
                ...
                ButtonSelector: PopConst_PopConst.Const.Selector.HS.HsDrawStorage,
                VisibilityControllers: [],
                Events: [{
                        Event: CommandButtonEvents.OnClick,
...
class EventManager_EventManager extends PopUpManagerBase {
    ...
    TriggerPingEvent() {
        return new Promise((resolve, reject) => EventManager_awaiter(this, void 0, void 0, function* () {
            yield this.Handlers.External.Ping();
        }));
    }
    __wireMenuButtons() {
        ...
        this.UiMan().AssignDblClickEvent(PopConst_PopConst.Const.Selector.HS.FeedbackLogElement, (evt) => { this.Handlers.Internal.__cleardebugTextWithConfirm(evt, this.PopHub); });
...
class LocationManager_LocationManager extends PopUpManagerBase {
    constructor(hub, allAgents) {
        super(hub, allAgents);
        this.AllAgents.Logger.InstantiateStart(LocationManager_LocationManager.name);
        this.AllAgents.Logger.InstantiateEnd(LocationManager_LocationManager.name);
    }
...
class UiButtonStateManager_UiButtonStateManager {
    ...
    RefreshUi(currentWindowType, currSelSnapshot, guidHelper, currentContentState) {
...
class FeedbackModuleBrowserState_FeedbackModuleBrowserState extends UiFeedbackModuleBase {
    ...
    PopulateFeedackBrowserState(urlParts) {
        var allStateText = this.lineBreak;
...
class FeedbackModuleContentState_FeedbackModuleContentState extends UiFeedbackModuleBase {
    ...
    PopulateContentStateFeedack(contentState, currentMenuState, urlParts) {
        var allStateText = this.lineBreak;
...
class FeedbackModulePopUpState_FeedbackModulePopUpState extends UiFeedbackModuleBase {
    ...
    PopulatePopUpStateUI(contentState, currentMenuState, urlParts) {
        var allStateText = this.lineBreak;
        this.AddHtmlString(allStateText);
    }
}
...
class UiManager_UiManager extends PopUpManagerBase {
    constructor(popHub, allAgents) {
        ...
        this.FeedbackModuleMessages = new FeedbackModuleMessages_FeedbackModuleMessages(PopConst_PopConst.Const.Selector.HS.DivOverlayModule, this.AllAgents.Logger);
        this.FeedbackModuleLog = new UiFeedbackModuleLog_UiFeedbackModuleLog(PopConst_PopConst.Const.Selector.HS.FeedbackLogElement, this.AllAgents.Logger);
        this.AllAgents.Logger.AddWriter(this.FeedbackModuleLog);
        this.FeedbackModuleContentState = new FeedbackModuleContentState_FeedbackModuleContentState(PopConst_PopConst.Const.Selector.HS.FeedbackContentState, this.AllAgents.Logger);
        this.FeedbackModuleBrowserState = new FeedbackModuleBrowserState_FeedbackModuleBrowserState(PopConst_PopConst.Const.Selector.HS.FeedbackBrowserState, this.AllAgents.Logger);
        this.FeedbackModulePopUpState = new FeedbackModulePopUpState_FeedbackModulePopUpState(PopConst_PopConst.Const.Selector.HS.FeedbackPopUpState, this.AllAgents.Logger);
        this.ModuleSelectSnapShot = new SelectSnapshotModule_SelectSnapshotModule(PopConst_PopConst.Const.Selector.HS.SelStateSnapShot, this.AllAgents.Logger, this.Helpers().GuidHelper);
    ...
    __GetCancelButton() {
        return document.getElementById(PopConst_PopConst.Const.Selector.HS.HsCancel);
    }
    SetCancelFlag() {
    ...
    SetUIStates(contentState, currentMenuState, urlParts) {
    ...
    RefreshUi(contentState) {
        return UiManager_awaiter(this, void 0, void 0, function* () {
            this.AllAgents.Logger.FuncStart(this.RefreshUi.name);
            yield this.SetUIStates(contentState, this.CurrentMenuState, this.TabMan().CurrentTabData.UrlParts);
            ...
            let currentContentState = this.UiMan().CurrContentState;
...
class PopUpHub_PopUpHub {
    constructor(allAgents) {
        ...
        let FeedbackModuleMsg = new FeedbackModuleMessages_FeedbackModuleMessages(PopConst_PopConst.Const.Selector.HS.FeedbackMessages, this._allAgents.Logger);
