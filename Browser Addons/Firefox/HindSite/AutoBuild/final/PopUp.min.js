...
(function (MenuCommand) {
    MenuCommand[MenuCommand["ScModeEdit"] = 0] = "ScModeEdit";
...
(function (SettingKey) {
    ...
    SettingKey[SettingKey["AutoSaveEnabled"] = 101] = "AutoSaveEnabled";
    ...
    SettingKey[SettingKey["ShowLogData"] = 201] = "ShowLogData";
    SettingKey[SettingKey["Test"] = 202] = "Test";
    SettingKey[SettingKey["LgndDebug"] = 300] = "LgndDebug";
...
class UiManager_UiManager extends PopUpManagerBase {
    ...
    Init() {
        ...
        this.MsgMan().SendMessageToContentTab(new MsgPayloadRequestFromPopUp_MsgFromPopUp(MsgFlag.ReqCurState, this.PopHub), this.TabMan().CurrentTabData);
    ...
    RefreshUiGenericSettings() {
        ...
        for (var idx = 0; idx < this.SettingsMan().AllSettings.SettingsAr.length; idx++) {
            ...
            this.Log().LogVal('setting', StaticHelpers_StaticHelpers.SettingKeyAsString(oneSetting.SettingKey));
    ...
    RefreshButtonStates() {
        ...
        for (var idx = 0; idx < this.EventMan().AllMenuCommands.length; idx++) {
            ...
            if (command.RequiredPageTypes.length > 0) {
                ...
                this.Log().LogVal('current', StaticHelpers_StaticHelpers.WindowTypeAsString(currentWindowType));
    ...
    PopulateContentStateDiv(contentState) {
        var targetCurrStateDiv = window.document.querySelector(PopConst.Const.Selector.HS.DivState);
        var allTaText = 'State as of: ' + (new Date()).toString();
        var allTaText = 'State as of: ' + this.Helpers().UtilityHelp.MakeFriendlyDate(new Date());
        var lineBreak = '<br/>';
        if (targetCurrStateDiv) {
            allTaText += lineBreak;
            allTaText += 'Page Type: ' + StaticHelpers_StaticHelpers.WindowTypeAsString(this.TabMan().CurrentTabData.UrlParts.ScWindowType);
    ...
    PopulateContentState(contentState) {
        return __awaiter(this, void 0, void 0, function* () {
...
// CONCATENATED MODULE: ./AutoBuild/TsTranspiled/Shared/scripts/Enums/LogLevel.js
var LogLevel;
(function (LogLevel) {
    LogLevel[LogLevel["Unknown"] = 0] = "Unknown";
    LogLevel[LogLevel["Enabled"] = 1] = "Enabled";
    LogLevel[LogLevel["Disabled"] = 2] = "Disabled";
})(LogLevel || (LogLevel = {}));
...
class HandlersExternal_HandlersExternal extends CommonEvents_CommonEvents {
    __hndlrAddCETab(evt, popHub) {
        return HandlersExternal_awaiter(this, void 0, void 0, function* () {
            popHub.EventMan.Handlers.External.__initNewOperation();
            popHub.PopMsgMan.SendMessageToContentTab(new MsgPayloadRequestFromPopUp_MsgFromPopUp(MsgFlag.ReqAddCETab, popHub), popHub.TabMan.CurrentTabData);
        });
    }
    ...
    MarkFavorite(evt) {
        this.MsgMan().SendMessageToContentTab(new MsgPayloadRequestFromPopUp_MsgFromPopUp(MsgFlag.ReqMarkFavorite, this.PopHub), this.TabMan().CurrentTabData);
    }
    __DrawStorage(evt) {
    ...
    HndlrAdminB() {
        this.__initNewOperation();
        this.MsgMan().SendMessageToContentTab(new MsgPayloadRequestFromPopUp_MsgFromPopUp(MsgFlag.ReqAdminB, this.PopHub), this.TabMan().CurrentTabData);
    }
    __hndlrSetScMode(evt, popHub, parameters) {
        return HandlersExternal_awaiter(this, void 0, void 0, function* () {
    ...
    __hndlrQuickPublish(evt) {
        return HandlersExternal_awaiter(this, void 0, void 0, function* () {
            this.__initNewOperation();
            this.MsgMan().SendMessageToContentTab(new MsgPayloadRequestFromPopUp_MsgFromPopUp(MsgFlag.ReqQuickPublish, this.PopHub), this.TabMan().CurrentTabData);
        });
    }
    ...
    CreateNewWindowIfRequired(evt, tabUrl) {
        return new Promise((resolve, reject) => HandlersExternal_awaiter(this, void 0, void 0, function* () {
            ...
            let result = new ResultSuccessFail();
            let toReturn;
            if (!evt.ctrlKey) {
                yield this.BrowserMan().CreateNewTab(tabUrl)
                    .then((newTab) => {
                    this.Log().MarkerA();
                    toReturn = newTab;
                });
    ...
    HndlrSnapShotRestore(evt) {
        return HandlersExternal_awaiter(this, void 0, void 0, function* () {
            ...
            this.__initNewOperation();
            yield this.CreateNewWindowIfRequired(evt, this.Helpers().UrlHelp.BuildFullUrlFromParts(this.TabMan().CurrentTabData.UrlParts))
                .then((newTab) => {
    ...
    __hndlrSnapShotCreate(evt) {
        return HandlersExternal_awaiter(this, void 0, void 0, function* () {
            ...
            yield this.MsgMan().SendMessageToContentTab(msg, this.TabMan().CurrentTabData);
        });
    }
}
...
class HandlersInternal_HandlersInternal extends CommonEvents_CommonEvents {
    ...
    __toggleAccordian(evt, settingKey) {
        ...
        if (foundContentSib) {
            var oldValue = this.Helpers().SettingsHelp.GetByKey(settingKey, this.SettingsMan().AllSettings.SettingsAr);
            if (oldValue) {
...
class PopUpMessagesManager_PopUpMessagesManager extends PopUpManagerBase {
    ...
    SendMessageToSingleTab(tab, messageToSend) {
        ...
        browser.tabs.sendMessage(tab.Tab.id, messageToSend).then((response) => {
            this.Log().LogVal('response', JSON.stringify(response, null, 1));
            var asMsgFromContent = response;
            if (asMsgFromContent) {
                this.Log().Log(StaticHelpers_StaticHelpers.MsgFlagAsString(asMsgFromContent.MsgFlag));
    ...
    SendMessageToContentTab(msgPlayload, targetTab) {
        return PopUpMessagesManager_awaiter(this, void 0, void 0, function* () {
            this.Log().FuncStart(this.SendMessageToContentTab.name, StaticHelpers_StaticHelpers.MsgFlagAsString(msgPlayload.MsgFlag));
            msgPlayload.CurrentContentPrefs = yield (yield this.SettingsMan().GetOnlyContentPrefs());
...
(function (SettingFlavor) {
    ...
    SettingFlavor[SettingFlavor["Content"] = 2] = "Content";
...
class ConstAllSettings {
}
ConstAllSettings.AllSettings = [
    {
        SettingKey: SettingKey_SettingKey.Test,
    ...
    {
        SettingKey: SettingKey_SettingKey.ShowLogData,
        DataType: SettingType.BoolCheckBox,
        ValueAsObj: null,
    ...
    {
        SettingKey: SettingKey_SettingKey.AutoSaveEnabled,
        DataType: SettingType.BoolCheckBox,
        ValueAsObj: null,
    ...
    {
        SettingKey: SettingKey_SettingKey.AutoLogin,
        DataType: SettingType.BoolCheckBox,
        ValueAsObj: null,
    ...
    {
        SettingKey: SettingKey_SettingKey.LgndDebug,
    ...
    {
        SettingKey: SettingKey_SettingKey.LgndForeSite,
        DataType: SettingType.Accordian,
        ValueAsObj: null,
    ...
    {
        SettingKey: SettingKey_SettingKey.LgndHindSite,
        DataType: SettingType.Accordian,
        ValueAsObj: null,
    ...
    {
        SettingKey: SettingKey_SettingKey.LgndSettings,
        DataType: SettingType.Accordian,
        ValueAsObj: null,
    ...
    {
        SettingKey: SettingKey_SettingKey.LgndState,
        DataType: SettingType.Accordian,
        ValueAsObj: null,
    ...
    {
        SettingKey: SettingKey_SettingKey.MaxAutoSaveCount,
    ...
    {
        SettingKey: SettingKey_SettingKey.AutoSaveIntervalMin,
        DataType: SettingType.Number,
        ValueAsObj: null,
    ...
    {
        SettingKey: SettingKey_SettingKey.DebugKeepDialogOpen,
        DataType: SettingType.BoolCheckBox,
        ValueAsObj: null,
...
class UtilityHelper_UtilityHelper extends HelperBase {
    ...
    MakeFriendlyDate(date) {
        ...
        if (date) {
            ...
            var month = StaticHelpers_StaticHelpers.BufferString((date.getMonth() + 1).toString(), 2, BufferChar.Zero, BufferDirection.left);
            var day = StaticHelpers_StaticHelpers.BufferString(date.getDate().toString(), 2, BufferChar.Zero, BufferDirection.left);
...
class PopUpHub_PopUpHub {
    constructor() {
        this.Log = new LoggerPopUp_LoggerPopUp(LogLevel.Enabled);
