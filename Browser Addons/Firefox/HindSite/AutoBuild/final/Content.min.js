...
class Guid_Guid {
    constructor() {
        this.ConstEmptyGuid = '00000000-0000-0000-0000-000000000000';
        this.ConstEmptyBracedGuid = '{00000000-0000-0000-0000-000000000000}';
        this.ConstAllZeros = '00000000000000000000000000000000';
        this.ShortGuidLength = 4;
        this.AsBracedGuid = this.ConstEmptyBracedGuid;
    ...
    static GetEmptyGuid() {
        let toReturn = new Guid_Guid();
        return Guid_Guid.ParseGuid('00000000-0000-0000-0000-000000000000', true);
    }
    newGuidString() {
        var toReturn;
    ...
    static NewGuid() {
        ...
        var toReturn = newGuid.MakeNewGuid();
        return toReturn;
    }
    AsShort() {
        var toReturn = '{error}';
    ...
    GetCurrentDtOrCeState() {
        return new Promise((resolve, reject) => ContentStateManager_awaiter(this, void 0, void 0, function* () {
            ...
            if (pageType === scWindowType.Desktop) {
                ...
                yield this.OneScWinMan().OneCEAgent.GetTreeState(Guid_Guid.NewGuid())
                    .then((result) => {
...
class ContentAtticManager_ContentAtticManager extends ContentManagerBase {
    ...
    __parseRawData(oneRaw) {
        ...
        if (candidate) {
            ...
            candidate.Id = Guid_Guid.ParseGuid(candidate.Id.ToString(), true);
            ...
            yield this.AllAgents.HelperAgent.PromisesBasic.GetAllLiveIframeData(this.associatedDoc)
                ...
                if (toReturnAllCeState.livingIframeAr && toReturnAllCeState.livingIframeAr.length > 0) {
                    for (var iframeIdx = 0; iframeIdx < toReturnAllCeState.livingIframeAr.length; iframeIdx++) {
                        ...
                        oneCeMan.GetTreeState(Guid_Guid.NewGuid())
                            .then((oneCeState) => {
