...
class ContentMessageBroker_ContentMessageBroker {
    constructor(logger, settingsAgent, apiManager, topLevelDoc) {
        this.Logger = logger;
    ...
    ReqMsgRouter(payload) {
        return ContentMessageBroker_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => ContentMessageBroker_awaiter(this, void 0, void 0, function* () {
                ...
                if (commandToExecute) {
                    yield commandToExecute(payload.Data, this, this.TopLevelDoc)
...
class ContentMessageManager_ContentMessageManager extends ContentManagerBase {
    ...
    Init() {
        ...
        var self = this;
        this.ContentMessageBroker = new ContentMessageBroker_ContentMessageBroker(this.AllAgents.Logger, this.AllAgents.SettingsAgent, this.APIMan(), this.ScUiMan().TopLevelDoc());
...
class ContentAPIManager_ContentAPIManager extends ContentManagerBase {
    ...
    AddCETab(payloadData, self, targetDoc) {
        return new Promise((resolve, reject) => ContentAPIManager_awaiter(this, void 0, void 0, function* () {
