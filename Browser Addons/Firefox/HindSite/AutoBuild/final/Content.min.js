...
class PromiseChainQuickPublish_PromiseChainQuickPublish extends ContentManagerBase {
    ...
    __waitForAndClickClose(dataPublishChain) {
        return PromiseChainQuickPublish_awaiter(this, void 0, void 0, function* () {
            yield this.AllAgents.HelperAgent.PromiseHelper.WaitForAndReturnFoundElem(dataPublishChain.Iframe0Blue.ContentDoc, InjectConst_ContentConst.Const.Selector.SC.Publish.SettingsHidden)
                .then(() => PromiseChainQuickPublish_awaiter(this, void 0, void 0, function* () {
                yield this.AllAgents.HelperAgent.PromiseHelper.WaitForAndReturnFoundElem(dataPublishChain.Iframe0Blue.ContentDoc, InjectConst_ContentConst.Const.Selector.SC.Publish.TheItemHasBeenPublished, this.SharedConst().IterHelper.MaxCount.OverridePublishing);
            }))
                .then(() => PromiseChainQuickPublish_awaiter(this, void 0, void 0, function* () {
                yield this.AllAgents.HelperAgent.PromiseHelper.WaitForThenClick([InjectConst_ContentConst.Const.Selector.SC.Cancel], dataPublishChain.Iframe0Blue.ContentDoc);
            }));
            return dataPublishChain;
        });
    }
    __waitForAndClickOk(dataPublishChain) {
        return PromiseChainQuickPublish_awaiter(this, void 0, void 0, function* () {
            yield this.AllAgents.HelperAgent.PromiseHelper.WaitForThenClick([InjectConst_ContentConst.Const.Selector.SC.Ok], dataPublishChain.messageDialogIframeRed.ContentDoc);
            return dataPublishChain;
        });
    }
    __WaitForAndClickPublishNextButton(dataPublishChain) {
        return PromiseChainQuickPublish_awaiter(this, void 0, void 0, function* () {
            yield this.AllAgents.HelperAgent.PromiseHelper.WaitForThenClick([InjectConst_ContentConst.Const.Selector.SC.NextButton], dataPublishChain.Iframe0Blue.ContentDoc);
            return dataPublishChain;
        });
    }
    GetMessageDialog(dataPublishChain) {
        return PromiseChainQuickPublish_awaiter(this, void 0, void 0, function* () {
            ...
            yield this.AllAgents.HelperAgent.PromiseHelper.WaitForIframeElemAndReturnWhenReady(dataPublishChain.jqIframe.ContentDoc, InjectConst_ContentConst.Const.Selector.SC.ContentIFrame1, 'iframeRed')
    ...
    GetDialogIframe0Blue(dataPublishChain = null) {
        return PromiseChainQuickPublish_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => PromiseChainQuickPublish_awaiter(this, void 0, void 0, function* () {
                ...
                yield this.AllAgents.HelperAgent.PromiseHelper.WaitForIframeElemAndReturnWhenReady(dataPublishChain.jqIframe.ContentDoc, InjectConst_ContentConst.Const.Selector.SC.ContentIframe0, 'Iframe0Blue')
                    .then((result) => {
    ...
    __waitForThenFunc(selector, targetDoc, dataPublishChain, optionFunc) {
        return new Promise((resolve, reject) => PromiseChainQuickPublish_awaiter(this, void 0, void 0, function* () {
            ...
            var found = null;
            yield this.AllAgents.HelperAgent.PromiseHelper.WaitForAndReturnFoundElem(targetDoc, selector)
...
class PromiseChainRestoreDesktop_PromiseChainRestoreDesktop extends ContentManagerBase {
    ...
    __waitForAndClickRedStartButton(targetDoc) {
        return new Promise((resolve, reject) => PromiseChainRestoreDesktop_awaiter(this, void 0, void 0, function* () {
            ...
            if (this.MiscMan().NotNullOrUndefined(targetDoc, this.__waitForAndClickRedStartButton.name)) {
                ...
                yield this.AllAgents.HelperAgent.PromiseHelper.RaceWaitAndClick(InjectConst_ContentConst.Const.Selector.SC.scStartButton, targetDoc)
                    .then(() => resolve())
                    .catch((ex) => reject(ex));
            }
            else {
    ...
    __waitForIframeReady(targetIframe) {
        return new Promise((resolve, reject) => PromiseChainRestoreDesktop_awaiter(this, void 0, void 0, function* () {
            ...
            yield this.AllAgents.HelperAgent.PromiseHelper.WaitForReadyIframe(targetIframe)
                .then((result) => {
    ...
    __waitForAndThenClickCEFromMenu(targetDoc) {
        return new Promise((resolve, reject) => PromiseChainRestoreDesktop_awaiter(this, void 0, void 0, function* () {
            yield this.AllAgents.HelperAgent.PromiseHelper.WaitForThenClick([InjectConst_ContentConst.Const.Selector.SC.StartMenuLeftOption], targetDoc)
                .then(() => { resolve(); })
    ...
    RunOneChain(targetDoc, dataToRestore) {
        return PromiseChainRestoreDesktop_awaiter(this, void 0, void 0, function* () {
            ...
            if (this.MiscMan().NotNullOrUndefined([targetDoc, dataToRestore], this.RunOneChain.name)) {
                ...
                var targetCeAgent;
                yield this.AllAgents.HelperAgent.PromiseHelper.GetAllLiveIframeData(targetDoc)
...
class OneDesktopManager_OneDesktopManager extends ContentManagerBase {
    ...
    GetStateDesktop() {
        return new Promise((resolve, reject) => OneDesktopManager_awaiter(this, void 0, void 0, function* () {
            ...
            yield this.AllAgents.HelperAgent.PromiseHelper.GetAllLiveIframeData(this.associatedDoc)
...
class PromiseOneStep_PromiseOneStep extends ContentManagerBase {
    constructor(hub, AllAgents) {
        super(hub, AllAgents);
        this.AllAgents.Logger.FuncStart(PromiseGeneric_PromiseHelper.name);
        this.AllAgents.Logger.FuncEnd(PromiseGeneric_PromiseHelper.name);
    }
    ClickPublishOnNav(payload) {
        return PromiseOneStep_awaiter(this, void 0, void 0, function* () {
            yield this.AllAgents.HelperAgent.PromiseHelper.WaitForThenClick([InjectConst_ContentConst.Const.Selector.SC.NavPublishStrip], payload.docToPublish);
            yield this.AllAgents.HelperAgent.PromiseHelper.WaitForThenClick([InjectConst_ContentConst.Const.Selector.SC.NavPublishStrip], payload.docToPublish);
            return payload;
        });
    }
    ClickMenuButtonPublishDropDown(payload = null) {
        return PromiseOneStep_awaiter(this, void 0, void 0, function* () {
            yield this.AllAgents.HelperAgent.PromiseHelper.WaitForThenClick([InjectConst_ContentConst.Const.Selector.SC.MenuButtonPublish], payload.docToPublish);
            return payload;
        });
    }
    ClickMenuDropDownPublishItem(payload = null) {
        return PromiseOneStep_awaiter(this, void 0, void 0, function* () {
            return yield this.AllAgents.HelperAgent.PromiseHelper.WaitForAndClickWithPayload(InjectConst_ContentConst.Const.Selector.SC.MenuDropDownPublishItem, payload.docToPublish, payload);
        });
    }
    GetThePublishItemDialog(dataPublishChain = null) {
        return PromiseOneStep_awaiter(this, void 0, void 0, function* () {
            yield this.AllAgents.HelperAgent.PromiseHelper.WaitForAndReturnFoundElem(dataPublishChain.TopLevelDoc, InjectConst_ContentConst.Const.Selector.SC.JqueryModalDialogsFrame)
                .then((found) => {
                ...
                yield this.AllAgents.HelperAgent.PromiseHelper.WaitForReadyIframe(payload.jqIframe);
            ...
            return new Promise((resolve, reject) => ContentMessageManager_awaiter(this, void 0, void 0, function* () {
                ...
                switch (payload.MsgFlag) {
                    ...
                    case MsgFlag.ReqAddCETab:
                        ...
                        yield this.AllAgents.HelperAgent.PromiseHelper.GetAllLiveIframeData(targetDoc)
                            .then((result) => allIframeDataAtBeginning = result)
                            .then(() => this.AllAgents.HelperAgent.PromiseHelper.RaceWaitAndClick(InjectConst_ContentConst.Const.Selector.SC.scStartButton, targetDoc))
                            .then(() => this.AllAgents.HelperAgent.PromiseHelper.WaitForReadyIframe)
                            .then(() => { this.AllAgents.HelperAgent.PromiseHelper.WaitForThenClick([InjectConst_ContentConst.Const.Selector.SC.StartMenuLeftOption], targetDoc); })
