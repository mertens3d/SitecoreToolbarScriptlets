...
class PromiseChainRestoreDesktop_PromiseChainRestoreDesktop extends ContentManagerBase {
    ...
    __waitForIframeReady(promiseBucket) {
        return new Promise((resolve, reject) => PromiseChainRestoreDesktop_awaiter(this, void 0, void 0, function* () {
            ...
            yield this.Helpers().PromiseHelp.WaitForReadyIframe(promiseBucket.NewIframe)
                .then((result) => {
    ...
    __waitForIframeCountDiff(promiseBucket) {
        return new Promise((resolve, reject) => PromiseChainRestoreDesktop_awaiter(this, void 0, void 0, function* () {
            ...
            var result = new PromiseResult(this.__waitForIframeCountDiff.name, this.AllAgents.Logger);
...
class OneTreeManager_OneTreeManager extends ContentManagerBase {
    constructor(hub, associatedDoc, AllAgents) {
        super(hub, AllAgents);
        this.AllAgents.Logger.FuncStart(OneTreeManager_OneTreeManager.name);
        this.AssociatedDoc = associatedDoc;
        this.AllAgents.Logger.FuncEnd(OneTreeManager_OneTreeManager.name);
    }
    ...
    GetOneLiveTreeData() {
        ...
        if (this.AssociatedDoc) {
            this.AllAgents.Logger.LogVal('Looking for node ID: ', InjectConst_ContentConst.Const.ElemId.sc.SitecoreRootNodeId);
...
class OneCEManager_OneCEManager extends ContentManagerBase {
    constructor(hub, associatedDoc, allContentAgents) {
        ...
        this.AllAgents.Logger.FuncStart(this.constructor.name);
        this.AssociatedDoc = associatedDoc;
        this.OneTreeMan = new OneTreeManager_OneTreeManager(hub, this.AssociatedDoc, allContentAgents);
        this.AllAgents.Logger.FuncEnd(this.constructor.name);
    }
    ...
    __collapseRootNode(targetCEDoc) {
        ...
        if (rootElem) {
            ...
            this.AllAgents.Logger.Error(this.__collapseRootNode.name, 'Root glyph not found ' + InjectConst_ContentConst.Const.ElemId.sc.SitecoreRootGlyphId);
        }
    }
    WaitForAndRestoreOneNode(nextNode, dataOneDocTarget) {
        return OneCEManager_awaiter(this, void 0, void 0, function* () {
            ...
            var iterHelper = new IterationHelper_IterationHelper(this.Helpers(), this.WaitForAndRestoreOneNode.name, this.AllAgents);
    ...
    WaitForAndRestoreManyAllNodes(storageData, dataOneDocTarget) {
        return OneCEManager_awaiter(this, void 0, void 0, function* () {
            ...
            let iterHelper = new IterationHelper_IterationHelper(this.Helpers(), this.WaitForAndRestoreManyAllNodes.name, this.AllAgents);
    ...
    GetStateCe(id) {
        return new Promise((resolve, reject) => {
            ...
            let result = new PromiseResult(this.GetStateCe.name, this.AllAgents.Logger);
            var toReturnCEData = {
                Id: id,
...
class OneDesktopManager_OneDesktopManager extends ContentManagerBase {
    ...
    WaitForIframeCountDiffWorker(IFramesbefore) {
        return OneDesktopManager_awaiter(this, void 0, void 0, function* () {
            ...
            var toReturn = null;
            var iterationJr = new IterationHelper_IterationHelper(this.Helpers(), this.WaitForIframeCountDiffWorker.name, this.AllAgents);
        ...
        return new Promise((resolve, reject) => OneDesktopManager_awaiter(this, void 0, void 0, function* () {
            ...
            if (toReturnAllCeState.livingIframeAr && toReturnAllCeState.livingIframeAr.length > 0) {
                for (var iframeIdx = 0; iframeIdx < toReturnAllCeState.livingIframeAr.length; iframeIdx++) {
                    ...
                    var oneCeMan = new OneCEManager_OneCEManager(this.ContentHub, targetIframeObj.ContentDoc, this.AllAgents);
...
class OneScWindowManager_OneScWindowManager extends ContentManagerBase {
    ...
    Init() {
        ...
        if (currPageType === scWindowType.Desktop) {
            ...
            this.OneCEMan = new OneCEManager_OneCEManager(this.ContentHub, this.ScUiMan().TopLevelDoc(), this.AllAgents);
        }
    }
            ...
            return new Promise((resolve, reject) => ContentMessageManager_awaiter(this, void 0, void 0, function* () {
                ...
                switch (payload.MsgFlag) {
                    ...
                    case MsgFlag.ReqUpdateNickName:
                        ...
                        break;
                    default:
                        this.AllAgents.Logger.Error('Unhandled MsgFlag', StaticHelpers_StaticHelpers.MsgFlagAsString(payload.MsgFlag));
...
class ContentHub_ContentHub {
    ...
    Instantiate() {
        ...
        this.Helpers = new Helpers_HelperHub(this.AllAgents);
