...
class ContentMessageManager_ContentMessageManager extends ContentManagerBase {
    ...
    SetLoggerFromMessage(reqMsgFromPopup) {
        let currSetting = this.AllAgents.SettingsAgent.GetByKey(SettingKey.LogToConsole);
    ...
    ContentReceiveRequest(reqMsgFromPopup) {
        return ContentMessageManager_awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => ContentMessageManager_awaiter(this, void 0, void 0, function* () {
                ...
                this.AllAgents.Logger.LogAsJsonPretty(MsgFromPopUp_MsgFromPopUp.name, reqMsgFromPopup);
                var response = null;
                if (reqMsgFromPopup) {
    ...
    ReqMsgRouter(payload) {
        return ContentMessageManager_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => ContentMessageManager_awaiter(this, void 0, void 0, function* () {
                ...
                this.AllAgents.Logger.LogAsJsonPretty(MsgFromPopUp_MsgFromPopUp.name, payload);
                let promiseResult = new PromiseResult(this.ReqMsgRouter.name, this.AllAgents.Logger);
