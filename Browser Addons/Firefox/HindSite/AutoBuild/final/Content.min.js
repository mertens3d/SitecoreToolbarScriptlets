...
class PromiseOneStep_PromiseOneStep extends ContentManagerBase {
    ...
    ClickPublishOnNav(payload) {
        return PromiseOneStep_awaiter(this, void 0, void 0, function* () {
            yield this.AllAgents.HelperAgent.PromisesBasic.WaitForThenClick([ContentConst.Const.Selector.SC.NavPublishStrip], payload.docToPublish);
            yield this.AllAgents.HelperAgent.PromisesBasic.WaitForThenClick([ContentConst.Const.Selector.SC.NavPublishStrip], payload.docToPublish);
            return payload;
        });
    }
    ClickMenuButtonPublishDropDown(payload = null) {
        return PromiseOneStep_awaiter(this, void 0, void 0, function* () {
            yield this.AllAgents.HelperAgent.PromisesBasic.WaitForThenClick([ContentConst.Const.Selector.SC.MenuButtonPublish], payload.docToPublish);
            return payload;
        });
    }
    ClickMenuDropDownPublishItem(payload = null) {
        return PromiseOneStep_awaiter(this, void 0, void 0, function* () {
            return yield this.AllAgents.HelperAgent.PromisesBasic.WaitForAndClickWithPayload(ContentConst.Const.Selector.SC.MenuDropDownPublishItem, payload.docToPublish, payload);
        });
    }
    GetThePublishItemDialog(dataPublishChain = null) {
        return PromiseOneStep_awaiter(this, void 0, void 0, function* () {
            yield this.AllAgents.HelperAgent.PromisesBasic.WaitForAndReturnFoundElem(dataPublishChain.TopLevelDoc, ContentConst.Const.Selector.SC.JqueryModalDialogsFrame)
                .then((found) => {
...
class PromiseChainQuickPublish_PromiseChainQuickPublish extends ContentManagerBase {
    ...
    __waitForAndClickClose(dataPublishChain) {
        return PromiseChainQuickPublish_awaiter(this, void 0, void 0, function* () {
            yield this.AllAgents.HelperAgent.PromisesBasic.WaitForAndReturnFoundElem(dataPublishChain.Iframe0Blue.ContentDoc, ContentConst.Const.Selector.SC.Publish.SettingsHidden)
                .then(() => PromiseChainQuickPublish_awaiter(this, void 0, void 0, function* () {
                yield this.AllAgents.HelperAgent.PromisesBasic.WaitForAndReturnFoundElem(dataPublishChain.Iframe0Blue.ContentDoc, ContentConst.Const.Selector.SC.Publish.TheItemHasBeenPublished, this.SharedConst().IterHelper.MaxCount.OverridePublishing);
            }))
                .then(() => PromiseChainQuickPublish_awaiter(this, void 0, void 0, function* () {
                yield this.AllAgents.HelperAgent.PromisesBasic.WaitForThenClick([ContentConst.Const.Selector.SC.Cancel], dataPublishChain.Iframe0Blue.ContentDoc);
            }));
            return dataPublishChain;
        });
    }
    __waitForAndClickOk(dataPublishChain) {
        return PromiseChainQuickPublish_awaiter(this, void 0, void 0, function* () {
            yield this.AllAgents.HelperAgent.PromisesBasic.WaitForThenClick([ContentConst.Const.Selector.SC.Ok], dataPublishChain.messageDialogIframeRed.ContentDoc);
            return dataPublishChain;
        });
    }
    __WaitForAndClickPublishNextButton(dataPublishChain) {
        return PromiseChainQuickPublish_awaiter(this, void 0, void 0, function* () {
            yield this.AllAgents.HelperAgent.PromisesBasic.WaitForThenClick([ContentConst.Const.Selector.SC.NextButton], dataPublishChain.Iframe0Blue.ContentDoc);
            return dataPublishChain;
        });
    }
    GetMessageDialog(dataPublishChain) {
        return PromiseChainQuickPublish_awaiter(this, void 0, void 0, function* () {
            ...
            yield this.AllAgents.HelperAgent.PromisesBasic.WaitForIframeElemAndReturnWhenReady(dataPublishChain.jqIframe.ContentDoc, ContentConst.Const.Selector.SC.ContentIFrame1, 'iframeRed')
    ...
    GetDialogIframe0Blue(dataPublishChain = null) {
        return PromiseChainQuickPublish_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => PromiseChainQuickPublish_awaiter(this, void 0, void 0, function* () {
                ...
                yield this.AllAgents.HelperAgent.PromisesBasic.WaitForIframeElemAndReturnWhenReady(dataPublishChain.jqIframe.ContentDoc, ContentConst.Const.Selector.SC.ContentIframe0, 'Iframe0Blue')
                    .then((result) => {
                    this.AllAgents.Logger.MarkerC();
...
// CONCATENATED MODULE: ./AutoBuild/TsTranspiled/Shared/scripts/Agents/Agents/UrlAgent/UrlAgent.js
var UrlAgent_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
class UrlAgent_GenericUrlAgent {
    constructor(logger) {
        this.Logger = logger;
    }
    GetUrlParts() {
    ...
    Init() {
        return new Promise((resolve, reject) => UrlAgent_awaiter(this, void 0, void 0, function* () {
            try {
                if (browser.tabs) {
                    yield browser.tabs.query({ currentWindow: true, active: true })
                        .then((result) => {
...
class ScUrlAgent_ScUrlAgent extends UrlAgent_GenericUrlAgent {
    constructor(logger) {
        super(logger);
    }
...
class ContentHub_ContentHub {
    ...
    InstantiateMembers() {
        return ContentHub_awaiter(this, void 0, void 0, function* () {
...
function main() {
    return zContentEntryPoint_awaiter(this, void 0, void 0, function* () {
        ...
        let contentHub = new ContentHub_ContentHub(allAgents);
        yield contentHub.Init()
