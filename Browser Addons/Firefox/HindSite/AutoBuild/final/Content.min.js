...
(function (SettingKey) {
    ...
    SettingKey[SettingKey["LgndLog"] = 3300] = "LgndLog";
    ...
    SettingKey[SettingKey["LgndState"] = 3304] = "LgndState";
...
class ContentMessageManager_ContentMessageManager extends ContentManagerBase {
    ...
    __restoreClick(Data) {
        return new Promise((resolve, reject) => ContentMessageManager_awaiter(this, void 0, void 0, function* () {
            ...
            let promiseResult = new PromiseResult(this.__restoreClick.name, this.AllAgents.Logger);
            try {
                this.AllAgents.Logger.MarkerA();
                if (Data.IdOfSelect) {
...
class ContentAPIManager_ContentAPIManager extends ContentManagerBase {
    ...
    SaveWindowState(payloadData) {
        return ContentAPIManager_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => ContentAPIManager_awaiter(this, void 0, void 0, function* () {
                yield this.OneScWinMan().SaveWindowState(payloadData.SnapShotSettings)
    ...
    RestoreSnapshop(payloadData) {
        return new Promise((resolve, reject) => ContentAPIManager_awaiter(this, void 0, void 0, function* () {
            yield this.ContentHub.MsgMan.__restoreClick(payloadData)
                .then(() => resolve())
                .catch((err) => reject(err));
        }));
    }
...
class ContentAtticManager_ContentAtticManager extends ContentManagerBase {
    ...
    GetAllLocalStorageAsIOneStorageData() {
        return new Promise((resolve, reject) => ContentAtticManager_awaiter(this, void 0, void 0, function* () {
            ...
            yield this.AllAgents.RepoAgent.GetBulkLocalStorageByKeyPrefix(prefix)
                .then((result) => resolve(result))
                .catch((err) => reject(err));
...
class ContentHub_ContentHub {
    ...
    Instantiate() {
        ...
        this.AtticMan = new ContentAtticManager_ContentAtticManager(this, this.AllAgents);
...
class Helpers_HelperAgent {
    constructor(logger) {
        logger.FuncStart(Helpers_HelperAgent.name);
        this.Init(logger, this);
        logger.FuncEnd(Helpers_HelperAgent.name);
    }
...
class RollingLogIdDrone_RollingLogIdDrone {
    ...
    GetLastUsedLogId() {
        ...
        console.log('Using Key : ' + _3xxx_SettingKey_SettingKey.LastUsedLogToStorageKey);
...
class ConstAllSettings_ConstAllSettings {
    constructor() {
        this.AllSettings = [
            ...
            new OneGenericSetting(_3xxx_SettingKey_SettingKey.LgndLog, SettingType.Accordion, null, PopConst_PopConst.Const.Selector.Legend.LgndDebug, PopConst_PopConst.Const.Settings.Defaults.LgndDebug, SettingFlavor.PopUp, 'Log'),
            ...
            new OneGenericSetting(_3xxx_SettingKey_SettingKey.LgndState, SettingType.Accordion, null, PopConst_PopConst.Const.Selector.Legend.LgndState, PopConst_PopConst.Const.Settings.Defaults.LgndState, SettingFlavor.PopUp, 'State'),
