...
class ContentManagerBase {
    ...
    PromiseGen() { return this.ContentHub.PromiseHelper; }
...
class OneDesktopManager_OneDesktopManager extends ContentManagerBase {
    ...
    GetActiveDesktopIframeData() {
        ...
        var toReturn = null;
        var livingIframeAr = this.GetAllLiveIframeData(this.ScUiMan().TopLevelWindow());
        if (livingIframeAr) {
...
class PromiseChainQuickPublish_PromiseChainQuickPublish extends ContentManagerBase {
    ...
    GetMessageDialog(dataPublishChain) {
        return PromiseChainQuickPublish_awaiter(this, void 0, void 0, function* () {
            ...
            dataPublishChain.messageDialogIframeRed =
                yield this.PromiseGen().WaitForAndReturnReadyIframe(dataPublishChain.jqIframe.ContentDoc, this.Const().Selector.SC.ContentIFrame1, IDataOneIframe);
            return dataPublishChain;
        });
    }
    GetDialogIframe0Blue(dataPublishChain = null) {
        return PromiseChainQuickPublish_awaiter(this, void 0, void 0, function* () {
            ...
            dataPublishChain.Iframe0Blue = yield this.PromiseGen().WaitForAndReturnReadyIframe(dataPublishChain.jqIframe.ContentDoc, this.Const().Selector.SC.ContentIframe0, IDataOneIframe);
...
class OneWindowManager_OneWindowManager extends ContentManagerBase {
    constructor(hub) {
        super(hub);
        hub.debug.FuncStart(OneWindowManager_OneWindowManager.name);
        hub.debug.FuncEnd(OneWindowManager_OneWindowManager.name);
    }
        ...
        return ContentMessageManager_awaiter(this, void 0, void 0, function* () {
            ...
            switch (payload.MsgFlag) {
                ...
                case MsgFlag.ReqAddCETab:
                    yield this.PromiseGen().RaceWaitAndClick(this.Const().Selector.SC.scStartButton, this.ScUiMan().TopLevelWindow().DataDocSelf)
    ...
    __restoreClick(Data) {
        return new Promise(() => ContentMessageManager_awaiter(this, void 0, void 0, function* () {
            try {
                ...
                this.debug().MarkerB();
                var self = this;
                var targetWindow = this.ScUiMan().TopLevelWindow();
                if (targetWindow) {
