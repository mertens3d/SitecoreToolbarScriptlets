    ...
    GetByKey(settingKey, settingAr) {
        ...
        for (var idx = 0; idx < settingAr.length; idx++) {
            if (settingAr[idx].SettingKey === settingKey) {
                ...
                console.log('found it ' + StaticHelpers_StaticHelpers.SettingKeyAsString(settingKey));
                break;
            }
        }
        return toReturn;
...
class ContentMessageManager_ContentMessageManager extends ContentManagerBase {
    ...
    ScheduleIntervalTasks(reqMsgFromPopup) {
        ...
        let autoSaveSetting = this.Helpers().SettingsHelp.GetByKey(SettingKey.AutoSaveEnabled, reqMsgFromPopup.CurrentContentPrefs);
        if (autoSaveSetting.ValueAsObj) {
