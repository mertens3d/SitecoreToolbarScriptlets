...
class ConstAllSettings_ConstAllSettings {
    constructor() {
        this.AllSettings = [
            ...
            new OneGenericSetting(_3xxx_SettingKey_SettingKey.LogToConsole, SettingType.BoolCheckBox, true, PopConst_PopConst.Const.Selector.HS.LogToConsole, SharedConst.Const.Settings.Defaults.LogToConsole, SettingFlavor.ContentAndPopUpStoredInPopUp, 'Log to Console', Enabled.Enabled),
            new OneGenericSetting(_3xxx_SettingKey_SettingKey.UseCompactCss, SettingType.BoolCheckBox, false, PopConst_PopConst.Const.Selector.HS.SettingUseCompactCss, SharedConst.Const.Settings.Defaults.UseCompactCss, SettingFlavor.ContentOnly, 'Use Compact CSS', Enabled.Disabled),
            ...
            new OneGenericSetting(_3xxx_SettingKey_SettingKey.AutoLogin, SettingType.BoolCheckBox, null, PopConst_PopConst.Const.Selector.HS.iCBoxdSettingsAutoLogin, PopConst_PopConst.Const.Storage.Defaults.bool.AutoLogin, SettingFlavor.ContentAndPopUpStoredInPopUp, 'Auto Login', Enabled.Disabled),
            new OneGenericSetting(_3xxx_SettingKey_SettingKey.LgndPopUpLog, SettingType.Accordion, null, PopConst_PopConst.Const.Selector.Legend.LgndPopUpLog, PopConst_PopConst.Const.Settings.Defaults.LgndPopUpLog, SettingFlavor.PopUp, 'Pop Up Log', Enabled.Enabled),
            new OneGenericSetting(_3xxx_SettingKey_SettingKey.LgndForeSite, SettingType.Accordion, null, PopConst_PopConst.Const.Selector.Legend.LgndForeSite, PopConst_PopConst.Const.Settings.Defaults.LgndForeSite, SettingFlavor.PopUp, 'Fore&bull;Site', Enabled.Enabled),
            new OneGenericSetting(_3xxx_SettingKey_SettingKey.LgndHindSite, SettingType.Accordion, null, PopConst_PopConst.Const.Selector.Legend.LgndHindSite, PopConst_PopConst.Const.Settings.Defaults.LgndHindSite, SettingFlavor.PopUp, 'Hind&bull;Site', Enabled.Enabled),
            new OneGenericSetting(_3xxx_SettingKey_SettingKey.LgndSettings, SettingType.Accordion, null, PopConst_PopConst.Const.Selector.Legend.LgndSettings, PopConst_PopConst.Const.Settings.Defaults.LgndSettings, SettingFlavor.PopUp, 'Settings', Enabled.Enabled),
            new OneGenericSetting(_3xxx_SettingKey_SettingKey.LgndMessages, SettingType.Accordion, null, PopConst_PopConst.Const.Selector.Legend.LgndMessages, PopConst_PopConst.Const.Settings.Defaults.LgndMessages, SettingFlavor.PopUp, 'Messages', Enabled.Enabled),
            new OneGenericSetting(_3xxx_SettingKey_SettingKey.LgndPopUpState, SettingType.Accordion, null, PopConst_PopConst.Const.Selector.Legend.LgndPopUpState, PopConst_PopConst.Const.Settings.Defaults.LgndPopUpState, SettingFlavor.PopUp, 'Pop Up State', Enabled.Enabled),
            new OneGenericSetting(_3xxx_SettingKey_SettingKey.LgndContentState, SettingType.Accordion, null, PopConst_PopConst.Const.Selector.Legend.LgndContentState, PopConst_PopConst.Const.Settings.Defaults.LgndContentState, SettingFlavor.PopUp, 'Content State', Enabled.Enabled),
            new OneGenericSetting(_3xxx_SettingKey_SettingKey.LgndBrowserState, SettingType.Accordion, null, PopConst_PopConst.Const.Selector.Legend.LgndBrowserState, PopConst_PopConst.Const.Settings.Defaults.LgndBrowserState, SettingFlavor.PopUp, 'Browser State', Enabled.Enabled),
            new OneGenericSetting(_3xxx_SettingKey_SettingKey.MaxAutoSaveCount, SettingType.Number, null, PopConst_PopConst.Const.Selector.HS.SettingAutoSaveMaxCount, PopConst_PopConst.Const.Numbers.MaxAutoSaveCount, SettingFlavor.ContentAndPopUpStoredInPopUp, 'Auto Save Max Count', Enabled.Disabled),
            new OneGenericSetting(_3xxx_SettingKey_SettingKey.AutoSaveIntervalMin, SettingType.Number, null, PopConst_PopConst.Const.Selector.HS.SettingAutoSaveInterval, PopConst_PopConst.Const.Numbers.AutoSaveIntervalMin, SettingFlavor.ContentAndPopUpStoredInPopUp, 'Auto Save Interval (Min) - 0 to disable', Enabled.Disabled),
            new OneGenericSetting(_3xxx_SettingKey_SettingKey.DebugKeepDialogOpen, SettingType.BoolCheckBox, null, PopConst_PopConst.Const.Selector.HS.SettingDebugKeepDialogOpen, PopConst_PopConst.Const.Settings.Defaults.DebugKeepDialogOpen, SettingFlavor.PopUp, '(Debug) Keep Dialog Open', Enabled.Enabled)
        ];
    }
}
