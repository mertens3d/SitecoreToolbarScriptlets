...
class ContentManagerBase {
    ...
    Const() { return this.ContentHub.Const; }
    debug() { return this.ContentHub.debug; }
    DesktopMan() { return this.ContentHub.OneDesktopMan; }
    GuidMan() { return this.ContentHub.GuidMan; }
    locMan() { return this.ContentHub.LocationMan; }
    OneCEMan() { return this.ContentHub.OneCEMan; }
    OneWinMan() { return this.ContentHub.OneWindowMan; }
    PageDataMan() { return this.ContentHub.PageDataMan; }
    MsgMan() { return this.ContentHub.MsgMan; }
    Utilites() { return this.ContentHub.Utilities; }
    Factoryman() { return this.ContentHub.Factory; }
    MiscMan() { return this.ContentHub.MiscMan; }
    PromiseGen() { return this.ContentHub.PromiseGeneric; }
    ...
    PromiseHelper() { return this.ContentHub.PromiseHelper; }
...
class ContentAtticManager_ContentAtticManager extends ContentManagerBase {
    ...
    WriteToStorage(dataOneWindow) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                ...
                yield window.localStorage.setItem(this.Const().Storage.WindowRoot + this.Const().Storage.SnapShotPrefix + dataOneWindow.Id.AsString, snapShotAsString);
    ...
    CleanOutOldData() {
        ...
        var cleanData = [];
        var now = new Date();
        var maxAutoSaveDiff = this.Const().MaxAutoSaveAgeDays * 24 * 60 * 60 * 1000;
    ...
    SetScMode(newValue, useOrigWindow) {
        return new Promise(() => LocationManager_awaiter(this, void 0, void 0, function* () {
            ...
            if (currentPageType === scWindowType.ContentEditor
                ...
                if (dataOneDoc) {
                    var AllTreeNodeAr = this.ContentHub.OneTreeMan.GetOneLiveTreeData(dataOneDoc);
...
class IterationHelper_IterationHelper extends HelperBase {
    constructor(debug, nickname, maxIterations = null) {
        super(debug);
...
class OneCEManager_OneCEManager extends ContentManagerBase {
    ...
    WaitForAndRestoreOneNode(nextNode, dataOneDocTarget) {
        return OneCEManager_awaiter(this, void 0, void 0, function* () {
            ...
            var iterHelper = new IterationHelper_IterationHelper(this.debug(), this.WaitForAndRestoreOneNode.name);
    ...
    WaitForAndRestoreManyAllNodes(storageData, dataOneDocTarget) {
        return OneCEManager_awaiter(this, void 0, void 0, function* () {
            ...
            let iterHelper = new IterationHelper_IterationHelper(this.debug(), this.WaitForAndRestoreManyAllNodes.name);
    ...
    SaveStateOneContentEditor(id, dataOneDoc, snapShotSettings) {
        ...
        ;
        var CeSnapShot = this.ContentHub.OneCEMan.MakeNewData(id);
...
class PromiseChainRestoreDesktop_PromiseChainRestoreDesktop extends ContentManagerBase {
    ...
    __waitForIframeCountDiffPromise(promiseBucket) {
        return new Promise((resolve, reject) => PromiseChainRestoreDesktop_awaiter(this, void 0, void 0, function* () {
            ...
            var iframeResult = yield this.DesktopMan().WaitForIframeCountDiffWorker(promiseBucket.IFramesbefore, promiseBucket.targetWindow);
            this.debug().MarkerB();
            if (iframeResult) {
                this.debug().MarkerC();
    ...
    GoToAndWaitForDesktopPage(promiseBucket) {
        return PromiseChainRestoreDesktop_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => PromiseChainRestoreDesktop_awaiter(this, void 0, void 0, function* () {
                yield this.DesktopMan().PromiseGen().SetHrefAndWaitForReady(this.Const().UrlSuffix.Desktop, promiseBucket.targetWindow, scWindowType.Desktop)
    ...
    RunOneChain(targetWindow, dataToRestore) {
        return PromiseChainRestoreDesktop_awaiter(this, void 0, void 0, function* () {
            ...
            if (this.MiscMan().NotNullOrUndefined([targetWindow, dataToRestore], this.RunOneChain.name)) {
                ...
                yield this.GoToAndWaitForDesktopPage(dataBucket)
...
class OneDesktopManager_OneDesktopManager extends ContentManagerBase {
    ...
    RestoreDataToOneIframeWorker(oneCEdata, newIframe) {
        return OneDesktopManager_awaiter(this, void 0, void 0, function* () {
            ...
            if (oneCEdata && newIframe) {
                yield this.ContentHub.OneCEMan.RestoreCEStateAsync(oneCEdata, newIframe.ContentDoc);
                toReturn = true;
            }
            else {
    ...
    WaitForIframeCountDiffWorker(IFramesbefore, targetWin) {
        return OneDesktopManager_awaiter(this, void 0, void 0, function* () {
            ...
            var toReturn = null;
            var iterationJr = new IterationHelper_IterationHelper(this.debug(), this.WaitForIframeCountDiffWorker.name);
    ...
    GetActiveDesktopIframeData() {
        ...
        var toReturn = null;
        var livingIframeAr = this.GetAllLiveIframeData(this.PageDataMan().TopLevelWindow());
        if (livingIframeAr) {
    ...
    SaveStateOneDesktop(targetWindow, snapShotSettings) {
    ...
    __waitForAndClickClose(dataPublishChain) {
        return PromiseChainQuickPublish_awaiter(this, void 0, void 0, function* () {
            yield this.PromiseGen().WaitForAndReturnFoundElem(dataPublishChain.Iframe0Blue.ContentDoc, this.Const().Selector.SC.Publish.SettingsHidden)
                ...
                yield this.PromiseGen().WaitForAndReturnFoundElem(dataPublishChain.Iframe0Blue.ContentDoc, this.Const().Selector.SC.Publish.TheItemHasBeenPublished, this.SharedConst().IterHelper.MaxCount.OverridePublishing);
            }))
                .then(() => PromiseChainQuickPublish_awaiter(this, void 0, void 0, function* () {
...
class OneWindowManager_OneWindowManager extends ContentManagerBase {
    ...
    SaveWindowState(targetWindow, snapShotSettings) {
        ...
        return OneWindowManager_awaiter(this, void 0, void 0, function* () {
            ...
            if (dataToRestore) {
                if (dataToRestore.WindowType === scWindowType.ContentEditor) {
                    yield this.ContentHub.OneCEMan.RestoreCEStateAsync(dataToRestore.AllCEAr[0], targetWindow.DataDocSelf);
                }
                else if (dataToRestore.WindowType === scWindowType.Desktop) {
                    yield this.ContentHub.OneDesktopMan.RestoreDesktopStateAsync(targetWindow, dataToRestore);
                }
                else {
    ...
    PutCEDataToCurrentSnapShot(oneCeData, snapShotSettings) {
    ...
    CreateNewWindowSnapShot(windowType, flavor) {
...
class PromiseGeneric_PromiseGeneric extends ContentManagerBase {
    ...
    WaitForReadyIframe(dataOneIframe) {
        return PromiseGeneric_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve) => PromiseGeneric_awaiter(this, void 0, void 0, function* () {
                ...
                var iterationJr = new IterationHelper_IterationHelper(this.debug(), this.WaitForReadyIframe.name);
                var isReady = false;
                this.debug().MarkerA();
    ...
    WaitForAndReturnFoundElem(targetDoc, selector, overrideIterCount = 8) {
        return PromiseGeneric_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => PromiseGeneric_awaiter(this, void 0, void 0, function* () {
                ...
                var found = null;
                var iterationJr = new IterationHelper_IterationHelper(this.debug(), this.WaitForAndReturnFoundElem.name, overrideIterCount);
    ...
    SetHrefAndWaitForReady(href, targetWindow, targetWindowType) {
        return PromiseGeneric_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => PromiseGeneric_awaiter(this, void 0, void 0, function* () {
                ...
                yield this.PromiseHelper().WaitForPageReadyNative(targetWindow.DataDocSelf)
                    .then(() => this.MsgMan().ReadyForMessages())
                    .then(() => resolve())
                    .catch(() => reject());
    ...
    WaitForThenClick(selector, targetDoc) {
        return new Promise((resolve, reject) => PromiseGeneric_awaiter(this, void 0, void 0, function* () {
            if (targetDoc) {
                ...
                var found = null;
                var iterationJr = new IterationHelper_IterationHelper(this.debug(), this.WaitForThenClick.name);
...
class Utilities_Utilities {
    constructor(debug) {
        ...
        this.Debug = debug;
        this.GuidMan = new GuidHelper_GuidHelper(debug);
...
class ContentMessageManager_ContentMessageManager extends ContentManagerBase {
    ...
    ReqMsgRouter(payload) {
        return ContentMessageManager_awaiter(this, void 0, void 0, function* () {
            ...
            var response = yield this.Factoryman().NewMsgFromContent();
            switch (payload.MsgFlag) {
                ...
                case MsgFlag.ReqAdminB:
                    this.debug().LogVal('flag is adminb', StaticHelpers_StaticHelpers.MsgFlagAsString(payload.MsgFlag));
    ...
    __restoreClick(Data) {
        return new Promise(() => ContentMessageManager_awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (targetWindow) {
                    yield self.OneWinMan().RestoreWindowStateToTarget(targetWindow, dataOneWindowStorage)
                        .then(() => this.respondSuccessful())
                        .catch((failReason) => this.respondFail(failReason));
                }
                else {
...
class Factories_Factories extends ContentManagerBase {
    constructor(contentHub) {
        contentHub.debug.FuncStart(PromiseGeneric_PromiseGeneric.name);
        super(contentHub);
        this.GuidHelper = new GuidHelper_GuidHelper(contentHub.debug);
        contentHub.debug.FuncEnd(PromiseGeneric_PromiseGeneric.name);
    }
    UpdateContentState(response) {
        return Factories_awaiter(this, void 0, void 0, function* () {
            ...
            response.ContentState.WindowType = yield this.PageDataMan().GetCurrentPageType();
...
// CONCATENATED MODULE: ./AutoBuild/TsTranspiled/Shared/scripts/Classes/PromiseHelper.js
var PromiseHelper_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
class PromiseHelper_PromiseHelper {
    constructor(debug) {
        this.Debug = debug;
    }
    WaitForPageReadyNative(targetDoc) {
        return PromiseHelper_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => PromiseHelper_awaiter(this, void 0, void 0, function* () {
                this.Debug.FuncStart(this.WaitForPageReadyNative.name);
                var result = new ResultSuccessFail();
                this.Debug.DebugIDataOneDoc(targetDoc);
                var iterationJr = new IterationHelper_IterationHelper(this.Debug, this.WaitForPageReadyNative.name);
                var isReady = false;
                this.Debug.MarkerA();
                while (iterationJr.DecrementAndKeepGoing() && !isReady) {
                    this.Debug.MarkerB();
...
class ContentHub_ContentHub {
    ...
    Instantiate() {
        ...
        this.GuidMan = new GuidHelper_GuidHelper(this.debug);
        ...
        this.PromiseHelper = new PromiseHelper_PromiseHelper(this.debug);
...
new ContentHub_ContentHub(SitecoreUiMan, zLast_debug);
