...
class ContentMessageManager_ContentMessageManager extends ContentManagerBase {
    ...
    ContentReceiveRequest(requestMsgFromPopup) {
        return ContentMessageManager_awaiter(this, void 0, void 0, function* () {
            ...
            response = yield this.ReceiveMessageHndlr(requestMsgFromPopup);
        ...
        return ContentMessageManager_awaiter(this, void 0, void 0, function* () {
            ...
            switch (payload.MsgFlag) {
                case MsgFlag.AddCETab:
                    ...
                    break;
                case MsgFlag.AdminB:
                    this.debug().LogVal('flag is adminb', this.Utilites().MsgFlagAsString(payload));
                ...
                case MsgFlag.GiveCurrentData:
                    response.Data.CurrentSnapShots = yield this.AtticMan().GetAllStorageAsIDataOneWindow();
