...
(function (MsgFlag) {
    ...
    MsgFlag[MsgFlag["ReqToggleCompactCss"] = 24] = "ReqToggleCompactCss";
})(MsgFlag || (MsgFlag = {}));
...
(function (SettingKey) {
    ...
    SettingKey[SettingKey["UseCompactCss"] = 104] = "UseCompactCss";
    ...
    SettingKey[SettingKey["LgndInSite"] = 305] = "LgndInSite";
    SettingKey[SettingKey["LastUsedLogToStorageKey"] = 400] = "LastUsedLogToStorageKey";
    SettingKey[SettingKey["AutoSnapshotBeforeWindowChange"] = 401] = "AutoSnapshotBeforeWindowChange";
            ...
            return new Promise((resolve, reject) => ContentMessageManager_awaiter(this, void 0, void 0, function* () {
                ...
                switch (payload.MsgFlag) {
                    ...
                    case MsgFlag.ReqToggleCompactCss:
                        yield this.ToggleCompactCss(payload.Data)
                            .then(() => promResult.MarkSuccessful())
                            .catch((err) => promResult.MarkFailed(err));
                        break;
...
class ConstAllSettings_ConstAllSettings {
    constructor() {
        this.AllSettings = [
            ...
            new OneGenericSetting(SettingKey_SettingKey.UseCompactCss, SettingType.BoolCheckBox, false, PopConst_PopConst.Const.Selector.HS.SettingUseCompactCss, SharedConst.Const.Settings.Defaults.UseCompactCss, SettingFlavor.ContentOnly, 'Use Compact CSS'),
            new OneGenericSetting(SettingKey_SettingKey.LogToConsole, SettingType.BoolCheckBox, true, PopConst_PopConst.Const.Selector.HS.LogToConsole, SharedConst.Const.Settings.Defaults.LogToConsole, SettingFlavor.ContentAndPopUpStoredInPopUp, 'Log to Console'),
            ...
            new OneGenericSetting(SettingKey_SettingKey.LgndInSite, SettingType.Accordion, null, PopConst_PopConst.Const.Selector.Legend.LgndInSite, PopConst_PopConst.Const.Settings.Defaults.LgndInSite, SettingFlavor.PopUp, 'In&bull;Site'),
