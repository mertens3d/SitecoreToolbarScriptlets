...
class ContentAtticManager_ContentAtticManager extends ContentManagerBase {
    constructor(hub) {
        super(hub);
        hub.Logger.FuncStart(ContentAtticManager_ContentAtticManager.name);
        hub.Logger.FuncEnd(ContentAtticManager_ContentAtticManager.name);
    }
    Init() {
    }
    UpdateNickname(payload) {
        return new Promise((resolve, reject) => {
            ...
            var promResult = new PromiseResult(this.UpdateNickname.name, this.Log());
    ...
    MarkFavorite(data) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            ...
            var result = new PromiseResult(this.MarkFavorite.name, this.Log());
            if (data.IdOfSelect) {
    ...
    WriteToStorage(dataOneWindow) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                ...
                var result = new PromiseResult(this.WriteToStorage.name, this.Log());
            ...
            for (var idx = 0; idx < cacheLength; idx++) {
                ...
                if (candidate.Flavor) {
                    if (autoCount > InjectConst_ContentConst.Const.MaxAutoToSaveCount) {
                        this.Log().LogVal('Delete (max count :' + InjectConst_ContentConst.Const.MaxAutoToSaveCount + ')', candidate.TimeStamp.toString());
                        deleteFlag = true;
                    }
                    autoCount++;
                }
                if (now.getTime() - candidate.TimeStamp.getTime() > maxAutoSaveDiff) {
                    this.Log().LogVal('Delete (Old : max' + InjectConst_ContentConst.Const.MaxAutoSaveAgeDays + ' days)', candidate.TimeStamp.toString());
                    deleteFlag = true;
                }
                if (!deleteFlag) {
    ...
    GetAllSnapShotsMany(cacheMode) {
        this.Log().FuncStart(this.GetAllSnapShotsMany.name, StaticHelpers_StaticHelpers.CacheModeAsString(cacheMode));
        var toReturn;
        ...
        this.Log().LogVal('cached timeDiff', timeDiff + ' : ' + InjectConst_ContentConst.Const.MaxCacheAgeMs);
...
class OneScWindowManager_OneScWindowManager extends ContentManagerBase {
    ...
    Init() {
        ...
        if (currPageType === scWindowType.Desktop) {
            this.OneDesktopMan = new OneDesktopManager_OneDesktopManager(this.ContentHub, this.ScUiMan().TopLevelDoc());
        }
        else if (currPageType === scWindowType.ContentEditor) {
            this.OneCEMan = new OneCEManager_OneCEManager(this.ContentHub, this.ScUiMan().TopLevelDoc());
        }
    }
...
class ContentFactories_ContentFactories extends ContentManagerBase {
    constructor(contentHub) {
        contentHub.Logger.FuncStart(PromiseGeneric_PromiseHelper.name);
        super(contentHub);
        contentHub.Logger.FuncEnd(PromiseGeneric_PromiseHelper.name);
    }
    UpdateContentState(contentState) {
        return new Promise((resolve, reject) => ContentFactories_awaiter(this, void 0, void 0, function* () {
            ...
            let promiseResult = new PromiseResult(this.UpdateContentState.name, this.Log());
    ...
    GetCurrentDtOrCeState() {
        return new Promise((resolve, reject) => ContentFactories_awaiter(this, void 0, void 0, function* () {
            ...
            let promiseResult = new PromiseResult(this.GetCurrentDtOrCeState.name, this.Log());
...
class ContentHub_ContentHub {
    ...
    Instantiate() {
        ...
        this.ContentFactory = new ContentFactories_ContentFactories(this);
        this.Logger.MarkerA();
...
// CONCATENATED MODULE: ./AutoBuild/TsTranspiled/Content/scripts/Classes/LoggerContent.js


class LoggerContent_LoggerContent extends LoggerBase_LoggerBase {
...
new ContentHub_ContentHub(new LoggerContent_LoggerContent());
