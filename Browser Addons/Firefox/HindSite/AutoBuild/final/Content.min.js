...
class OneWindowManager_OneWindowManager extends ContentManagerBase {
    ...
    RemoveAutoFlagIfNotAuto(data, snapShotSettings) {
...
class Utilities_Utilities {
    ...
    TimeNicknameFavStr(data) {
        ...
        return this.MakeFriendlyDate(data.TimeStamp)
            ...
            + ' - ' + StaticHelpers_StaticHelpers.BufferString((data.IsFavorite ? '*' : ' '), 1)
            + ' - ' + StaticHelpers_StaticHelpers.BufferString((data.IsAutoSave ? 'A' : ' '), 1);
    }
        ...
        return ContentMessageManager_awaiter(this, void 0, void 0, function* () {
            ...
            switch (payload.MsgFlag) {
                ...
                case MsgFlag.ReqUpdateNickName:
                    ...
                    break;
                default:
                    this.debug().LogVal('Unrecognized MsgFlag', StaticHelpers_StaticHelpers.MsgFlagAsString(payload.MsgFlag));
                    break;
            }
...
class Factories_Factories extends ContentManagerBase {
    ...
    UpdateContentState(response) {
        return Factories_awaiter(this, void 0, void 0, function* () {
            response.State.CurrentSnapShots = yield this.AtticMan().GetAllStorageAsIDataOneWindow();
