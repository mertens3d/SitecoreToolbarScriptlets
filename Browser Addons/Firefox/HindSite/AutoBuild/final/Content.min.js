...
class PromiseChainRestoreDesktop_PromiseChainRestoreDesktop extends ContentManagerBase {
    ...
    __waitForNewIframe(iframesBefore) {
        return new Promise((resolve, reject) => PromiseChainRestoreDesktop_awaiter(this, void 0, void 0, function* () {
            this.AllAgents.Logger.FuncStart(this.__waitForNewIframe.name);
            var result = new PromiseResult(this.__waitForNewIframe.name, this.AllAgents.Logger);
            var iframeResult;
            yield this.OneScWinMan().OneDesktopMan.WaitForNewIframe(iframesBefore)
    ...
    RunOneChain(targetDoc, dataToRestore) {
        return PromiseChainRestoreDesktop_awaiter(this, void 0, void 0, function* () {
            ...
            if (this.MiscMan().NotNullOrUndefined([targetDoc, dataToRestore], this.RunOneChain.name)) {
                ...
                var targetCeAgent;
                yield this.__waitForAndClickRedStartButton(dataBucket.targetDoc)
...
class OneDesktopManager_OneDesktopManager extends ContentManagerBase {
    ...
    WaitForNewIframe(IFramesbefore) {
        return OneDesktopManager_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => OneDesktopManager_awaiter(this, void 0, void 0, function* () {
                this.AllAgents.Logger.FuncStart(this.WaitForNewIframe.name);
                var toReturn = null;
                var iterationJr = new IterationDrone_IterationDrone(this.AllAgents.Logger, this.WaitForNewIframe.name);
    ...
    GetAllLiveIframeData() {
        ...
        var toReturn = [];
        this.AllAgents.Logger.LogVal('querySelectorAll 9.2: ', InjectConst_ContentConst.Const.Selector.SC.IframeContent.sc920);
        ...
        if (iframeAr) {
            ...
            for (var ifrIdx = 0; ifrIdx < iframeAr.length; ifrIdx++) {
                ...
                var dataOneIframe = this.AllAgents.HelperAgent.FactoryHelp.DataOneIframeFactory(iframeElem, 'desktop Iframe_' + ifrIdx);
    ...
    GetStateDesktop() {
        return new Promise((resolve, reject) => OneDesktopManager_awaiter(this, void 0, void 0, function* () {
            ...
            this.AllAgents.Logger.DebugIDataOneDoc(this.associatedDoc);
            let promiseResult = new PromiseResult(this.GetStateDesktop.name, this.AllAgents.Logger);
            ...
            if (toReturnAllCeState.livingIframeAr && toReturnAllCeState.livingIframeAr.length > 0) {
                for (var iframeIdx = 0; iframeIdx < toReturnAllCeState.livingIframeAr.length; iframeIdx++) {
                    ...
                    yield oneCeMan.GetTreeState(this.AllAgents.HelperAgent.GuidHelper.NewGuid())
                        .then((oneCeState) => {
            ...
            return new Promise((resolve, reject) => ContentMessageManager_awaiter(this, void 0, void 0, function* () {
                ...
                switch (payload.MsgFlag) {
                    ...
                    case MsgFlag.ReqAddCETab:
                        yield this.AllAgents.HelperAgent.PromiseHelper.RaceWaitAndClick(InjectConst_ContentConst.Const.Selector.SC.scStartButton, this.ScUiMan().TopLevelDoc())
                            .then(() => { this.AllAgents.HelperAgent.PromiseHelper.WaitForThenClick([InjectConst_ContentConst.Const.Selector.SC.StartMenuLeftOption], this.ScUiMan().TopLevelDoc()); })
                            .then(() => { promResult.MarkSuccessful(); })
                            .catch((err) => promResult.MarkFailed(err));
                        break;
