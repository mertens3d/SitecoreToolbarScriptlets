...
class HindSiteWindowOpenerClass extends CommonBase{
  constructor() {
    super();
    console.log('s) HindSiteWindowOpenerClass ctor');
    ...
    this.debugInfo();
    console.log('e) HindSiteWindowOpenerClass ctor');
  }
  SourceDirFilter() {
  ...
  debugInfo() {
    console.log('----------');
    console.log('s) debugInfo HindSiteWindowOpenerClass');
    ...
    console.log('NameConcatMinWithVar: ' + this.NameConcatMinWithVar);
    console.log('e) debugInfo HindSiteWindowOpenerClass');
  }
}
