...
__webpack_require__.d(__webpack_exports__, {
  "j": () => /* reexport */ ElementDivJacket
});

// UNUSED EXPORTS: ElementAnchorJacket

// EXTERNAL MODULE: ./AutoBuild/TsTranspiled/DOMJacket/scripts/Elements/ElementJacketOfType.js + 4 modules
var Elements_ElementJacketOfType = __webpack_require__(7304);
...
// CONCATENATED MODULE: ./AutoBuild/TsTranspiled/DOMJacket/scripts/Elements/ElementDivJacket.js

class ElementDivJacket extends Elements_ElementJacketOfType/* ElementJacketOfType */.X {
...
// CONCATENATED MODULE: ./AutoBuild/TsTranspiled/DOMJacket/scripts/Elements/ElementJacketOfType.js
var ElementJacketOfType_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
class ElementJacketOfType extends _CommonCoreBase/* _CommonBase */.a {
    ...
    AddWatcher(watcherParams) {
        return ElementJacketOfType_awaiter(this, void 0, void 0, function* () {
    ...
    WaitFor(selector, friendly = '') {
        return ElementJacketOfType_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => ElementJacketOfType_awaiter(this, void 0, void 0, function* () {
                let selectorAr = [];
