...
var ElementAnchorJacket = (function (_super) {
    __extends(ElementAnchorJacket, _super);
    function ElementAnchorJacket() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return ElementAnchorJacket;
}(ElementJacketBaseOfType/* ElementJacketOfType */.X));
...
var ElementDivJacket = (function (_super) {
    __extends(ElementDivJacket, _super);
    function ElementDivJacket(commonCore, htmlElement) {
        return _super.call(this, commonCore, htmlElement) || this;
    }
    return ElementDivJacket;
...
var ElementJacketMutationEvent_Subject = (function (_super) {
    __extends(ElementJacketMutationEvent_Subject, _super);
    function ElementJacketMutationEvent_Subject() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.TypeDiscriminator = _70_TypeDiscriminator/* TypeDiscriminator.ElementJacketMutationEvent_Subject */.g.ElementJacketMutationEvent_Subject;
        _this.ShowLogActions = true;
        return _this;
    }
    return ElementJacketMutationEvent_Subject;
...
var NativeAddRemoveEvent_Observer_extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
            function (d, b) { for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p]; };
...
var NativeAddRemoveEvent_Observer = (function (_super) {
    NativeAddRemoveEvent_Observer_extends(NativeAddRemoveEvent_Observer, _super);
    function NativeAddRemoveEvent_Observer(commonCore, callback) {
        var _this = _super.call(this, commonCore, NativeAddRemoveEvent_Observer.name, callback) || this;
        _this.TypeDiscriminator = _70_TypeDiscriminator/* TypeDiscriminator.NativeAddRemoveEvent_Observer */.g.NativeAddRemoveEvent_Observer;
        return _this;
    }
    return NativeAddRemoveEvent_Observer;
...
var NativeAddRemoveEvent_Subject_extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
            function (d, b) { for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p]; };
...
var NativeAddRemoveEvent_Subject = (function (_super) {
    NativeAddRemoveEvent_Subject_extends(NativeAddRemoveEvent_Subject, _super);
    function NativeAddRemoveEvent_Subject(commonCore, elemJacket, watcherParams) {
        var _this = _super.call(this, commonCore) || this;
        _this.TypeDiscriminator = _70_TypeDiscriminator/* TypeDiscriminator.FrameJacketAddRemoveEvent_Subject */.g.FrameJacketAddRemoveEvent_Subject;
        _this.ShowLogActions = true;
            ...
            if (addedNode instanceof HTMLElement) {
                ...
                if (passesFilterTest) {
                    if (addedHtmlElement instanceof HTMLIFrameElement) {
                        addedElementJackets.push(new ElementJacketOfType(_this.CommonCore, addedHtmlElement));
                    }
                }
            }
        });
...
var ElementJacketWatcher_extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
            function (d, b) { for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p]; };
...
var ElementJacketWatcher = (function (_super) {
    ElementJacketWatcher_extends(ElementJacketWatcher, _super);
    function ElementJacketWatcher(commonCore, elementJacket, watcherParams) {
        var _this = _super.call(this, commonCore) || this;
        _this.ErrorHand.ThrowIfNullOrUndefined(ElementJacketWatcher.name, [elementJacket]);
        _this.ElementJacket = elementJacket;
        _this.WatcherParams = watcherParams;
        _this.InstantiateInstance();
        return _this;
    }
    ElementJacketWatcher.prototype.InstantiateInstance = function () {
    ...
    ElementJacketWatcher.prototype.WireInstanceEvents = function () {
    ...
    ElementJacketWatcher.prototype.CallBackOnNativeAddRemoveEventAsync = function (nativeIFrameAddRemoveEvent_Payload) {
...
var ElementJacketBaseOfType_extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
            function (d, b) { for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p]; };
...
var ElementJacketBaseOfType_generator = (undefined && undefined.__generator) || function (thisArg, body) {
    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g;
    return g = { next: verb(0), "throw": verb(1), "return": verb(2) }, typeof Symbol === "function" && (g[Symbol.iterator] = function() { return this; }), g;
    function verb(n) { return function (v) { return step([n, v]); }; }
    function step(op) {
...
var ElementJacketOfType = (function (_super) {
    ElementJacketBaseOfType_extends(ElementJacketOfType, _super);
    function ElementJacketOfType(commonCore, htmlElement) {
        var _this = _super.call(this, commonCore) || this;
        _this.ElemJacketWatchers = [];
        _this.NativeElement = htmlElement;
        _this.NodeTagName = htmlElement.tagName;
        return _this;
    }
    ElementJacketOfType.prototype.Click = function () {
        this.NativeElement.click();
    };
    ElementJacketOfType.prototype.AddWatcher = function (watcherParams) {
        return ElementJacketBaseOfType_awaiter(this, void 0, void 0, function () {
            var _this = this;
            return ElementJacketBaseOfType_generator(this, function (_a) {
                return [2, new Promise(function (resolve, reject) {
                        _this.Logger.FuncStart([ElementJacketOfType.name, _this.AddWatcher.name], (watcherParams && watcherParams.OwnerFriendly) ? watcherParams.OwnerFriendly : 'no watcher params');
                        var jacketElemWatcher = new ElementJacketWatcher(_this.CommonCore, _this, watcherParams);
                        _this.ElemJacketWatchers.push(jacketElemWatcher);
                        if (jacketElemWatcher) {
                            resolve(jacketElemWatcher.ElemJacketMutationEvent_Subject);
                        }
                        else {
                            reject(_this.ErrorHand.FormatRejectMessage([ElementJacketOfType.name, _this.AddWatcher.name], 'Unknown reason'));
                        }
                        _this.Logger.FuncEnd([ElementJacketOfType.name, _this.AddWatcher.name], (watcherParams && watcherParams.OwnerFriendly) ? watcherParams.OwnerFriendly : 'no watcher params');
                    })];
            });
        });
    };
    ElementJacketOfType.prototype.querySelector = function (selector) {
        var toReturn = null;
        var candidate = this.NativeElement.querySelector(selector);
        if (candidate) {
            toReturn = new ElementJacketOfType(this.CommonCore, candidate);
        }
        return toReturn;
    };
    ElementJacketOfType.prototype.WaitForElement = function (selector, friendly) {
        if (friendly === void 0) { friendly = ''; }
        return ElementJacketBaseOfType_awaiter(this, void 0, void 0, function () {
            var _this = this;
            return ElementJacketBaseOfType_generator(this, function (_a) {
                return [2, new Promise(function (resolve, reject) { return ElementJacketBaseOfType_awaiter(_this, void 0, void 0, function () {
                        var selectorAr, toReturnElemJacket, iterationJr, foundSelector, foundHtmlElement, idx;
                        return ElementJacketBaseOfType_generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    selectorAr = [];
                                    ...
                                    toReturnElemJacket = null;
                                    iterationJr = new IterationDrone/* IterationDrone */.v(this.CommonCore, this.WaitForElement.name + ' : ' + selectorAr.join(',') + ' ' + friendly, false);
                                    foundSelector = '';
                                    foundHtmlElement = null;
                                    _a.label = 1;
                                case 1:
                                    if (!(!toReturnElemJacket && iterationJr.DecrementAndKeepGoing())) return [3, 3];
    ...
    ElementJacketOfType.prototype.WaitForThenClick = function (selectorAr) {
        var _this = this;
        return new Promise(function (resolve, reject) { return ElementJacketBaseOfType_awaiter(_this, void 0, void 0, function () {
            var _this = this;
            return ElementJacketBaseOfType_generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.ErrorHand.ThrowIfNullOrUndefined(this.WaitForThenClick.name, [selectorAr]);
                        return [4, this.WaitForElement(selectorAr)
                                .then(function (elemJacket) { return elemJacket.Click(); })
                                .then(function () { return resolve(); })
                                .catch(function (err) { return _this.ErrorHand.FormatRejectMessage(_this.WaitForThenClick.name, err); })];
                    case 1:
                        _a.sent();
                        return [2];
                }
    ...
    ElementJacketOfType.prototype.WaitForElemToHaveClassOrReject = function (classNames, friendly) {
        return ElementJacketBaseOfType_awaiter(this, void 0, void 0, function () {
            var _this = this;
            return ElementJacketBaseOfType_generator(this, function (_a) {
                return [2, new Promise(function (resolve, reject) { return ElementJacketBaseOfType_awaiter(_this, void 0, void 0, function () {
                        var elemHasClassName, iterationJr, _loop_1, this_1;
                        return ElementJacketBaseOfType_generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    elemHasClassName = false;
                                    iterationJr = new IterationDrone/* IterationDrone */.v(this.CommonCore, this.WaitForElemToHaveClassOrReject.name + ' : ' + classNames + ' ' + friendly, true);
                                    _loop_1 = function () {
                                        var classList;
                                        return ElementJacketBaseOfType_generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0:
                                                    classList = this_1.NativeElement.classList;
                                                    classNames.forEach(function (className) {
                                                        if (classList.contains(className)) {
                                                            elemHasClassName = true;
                                                        }
                                                    });
                                                    if (!elemHasClassName) return [3, 1];
                                                    resolve();
                                                    return [3, 3];
                                                case 1: return [4, iterationJr.Wait()];
                                                case 2:
                                                    _a.sent();
                                                    _a.label = 3;
                                                case 3: return [2];
                                    ...
                                    _a.label = 1;
                                case 1:
                                    if (!(!elemHasClassName && iterationJr.DecrementAndKeepGoing())) return [3, 3];
                                    return [5, _loop_1()];
                                case 2:
                                    _a.sent();
                                    return [3, 1];
