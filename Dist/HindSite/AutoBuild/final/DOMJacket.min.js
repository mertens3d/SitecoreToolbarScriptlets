...
class ElementJacketMutationEvent_Subject extends HindeSiteEvent_Subject/* HindeSiteEvent_Subject */.U {
    constructor() {
        super(...arguments);
...
class NativeAddRemoveEvent_Observer extends HindSiteEvent_Observer/* HindSiteEvent_Observer */.z {
...
class NativeAddRemoveEvent_Subject extends HindeSiteEvent_Subject/* HindeSiteEvent_Subject */.U {
    ...
    WaitForElement(selector, friendly = '') {
        return ElementJacketBaseOfType_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => ElementJacketBaseOfType_awaiter(this, void 0, void 0, function* () {
                ...
                var iterationJr = new IterationDrone/* IterationDrone */.v(this.CommonCore, this.WaitForElement.name + ' : ' + selectorAr.join(',') + ' ' + friendly, false);
                let foundSelector = '';
