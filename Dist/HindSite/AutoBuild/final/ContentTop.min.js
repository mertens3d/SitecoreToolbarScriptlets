...
class TaskListMutationEvent_Observer extends HindSiteEvent_Observer/* HindSiteEvent_Observer */.z {
...
class CommandStartEndCancelEvent_Observer extends HindSiteEvent_Observer/* HindSiteEvent_Observer */.z {
    ...
    AutoSaveSnapShot() {
        return CommandSolicitorForAutoSnapShot_awaiter(this, void 0, void 0, function* () {
            ...
            this.CommandRouter.RouteCommand(setStateFromX)
                ...
                let returnPayload = commandRouterResult.ReturnPayload;
...
class HotKeyEvent_Observer extends HindSiteEvent_Observer/* HindSiteEvent_Observer */.z {
    constructor(commonCore, callback) {
...
class CommandStartEndCancelEvent_Subject extends HindeSiteEvent_Subject/* HindeSiteEvent_Subject */.U {
    constructor() {
        super(...arguments);
    ...
    SaveWindowState(commandParams) {
        return CommandRunnerInternal_awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => CommandRunnerInternal_awaiter(this, void 0, void 0, function* () {
                ...
                this.CommandRouter.RouteCommand(routingParams)
                    .then((commandRouterResults) => this.AtticAgent.WriteStateOfSitecoreToStorage(commandRouterResults.ReturnPayload.StateOfScUi))
                    .then(() => resolve())
...
class KeyBoardComboEvent_Subject extends HindeSiteEvent_Subject/* HindeSiteEvent_Subject */.U {
    constructor() {
        super(...arguments);
...
class KeyBoardComboEvent_Observer extends HindSiteEvent_Observer/* HindSiteEvent_Observer */.z {
    constructor(commonCore, callback) {
...
class HotKeyEvent_Subject extends HindeSiteEvent_Subject/* HindeSiteEvent_Subject */.U {
    constructor() {
        super(...arguments);
