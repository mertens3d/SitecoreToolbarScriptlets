...
// EXTERNAL MODULE: ./AutoBuild/TsTranspiled/HindSiteScUiProxy/scripts/HindSiteScUiProxy.js + 77 modules
var HindSiteScUiProxy = __webpack_require__(2702);
...
class ContentAtticAgent extends _HindeCoreBase/* _FrontBase */.c {
    ...
    GetAllStorage() {
        ...
        let snapShotValidator = new SnapShotValidatorB/* SnapShotValidatorB */.D(this.CommonCore);
        if (rawStorageData) {
            for (var idx = 0; idx < rawStorageData.length; idx++) {
                let storageItem = rawStorageData[idx];
                let validatedData = snapShotValidator.ValidateStorageData(storageItem);
...
class SolicitorForScheduledAutoSnapShot extends _CommandSolicitorForEvent_ {
    ...
    AutoSaveSnapShot() {
        return CommandSolicitorForAutoSnapShot_awaiter(this, void 0, void 0, function* () {
            ...
            yield this.CommandRouter.RouteCommand(setStateFromX)
                ...
                if (this.DocumentJacket.UrlJacket.QueryStringHasKey(QueryStrKey/* QueryStrKey.hsTargetSs */.a.hsTargetSs)) {
                    ...
                    if (Guid/* Guid.IsValidGuidStr */.i.IsValidGuidStr(qsValue)) {
                        ...
                        if (targetGuid && targetGuid !== Guid/* Guid.GetEmptyGuid */.i.GetEmptyGuid()) {
                            ...
                            yield this.CommandRouter.RouteCommand(routingParams)
                                .then(() => resolve())
                                .catch((err) => this.ErrorHand.FormatRejectMessage([CommandSolicitorForEventQueryString.name, this.StartUp.name], err));
                        }
                        else {
