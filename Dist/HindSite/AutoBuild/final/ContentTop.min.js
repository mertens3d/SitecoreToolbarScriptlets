...
// EXTERNAL MODULE: ./AutoBuild/TsTranspiled/HindSiteScUiProxy/scripts/HindSiteScUiProxy.js + 76 modules
var HindSiteScUiProxy = __webpack_require__(1626);
...
var ToastAgent = (function (_super) {
    ...
    ToastAgent.prototype.OnCommandStartEndCancelEvent = function (payload) {
    ...
    ToastAgent.prototype.ObserveRouter = function (CommandRouter) {
        ...
        return AutoSnapShotAgent_awaiter(this, void 0, void 0, function () {
            ...
            return AutoSnapShotAgent_generator(this, function (_a) {
                ...
                this.ScUiProxy.GetStateOfScUiProxy(payload)
                    ...
                    var hasCorrectData = returnPayload && returnPayload.StateOfScUi && returnPayload.StateOfScUi.Meta && returnPayload.StateOfScUi.Meta.Hash
                    ...
                    if (!hasCorrectData || (returnPayload.StateOfScUi.Meta.Hash !== windowStatePrior.Meta.Hash)) {
                        ...
                        _this.AtticAgent.WriteStateOfSitecoreToStorage(returnPayload.StateOfScUi);
                    }
                    else {
                        _this.Logger.Log('states are same, no save');
                    }
                    _this.LastKnownSavedState = returnPayload.StateOfScUi;
                })
...
var _CommandSolicitorFor_extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
            function (d, b) { for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p]; };
...
var _CommandSolicitorFor_ = (function (_super) {
    _CommandSolicitorFor_extends(_CommandSolicitorFor_, _super);
    function _CommandSolicitorFor_(hindCore, commandRouter, documentJacket) {
        var _this = _super.call(this, hindCore) || this;
        _this.CommandRouter = commandRouter;
        _this.DocumentJacket = documentJacket;
        _this.Instantiate_base();
        _this.Instantiate();
        return _this;
    }
    _CommandSolicitorFor_.prototype.Instantiate_base = function () {
    };
    return _CommandSolicitorFor_;
}(_HindeCoreBase/* _FrontBase */.c));


// CONCATENATED MODULE: ./AutoBuild/TsTranspiled/ContentTop/scripts/CommandSolicitors/CommandSolicitorHotKeys.js
var CommandSolicitorHotKeys_extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
            function (d, b) { for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p]; };
...
var CommandSolicitorForHotKeys = (function (_super) {
    CommandSolicitorHotKeys_extends(CommandSolicitorForHotKeys, _super);
    function CommandSolicitorForHotKeys() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    CommandSolicitorForHotKeys.prototype.Instantiate = function () {
    ...
    CommandSolicitorForHotKeys.prototype.CallBackOnHotKeyEvent = function (hotKeyEvent_Payload) {
    ...
    return CommandSolicitorForHotKeys;
}(_CommandSolicitorFor_));
...
var CommandSolicitorForQueryString_extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
            function (d, b) { for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p]; };
...
var CommandSolicitorForQueryString = (function (_super) {
    CommandSolicitorForQueryString_extends(CommandSolicitorForQueryString, _super);
    function CommandSolicitorForQueryString(hindCore, commandRouter, documentJacket, settingsAgent) {
        var _this = _super.call(this, hindCore, commandRouter, documentJacket) || this;
        _this.SettingsAgent = settingsAgent;
        return _this;
    }
    CommandSolicitorForQueryString.prototype.Instantiate = function () {
    };
    CommandSolicitorForQueryString.prototype.StatUp = function () {
        var setStateFromX = {
    ...
    return CommandSolicitorForQueryString;
}(_CommandSolicitorFor_));
...
var BrowserMessageBroker_Content = (function (_super) {
                ...
                return [2, new Promise(function (resolve, reject) { return BrowserMessageBroker_Content_awaiter(_this, void 0, void 0, function () {
                        ...
                        return BrowserMessageBroker_Content_generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 6:
                                    err_1 = _a.sent();
                                    this.ErrorHand.HandleTopLevelTryCatch([BrowserMessageBroker_Content.name, this.ContentReceiveRequest.name], err_1);
                                    return [3, 7];
                                case 7: return [2];
                            }
                        });
    ...
    BrowserMessageBroker_Content.prototype.ConstructResponse = function (msgFlag) {
        return BrowserMessageBroker_Content_awaiter(this, void 0, void 0, function () {
            ...
            return BrowserMessageBroker_Content_generator(this, function (_a) {
                return [2, new Promise(function (resolve, reject) { return BrowserMessageBroker_Content_awaiter(_this, void 0, void 0, function () {
                        var responseContentToController, payload;
                        var _this = this;
                        return BrowserMessageBroker_Content_generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4, this.HindSiteScUiProxy.GetStateOfScUiProxy(payload)
                                            .then(function (returnPayload) {
...
var CommandPayloadForInternal = (function (_super) {
    ...
    function CommandPayloadForInternal(hindeCore, apiPayload) {
        var _this = _super.call(this, hindeCore) || this;
            ...
            return RecipeInitFromQueryStr_generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.CommandParams.ApiPayload.SnapShotOfStateScUiApi = mostRecent_1;
                        return [4, this.Dependancies.ScUiProxy.SetStateOfSitecoreWindowAsync(this.CommandParams.ApiPayload)
                                .then(function () { return resolve(); })
                ...
                switch (_a.label) {
                    case 0:
                        payload = {
                            DataOneWindowStorage: null,
                            ScRibbonCommand: eScRibbonCommand/* ScRibbonCommand.Unknown */.G.Unknown,
                            SnapShotFlavor: SnapShotFlavor/* SnapShotFlavor.Manual */.n.Manual,
                            SnapShotOfStateScUiApi: null,
                        };
                        return [4, this.Dependancies.ScUiProxy.GetStateOfScUiProxy(payload)
                                .then(function (scUiReturnPayload) {
                                _this.Dependancies.AtticAgent.WriteStateOfSitecoreToStorage(scUiReturnPayload.StateOfScUi);
                            })
                                .then(function () { return resolve(); })
                                .catch(function (err) { return reject(err); })];
                    case 1:
...
var CommandRouter = (function (_super) {
    ...
    function CommandRouter(hindeCore, scUiProxy, atticAgent, autoSnapShotAgent, documentJacket) {
        var _this = _super.call(this, hindeCore) || this;
        _this.ScUiProxy = scUiProxy;
        _this.AtticAgent = atticAgent;
        _this.AutoSnapShotAgent = autoSnapShotAgent;
                            ...
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4, this.ExecuteApiCommand(commandData.commandToExecute, routingParams.MsgFlag)
                                            .then(function () { return resolve(); })
                                            .finally(function () { return reject('need to do'); })];
                                case 1:
                                    _a.sent();
                                    return [3, 6];
                                case 2:
                                    if (!(commandData.CommandType = CommandType/* CommandType.ContentInternal */.w.ContentInternal)) return [3, 6];
                                    _a.label = 3;
                                case 3:
                                    _a.trys.push([3, 5, , 6]);
                                    return [4, this.ExecuteInternalCommand(commandData.commandToExecute, routingParams)
                                            ...
                                            .catch(function (err) { return _this.ErrorHand.HandleTopLevelTryCatch(err, err); })
                                            .finally(function () { return reject('todo'); })];
                                case 4:
                                    _a.sent();
                                    return [3, 6];
                                case 5:
                                    err_1 = _a.sent();
                                    this.ErrorHand.HandleTopLevelTryCatch(err_1, err_1);
                                    return [3, 6];
                                case 6:
                                    if (commandData) {
                                    }
    ...
    CommandRouter.prototype.ExecuteInternalCommand = function (commandToExecute, routingParams) {
        ...
        return new Promise(function (resolve, reject) { return CommandRouter_awaiter(_this, void 0, void 0, function () {
            var commandParams, self_1, err_2;
            var _this = this;
            return CommandRouter_generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.Logger.FuncStart(this.ExecuteInternalCommand.name);
                        if (!commandToExecute) return [3, 4];
                    ...
                    case 3:
                        err_2 = _a.sent();
                        this.ErrorHand.HandleTopLevelTryCatch(err_2, err_2);
                        return [3, 4];
                    case 4:
    ...
    CommandRouter.prototype.BuildCommandPayloadForInternal = function () {
        ...
        var commandParams = new CommandPayloadForInternal(this.HindeCore, scProxyPayload);
    ...
    CommandRouter.prototype.CalculateCommandToExec = function (msgFlag) {
        ...
        switch (msgFlag) {
            case _10_MessageFlag/* ReqCommandMsgFlag.ReqAddCETab */.r.ReqAddCETab:
                ...
                break;
            case _10_MessageFlag/* ReqCommandMsgFlag.GetStateOfWindow */.r.GetStateOfWindow:
                commandData.CommandType = CommandType/* CommandType.Api */.w.Api;
            ...
            case _10_MessageFlag/* ReqCommandMsgFlag.ReqToggleRawValues */.r.ReqToggleRawValues:
                commandData.CommandType = CommandType/* CommandType.Api */.w.Api;
                payload.ScRibbonCommand = eScRibbonCommand/* ScRibbonCommand.ToggleRawValues */.G.ToggleRawValues;
                commandData.commandToExecute = (function () { return _this.ScUiProxy.TriggerCERibbonCommand(payload); });
                break;
            case _10_MessageFlag/* ReqCommandMsgFlag.OpenCERibbonPresentationDetails */.r.OpenCERibbonPresentationDetails:
                commandData.CommandType = CommandType/* CommandType.Api */.w.Api;
                payload.ScRibbonCommand = eScRibbonCommand/* ScRibbonCommand.PresentationDetails */.G.PresentationDetails;
                commandData.commandToExecute = (function () { return _this.ScUiProxy.TriggerCERibbonCommand(payload); });
                break;
            case _10_MessageFlag/* ReqCommandMsgFlag.OpenCERibbonNavigateLinks */.r.OpenCERibbonNavigateLinks:
                commandData.CommandType = CommandType/* CommandType.Api */.w.Api;
                payload.ScRibbonCommand = eScRibbonCommand/* ScRibbonCommand.NavigateLinks */.G.NavigateLinks;
                commandData.commandToExecute = (function () { return _this.ScUiProxy.TriggerCERibbonCommand(payload); });
                break;
            case _10_MessageFlag/* ReqCommandMsgFlag.ReqNavigateBack */.r.ReqNavigateBack:
                commandData.CommandType = CommandType/* CommandType.Api */.w.Api;
                payload.ScRibbonCommand = eScRibbonCommand/* ScRibbonCommand.NavigateBack */.G.NavigateBack;
                commandData.commandToExecute = (function () { return _this.ScUiProxy.TriggerCERibbonCommand(payload); });
                break;
            ...
            case _10_MessageFlag/* ReqCommandMsgFlag.ReqNavigateUp */.r.ReqNavigateUp:
                commandData.CommandType = CommandType/* CommandType.Api */.w.Api;
                payload.ScRibbonCommand = eScRibbonCommand/* ScRibbonCommand.NavigateUp */.G.NavigateUp;
                commandData.commandToExecute = (function () { return _this.ScUiProxy.TriggerCERibbonCommand(payload); });
                break;
            ...
            case _10_MessageFlag/* ReqCommandMsgFlag.ReqGoToSelected */.r.ReqGoToSelected:
                commandData.CommandType = CommandType/* CommandType.Api */.w.Api;
                commandData.commandToExecute = (function () { return _this.ScUiProxy.CEGoSelected(payload); });
                break;
            ...
            case _10_MessageFlag/* ReqCommandMsgFlag.ReqDebugAutoSnapShot */.r.ReqDebugAutoSnapShot:
                ...
                break;
            case _10_MessageFlag/* ReqCommandMsgFlag.ReqDebugContentFatalError */.r.ReqDebugContentFatalError:
                commandData.CommandType = CommandType/* CommandType.ContentInternal */.w.ContentInternal;
                commandData.commandToExecute = (function () {
...
var ContentEntry = (function () {
    ...
    ContentEntry.prototype.StartUpContent = function () {
        return zContentTopEntryPoint_awaiter(this, void 0, void 0, function () {
            var commonCore_1, err_1;
            var _this = this;
            return zContentTopEntryPoint_generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        commonCore_1 = CoreFactory/* CoreFactory.BuildCommonCore */.A.BuildCommonCore();
                        this.HindeCore = new HindeCore/* HindeCore */.Q(commonCore_1);
                        ...
                        return [4, DocumentJacket/* DocumentJacket.FactoryMakeDocumentJacket */.k.FactoryMakeDocumentJacket(this.HindeCore, document)
                                ...
                                .catch(function (err) { return commonCore_1.ErrorHand.HandleFatalError(_this.StartUpContent.name, err); })];
                    ...
                    case 3:
                        err_1 = _a.sent();
                        if (this.ErrorHand) {
                            this.ErrorHand.HandleFatalError([ContentEntry.name, this.StartUpContent.name], err_1);
                        }
    ...
    ContentEntry.prototype.InstantiateAndInit_Managers = function () {
        return zContentTopEntryPoint_awaiter(this, void 0, void 0, function () {
            var contentMessageMan, runTimeOptions, urlJacket, contentMessageBroker;
            return zContentTopEntryPoint_generator(this, function (_a) {
                try {
                    this.HindeCore.Logger.SectionMarker('Instantiate and Initialize Managers');
                    contentMessageMan = void 0;
                    runTimeOptions = {
