...
var OneWindowManager = /** @class */ (function (_super) {
    ...
    OneWindowManager.prototype.SaveWindowState = function () {
        this.Xyyz.debug.FuncStart(this.SaveWindowState.name);
        this.Xyyz.OneWindowMan.CreateNewWindowTreeSnapShot();
        ...
        if (currentPageType === PageType.ContentEditor) {
            ...
            var id = this.Xyyz.InjectConst.GuidEmpty;
        ...
        this.Xyyz.debug.FuncEnd(this.SaveWindowState.name);
        ;
    };
    OneWindowManager.prototype.ClearStorage = function () {
    ...
    OneWindowManager.prototype.__GetAllLocalStorage = function () {
    ...
    OneWindowManager.prototype.__drawStorageRaw = function (ourData) {
    ...
    OneWindowManager.prototype.__drawStoragePretty = function (ourData) {
    ...
    OneWindowManager.prototype.DrawStorage = function () {
    ...
    OneWindowManager.prototype.ShowDebugDataOneWindow = function () {
    ...
    OneWindowManager.prototype.CreateNewWindowTreeSnapShot = function () {
    ...
    OneWindowManager.prototype.DrawDebugDataPretty = function (source) {
    ...
    OneWindowManager.prototype.__buildDebugDataPretty = function (source) {
