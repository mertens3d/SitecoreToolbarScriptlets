...
exports.ScWindowManager = void 0;
...
var RecipeInitFromQueryStr_1 = require("../../ContentApi/Recipes/RecipeInitFromQueryStr/RecipeInitFromQueryStr");
...
var ScWindowManager = /** @class */ (function (_super) {
    __extends(ScWindowManager, _super);
    function ScWindowManager(logger, scUiMan, miscAgent, toastAgent, atticAgent, scUrlAgent, settingsAgent) {
        var _this = _super.call(this, logger) || this;
        _this.__desktopProxyLazy = null;
        _this.__contentEditorProxyLazy = null;
        _this.Logger.InstantiateStart(ScWindowManager.name);
        _this.MiscAgent = miscAgent;
        ...
        _this.Logger.InstantiateEnd(ScWindowManager.name);
        return _this;
    }
    ScWindowManager.prototype.DesktopProxy = function () {
        if (!this.__desktopProxyLazy) {
            this.__desktopProxyLazy = new DesktopProxy_1.DesktopProxy(this.Logger, this.GetTopLevelDoc(), this.SettingsAgent);
        }
        return this.__desktopProxyLazy;
    };
    ScWindowManager.prototype.ContentEditorProxy = function () {
    ...
    ScWindowManager.prototype.OnReadyInitScWindowManager = function () {
                            ...
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    return [4 /*yield*/, recipesBasic.WaitForReadyNABDocument(this.GetTopLevelDoc())
                                            ...
                                            .then(function () { return _this.InitFromQueryStr(); })
    ...
    ScWindowManager.prototype.MakeScWinRecipeParts = function () {
        return new ScWindowRecipePartials_1.ScWindowRecipePartials(this.Logger, this.ToastAgent);
    };
    ScWindowManager.prototype.GetCurrentStateByPageType = function (scWindowType) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ScWindowManager.prototype.GetScUrlAgent = function () {
        return this.ScUrlAgent;
    };
    ScWindowManager.prototype.GetCurrentPageType = function () {
        return this.ScUrlAgent.GetScWindowType();
    };
    ScWindowManager.prototype.GetTopLevelDoc = function () {
        if (!this.TopDoc) {
            this.TopDoc = {
                //ParentDoc: null,
    ...
    ScWindowManager.prototype.InitFromQueryStr = function () {
        return __awaiter(this, void 0, void 0, function () {
            var recipe, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        if (!this.GetScUrlAgent().QueryStringHasKey(QueryStrKey_1.QueryStrKey.hsTargetSs)) return [3 /*break*/, 3];
                        recipe = new RecipeInitFromQueryStr_1.RecipeInitFromQueryStr(this.Logger, this.GetScUrlAgent(), this.AtticAgent, this.GetTopLevelDoc(), this.MakeScWinRecipeParts(), this.DesktopProxy(), this.ContentEditorProxy());
    ...
    ScWindowManager.prototype.SetCompactCss = function (targetDoc) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: 
    ...
    ScWindowManager.prototype.CreateShellIDataScWindowState = function (windowType, flavor) {
    ...
    //}
    ScWindowManager.prototype.GetStates = function () {
        var _this = this;
    ...
    ScWindowManager.prototype.GetStateOfSitecoreWindow = function (snapshotFlavor) {
        var _this = this;
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
    ...
    ScWindowManager.prototype.PopulateFriendly = function (metadata) {
    ...
    ScWindowManager.prototype.PopulateMetaData = function (snapshotFlavor) {
    ...
    return ScWindowManager;
}(LoggableBase_1.LoggableBase));
exports.ScWindowManager = ScWindowManager;
