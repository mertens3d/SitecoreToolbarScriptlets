...
export class DTAreaProxyMutationEvent_Observer extends _HindSiteEvent_Observer<IDTAreaProxyMutationEvent_Payload> implements IHindSiteEvent_Observer<IDTAreaProxyMutationEvent_Payload> {
