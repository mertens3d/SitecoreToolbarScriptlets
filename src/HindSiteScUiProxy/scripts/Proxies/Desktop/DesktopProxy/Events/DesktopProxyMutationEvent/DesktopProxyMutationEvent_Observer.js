...
var DesktopProxyMutationEvent_Observer = /** @class */ (function (_super) {
    ...
    function DesktopProxyMutationEvent_Observer(logger, owner) {
        var _this = _super.call(this, logger, DesktopProxyMutationEvent_Observer.name) || this;
        _this.Owner = owner;
        return _this;
    }
            ...
            payload.AddedDTFrameProxies.forEach(function (dtFrameProxy) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    dtFrameProxy.OnReadyInitDTFrameProxy()
                        .then(function () { return _this.Owner.AddDTFrameProxyAsync(dtFrameProxy); })
                        .catch(function (err) { throw (DesktopProxyMutationEvent_Observer.name + ' | ' + err); });
                    return [2 /*return*/];
                });
            }); });
        }
