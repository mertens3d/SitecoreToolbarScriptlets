...
var RecipePublishActiveCe = /** @class */ (function (_super) {
    ...
    RecipePublishActiveCe.prototype.Execute = function () {
        var _this = this;
    ...
    RecipePublishActiveCe.prototype.__debugDataPublishChain = function (dataPublishChain, nickname) {
    ...
    RecipePublishActiveCe.prototype.PublishCE = function (docToPublish) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    RecipePublishActiveCe.prototype.ClickPublishOnNav = function (payload) {
        return __awaiter(this, void 0, void 0, function () {
            var err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    RecipePublishActiveCe.prototype.__waitForAndClickClose = function (dataPublishChain) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    RecipePublishActiveCe.prototype.__waitForAndClickOk = function (dataPublishChain) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    RecipePublishActiveCe.prototype.__WaitForAndClickPublishNextButton = function (dataPublishChain) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    RecipePublishActiveCe.prototype.ClickMenuButtonPublishDropDown = function (payload) {
    ...
    RecipePublishActiveCe.prototype.ClickMenuDropDownPublishItem = function (payload) {
        if (payload === void 0) { payload = null; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    RecipePublishActiveCe.prototype.GetThePublishItemDialog = function (dataPublishChain) {
    ...
    RecipePublishActiveCe.prototype.GetMessageDialog = function (dataPublishChain) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    RecipePublishActiveCe.prototype.GetDialogIframe0Blue = function (dataPublishChain) {
        if (dataPublishChain === void 0) { dataPublishChain = null; }
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
    ...
    RecipePublishActiveCe.prototype.__waitForThenFunc = function (selector, targetDoc, dataPublishChain, optionFunc) {
        var _this = this;
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            var found;
            return __generator(this, function (_a) {
