...
export class UiSettingBasedModuleMutationEvent_Observer extends _HindSiteEvent_Observer<IUiSettingBasedModuleMutationEven_Payload> implements IHindSiteEvent_Observer<IUiSettingBasedModuleMutationEven_Payload> {
