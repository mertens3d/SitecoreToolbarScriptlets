...
export class NativeAddRemoveEvent_Observer extends _HindSiteEvent_Observer<INativeAddRemoveEvent_Payload> implements IHindSiteEvent_Observer<INativeAddRemoveEvent_Payload> {
