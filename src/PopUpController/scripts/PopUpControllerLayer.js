...
var HandlersForInternal_1 = require("../../PopUpUi/scripts/Classes/HandlersForInternal");
var PopUpBrowserTabAgent_1 = require("../../PopUpUi/scripts/Managers/PopUpBrowserTabAgent");
var PopUpControllerLayer = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.PopUpBrowserProxy = new BrowserProxy_1.PopUpBrowserProxy(this.Logger);
                        return [4 /*yield*/, this.PopUpBrowserProxy.Init_BrowserProxy()
                                .then(function () {
    ...
    PopUpControllerLayer.prototype.InstantiateAgents_Controller = function () {
        this.ScUrlAgent = new ScUrlAgent_1.ScUrlAgent(this.Logger, this.PopUpBrowserProxy);
        this.ScUrlAgent.Init_ScUrlAgent();
        this.PopUpMessageBrokerAgent = new PopUpMessagesBrokerAgent_1.PopUpMessagesBrokerAgent(this.Logger, this.PopUpBrowserProxy, this.SettingsAgent);
    };
    PopUpControllerLayer.prototype.InstantiateManagers_Controller = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                this.UiLayer = new HindSiteUiLayer_1.HindSiteUiLayer(this.Logger, this.SettingsAgent, this.CommandDefintionBucket, this.ScUrlAgent);
                this.BrowserTabAgent = new PopUpBrowserTabAgent_1.PopUpBrowserTabAgent(this.Logger, this.ScUrlAgent, this.SettingsAgent, this.PopUpBrowserProxy);
