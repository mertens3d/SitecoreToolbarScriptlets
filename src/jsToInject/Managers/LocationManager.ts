...
import { IDataOneTreeNode } from '../Interfaces/IDataOneTreeNode';
import { IscMode } from '../Interfaces/IscMode';

export class LocationManager extends ManagerBase {
  ...
  SetScMode(newValue: IscMode, useOrigWindow: boolean) {
