...
export class CommandRouter extends _FrontBase {
  ...
  constructor(hindeCore: IHindeCore, scUiProxy: IHindSiteScUiProxy, toastAgent: IToastAgent, atticAgent: IContentAtticAgent, settingsAgent: ISettingsAgent, autoSnapShotAgent: AutoSnapShotAgent, documentJacket: DocumentJacket, deepHotKeyAgent: DeepHotKeyAgent) {
    super(hindeCore);
