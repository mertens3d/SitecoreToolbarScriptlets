...
var DTFrameProxyMutationEvent_Observer_1 = require("../../Events/DesktopProxy/DTFrameProxyMutationEvent/DTFrameProxyMutationEvent_Observer");
...
var RecipeRestoreDesktop_1 = require("../../../../Content/scripts/ContentApi/Recipes/RecipeRestoreDesktop/RecipeRestoreDesktop");
var FrameHelper_1 = require("../../../../Content/scripts/Helpers/FrameHelper");
var LoggableBase_1 = require("../../../../Shared/scripts/LoggableBase");
var DesktopStartBarProxy_1 = require("../../../../Content/scripts/Proxies/Desktop/DesktopStartBarProxy/DesktopStartBarProxy");
var DTFrameProxyBucket_1 = require("../../../../Content/scripts/Proxies/Desktop/DesktopProxy/DTFrameProxyBucket");
var DesktopProxyMutationEvent_Observer_1 = require("../../../../Content/scripts/Proxies/Desktop/DesktopProxy/Events/DesktopProxyMutationEvent/DesktopProxyMutationEvent_Observer");
var DesktopProxyMutationEvent_Subject_1 = require("../../../../Content/scripts/Proxies/Desktop/DesktopProxy/Events/DesktopProxyMutationEvent/DesktopProxyMutationEvent_Subject");
var DesktopProxy = /** @class */ (function (_super) {
    __extends(DesktopProxy, _super);
    function DesktopProxy(logger, associatedDoc, contentBrowserProxy) {
        ...
        if (associatedDoc) {
            ...
            _this.RecipeBasics = new RecipeBasics_1.RecipeBasicsForContent(_this.Logger, _this.ContentBrowserProxy);
        }
        else {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    this.DTFrameProxyMutationEvent_Observer = new DTFrameProxyMutationEvent_Observer_1.DTFrameProxyMutationEvent_Observer(this.Logger, this.OnDTFrameProxyMutationEvent.bind(this));
                                    ...
                                    return [4 /*yield*/, this.OnReadyPopulateDTFrameProxyBucket()
                                            .then(function () {
                                            _this.DesktopStartBarAgent = new DesktopStartBarProxy_1.DesktopStartBarProxy(_this.Logger, _this.ContentBrowserProxy, _this.AssociatedDoc);
                                            var self = _this;
                                            _this.DesktopProxyMutationEvent_Subject = new DesktopProxyMutationEvent_Subject_1.DesktopProxyMutationEvent_Subject(self.Logger, _this.AssociatedDoc, _this.ContentBrowserProxy);
                                            _this.WireEvents();
                                        })
    ...
    DesktopProxy.prototype.GetFrameHelper = function () {
        if (this.__iframeHelper == null) {
            this.__iframeHelper = new FrameHelper_1.FrameHelper(this.Logger, this.ContentBrowserProxy);
        }
    ...
    DesktopProxy.prototype.WireEvents = function () {
        ...
        //}
        this.DomChangedEvent_Subject = new DesktopProxyMutationEvent_Subject_1.DesktopProxyMutationEvent_Subject(this.Logger, this.AssociatedDoc, this.ContentBrowserProxy);
        var DomChangeEvent_Observer = new DesktopProxyMutationEvent_Observer_1.DesktopProxyMutationEvent_Observer(this.Logger, this.CallbackToName.bind(this));
        this.DomChangedEvent_Subject.RegisterObserver(DomChangeEvent_Observer);
    };
    DesktopProxy.prototype.CallbackToName = function (payload) {
        var _this = this;
    ...
    DesktopProxy.prototype.GetDtStartBarAgent = function () {
        if (!this.__dtStartBarAgent) {
            this.__dtStartBarAgent = new DesktopStartBarProxy_1.DesktopStartBarProxy(this.Logger, this.ContentBrowserProxy, this.AssociatedDoc);
        }
    ...
    DesktopProxy.prototype.SetStateOfDesktop = function (desktopState, commanddata) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    ;
                                    if (!(desktopState && desktopState.StateOfDTFrames && desktopState.StateOfDTFrames.length > 0)) return [3 /*break*/, 7];
                                    if (!!StaticHelpers_1.StaticHelpers.IsNullOrUndefined([this.AssociatedDoc])) return [3 /*break*/, 5];
                                    idx = 0;
                                    _a.label = 1;
                                case 1:
                                    if (!(idx < desktopState.StateOfDTFrames.length)) return [3 /*break*/, 4];
                                    stateOfFrame = desktopState.StateOfDTFrames[idx];
                                    recipe = new RecipeRestoreDesktop_1.RecipeRestoreFrameOnDesktop(commanddata, stateOfFrame);
