...
export class KeyBoardComboEvent_Observer extends HindSiteEvent_Observer<IKeyBoardComboEvent_Payload> implements IHindSiteEvent_Observer<IKeyBoardComboEvent_Payload> {
