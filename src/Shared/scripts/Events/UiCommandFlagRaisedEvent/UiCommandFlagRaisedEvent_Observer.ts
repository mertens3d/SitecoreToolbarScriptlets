...
export class UiCommandFlagRaisedEvent_Observer extends _HindSiteEvent_Observer<IUiCommandFlagRaisedEvent_Payload> implements IHindSiteEvent_Observer<IUiCommandFlagRaisedEvent_Payload> {
