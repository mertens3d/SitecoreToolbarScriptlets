...
export class CommandStartEndCancelEvent_Observer extends _HindSiteEvent_Observer<ICommandStartEndCancelEvent_Payload> implements IHindSiteEvent_Observer<ICommandStartEndCancelEvent_Payload> {
